package com.adobe.utils
{
   ...
   public class AGALMiniAssembler
   {
      ...
      private static function init() : void
      {
         ...
         SAMPLEMAP["compressed"] = new Sampler("compressed",8,1);
         SAMPLEMAP["compressedalpha"] = new Sampler("compressedalpha",8,2);
      ...
      public function assemble(param1:String, param2:String, param3:uint = 1, param4:Boolean = false) : ByteArray
      {
         ...
         {
            if((_loc32_ = (_loc29_ = (_loc29_ = new String(_loc36_[_loc41_])).replace(REGEXP_OUTER_SPACES,"")).search("//")) != -1)
            {
               _loc29_ = _loc29_.slice(0,_loc32_);
            }
            if((_loc13_ = _loc29_.search(/<.*>/g)) != -1)
            {
               _loc9_ = _loc29_.slice(_loc13_).match(/([\w\.\-\+]+)/gi);
               _loc29_ = _loc29_.slice(0,_loc13_);
            }
            if(!(_loc34_ = _loc29_.match(/^\w{3}/gi)))
            {
               if(_loc29_.length >= 3)
               {
            ...
            else
            {
               ...
               else
               {
                  ...
                  if(_loc24_ > 4096)
                  {
                     _error = "error: too many opcodes. maximum is 4096.";
                     break;
                  }
                  if(!(_loc42_ = _loc29_.match(/vc\[([vofi][acostdip]?[d]?)(\d*)?((\.[xyzw])?(\+\d{1,3})?)?\](\.[xyzw]{1,4})?|([vofi][acostdip]?[d]?)(\d*)?(\.[xyzw]{1,4})?/gi)) || _loc42_.length != _loc15_.numRegister)
                  {
                  ...
                  {
                     _loc25_ = false;
                     if((_loc7_ = _loc42_[_loc43_].match(/\[.*\]/gi)) && _loc7_.length > 0)
                     {
                     ...
                     if(!(_loc16_ = _loc42_[_loc43_].match(/^\b[A-Za-z]{1,3}/gi)))
                     {
                     ...
                     if(_loc50_)
                     {
                        ...
                        {
                           if((_loc47_ = uint(_loc50_[0].charCodeAt(_loc46_) - "x".charCodeAt(0))) > 2)
                           {
                              _loc47_ = uint(3);
                           }
                           if(_loc31_)
                     ...
                     if(_loc25_)
                     {
                        ...
                        if((_loc30_ = REGMAP[_loc17_[0]]) == null)
                        {
                        ...
                        if((_loc37_ = _loc7_[0].match(/(\.[xyzw]{1,1})/)).length == 0)
                        {
                           _error = "error: bad index register select";
                           _loc23_ = true;
                           break;
                        }
                        if((_loc45_ = uint(_loc37_[0].charCodeAt(1) - "x".charCodeAt(0))) > 2)
                        {
                           _loc45_ = uint(3);
                        }
                        if((_loc5_ = _loc7_[0].match(/\+\d{1,3}/gi)).length > 0)
                        {
                           _loc27_ = _loc5_[0];
                        }
                     ...
                     else if(_loc39_)
                     {
                        ...
                        while(_loc46_ < _loc11_)
                        {
                           ...
                           if((_loc6_ = SAMPLEMAP[_loc9_[_loc46_]]) == null)
                           {
                           ...
                           else
                           {
                              ...
                              _loc21_ |= uint(_loc6_.mask) << uint(_loc6_.flag);
                           }
                           _loc46_++;
                        }
                        agalcode.writeShort(_loc38_);
         ...
         if(debugEnabled)
         {
            ...
            while(_loc22_ < _loc33_)
            {
               ...
               if((_loc20_ = agalcode[_loc22_].toString(16)).length < 2)
               {
                  _loc20_ = "0" + _loc20_;
               }
               _loc28_ += _loc20_;
      ...
      private function initregmap(param1:uint, param2:Boolean) : void
      {
         ...
         REGMAP["iid"] = new Register("iid","instance id",7,!!param2 ? 1024 : 0,64 | 2);
         REGMAP["op"] = REGMAP["vo"];
         REGMAP["i"] = REGMAP["vi"];
         REGMAP["v"] = REGMAP["vi"];
         REGMAP["oc"] = REGMAP["fo"];
