package com.greensock
{
   ...
   public class TimelineLite extends SimpleTimeline
   {
      ...
      public static function exportRoot(param1:Object = null, param2:Boolean = true) : TimelineLite
      {
         ...
         (_loc4_ = _loc3_._timeline)._remove(_loc3_,true);
         _loc3_._startTime = 0;
      ...
      {
         param3 = this._parseTimeOrLabel(param3,0,true);
      ...
      override public function add(param1:*, param2:* = "+=0", param3:String = "normal", param4:Number = 0) : *
      {
         ...
         if(!(param1 is Animation))
         {
            if(param1 is Array)
            {
               ...
               while(_loc5_ < _loc7_)
               {
                  if((_loc8_ = param1[_loc5_]) is Array)
                  {
                  ...
                  if(!(typeof _loc8_ === "string" || typeof _loc8_ === "function"))
                  {
                     ...
                     {
                        _loc8_._startTime -= _loc8_.delay();
                     }
                  }
                  _loc6_ += param4;
                  _loc5_++;
         ...
         if(_gc || _time === _duration)
         {
            if(!_paused)
            {
               ...
               {
                  _loc10_ = (_loc9_ = this).rawTime() > param1._startTime;
                  while(_loc9_._timeline)
                  {
                     if(_loc10_ && _loc9_._timeline.smoothChildTiming)
                     {
      ...
      {
         return param1 in this._labels ? Number(Number(this._labels[param1])) : -1;
      }
      ...
      protected function _parseTimeOrLabel(param1:*, param2:* = 0, param3:Boolean = false, param4:Object = null) : Number
      {
         ...
         if(typeof param1 === "string" && (isNaN(param1) || param1 in this._labels))
         {
            if((_loc5_ = param1.indexOf("=")) === -1)
            {
               ...
               {
                  return !!param3 ? (Number(this._labels[param1] = this.duration() + param2)) : Number(param2);
               }
      ...
      {
         return totalTime(typeof param1 === "number" ? Number(Number(param1)) : Number(this._parseTimeOrLabel(param1)),param2);
      }
      ...
      override public function render(param1:Number, param2:Boolean = false, param3:Boolean = false) : void
      {
         ...
         if(param1 >= _loc4_)
         {
            ...
            _rawPrevTime = _duration !== 0 || !param2 || param1 !== 0 || _rawPrevTime === param1 ? Number(param1) : Number(_tinyNum);
            param1 = Number(_loc4_ + 0.0001);
         }
         else if(param1 < 1e-7)
         {
            _totalTime = _time = 0;
            if(_loc5_ !== 0 || _duration === 0 && _rawPrevTime !== _tinyNum && (_rawPrevTime > 0 || param1 < 0 && _rawPrevTime >= 0))
            {
               _loc12_ = "onReverseComplete";
               _loc10_ = _reversed;
            }
         ...
         while(_loc6_)
         {
            if(_loc6_._startTime >= param4)
            {
               ...
               else
               {
                  ...
                  if(param1)
                  {
                     _loc7_ = (_loc5_ = _loc5_.concat(TimelineLite(_loc6_).getChildren(true,param2,param3))).length;
                  }
               }
            }
            _loc6_ = _loc6_._next;
      ...
      public function getTweensOf(param1:Object, param2:Boolean = true) : Array
      {
         ...
         _loc7_ = (_loc6_ = TweenLite.getTweensOf(param1)).length;
         while(--_loc7_ > -1)
         {
            if(_loc6_[_loc7_].timeline === this || param2 && this._contains(_loc6_[_loc7_]))
            {
               var _loc8_:*;
               _loc4_[_loc8_ = _loc5_++] = _loc6_[_loc7_];
            }
         }
         if(_loc3_)
         {
            ...
            if(_dirty)
            {
               ...
               while(_loc4_)
               {
                  ...
                  if(_loc4_._startTime < 0 && !_loc4_._paused)
                  {
                     ...
                     this.shiftChildren(-_loc4_._startTime,false,-9999999999);
                     _loc5_ = 0;
                  }
                  if((_loc7_ = _loc4_._startTime + _loc4_._totalDuration / _loc4_._timeScale) > _loc3_)
                  {
