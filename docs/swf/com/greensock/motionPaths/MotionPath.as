package com.greensock.motionPaths
{
   ...
   public class MotionPath extends Shape
   {
      ...
      {
         var _loc5_:PathFollower;
         if((_loc5_ = this.getFollower(param1)) == null)
         {
      ...
      {
         var _loc2_:PathFollower = this.getFollower(param1);
         if(_loc2_ == null)
         {
            return;
         }
         ...
         {
            this._rootFollower = _loc2_.cachedNext;
         }
      ...
      public function removeAllFollowers() : void
      {
         ...
         var _loc1_:PathFollower = this._rootFollower;
         while(_loc1_)
         {
      ...
      public function distribute(param1:Array = null, param2:Number = 0, param3:Number = 1, param4:Boolean = false, param5:Number = 0) : void
      {
         ...
         var _loc7_:int;
         var _loc8_:Number = (_loc7_ = param1.length) > 1 ? Number((param3 - param2) / (_loc7_ - 1)) : 1;
         while(--_loc7_ > -1)
         {
            if((_loc6_ = this.getFollower(param1[_loc7_])) == null)
            {
      ...
      public function getFollower(param1:Object) : PathFollower
      {
         ...
         var _loc2_:PathFollower = this._rootFollower;
         while(_loc2_)
         {
      ...
      public function set progress(param1:Number) : void
      {
         ...
         var _loc3_:PathFollower = this._rootFollower;
         while(_loc3_)
         {
