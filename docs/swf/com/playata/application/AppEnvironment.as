package com.playata.application
{
   ...
   import com.playata.framework.assets.download.StringLoader;
   import com.playata.framework.assets.location.IAssetLocation;
   import com.playata.framework.assets.location.UrlAssetLocation;
   ...
   public class AppEnvironment extends Environment
   {
      ...
      {
         Environment.platform = appPlatform = new AppPlatform();
      ...
      protected function get stringLocation() : IAssetLocation
      {
         return new UrlAssetLocation("{identifier}");
      }
      ...
      override protected function setupPlatformAssetLoaders() : void
      {
         ...
         var _loc4_:ConstantsLoader;
         (_loc4_ = new ConstantsLoader(constantsCacheFile)).addAssetLocation(constantsLocation);
         Environment.assetManager.addLoader(AssetType.CONSTANTS,_loc4_);
         var _loc2_:StringLoader = new StringLoader();
         _loc2_.addAssetLocation(stringLocation);
         Environment.assetManager.addLoader(AssetType.STRING,_loc2_);
         var _loc3_:IAssetLoader = Environment.assetManager.getLoader(AssetType.SPINE_DEFINITION);
         _loc3_.addAssetLocation(spineDefinitionLocation);
         hideLaunchScreen();
         loadAssets();
      }
      ...
      {
         var onSpineLoaded:* = function():void
         {
         ...
         var onTexturesLoaded:* = function():void
         {
