package com.playata.application
{
   ...
   public class AssetListCommon
   {
      ...
      public static var ASSET_LIST_TEXTURES:Vector.<TextureAssetDefinitionData> = new <TextureAssetDefinitionData>[new TextureAssetDefinitionData("ui_background.png"),new TextureAssetDefinitionData("ui_background.xml"),new TextureAssetDefinitionData("oc_animation.png"),new TextureAssetDefinitionData("oc_animation.xml"),new TextureAssetDefinitionData("streaming_animation.png"),new TextureAssetDefinitionData("streaming_animation.xml"),new TextureAssetDefinitionData("ui_foreground.png"),new TextureAssetDefinitionData("ui_foreground.xml"),new TextureAssetDefinitionData("ui_foreground2.png"),new TextureAssetDefinitionData("ui_foreground2.xml"),new TextureAssetDefinitionData("guild_emblems.png"),new TextureAssetDefinitionData("guild_emblems.xml"),new TextureAssetDefinitionData("citymap.png"),new TextureAssetDefinitionData("citymap.xml"),new TextureAssetDefinitionData("FontCopy.fnt"),new TextureAssetDefinitionData("FontHeadlineStyled.fnt"),new TextureAssetDefinitionData("FontHeadline.fnt"),new TextureAssetDefinitionData("FontCopyChat.fnt")];
