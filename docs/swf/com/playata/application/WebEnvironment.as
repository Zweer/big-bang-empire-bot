package com.playata.application
{
   ...
   import com.playata.framework.services.pushnotifications.lib.web.WebPushNotificationManager;
   ...
   public class WebEnvironment extends AppEnvironment
   {
      ...
      override protected function initPlatform() : void
      {
         ...
         var _loc6_:SwfLoad;
         (_loc6_ = new SwfLoad(_loc4_,_loc5_)).loader.uncaughtErrorEvents.addEventListener("uncaughtError",ErrorReporting.uncaughtErrorHandler);
         var _loc7_:SwfLoad;
         (_loc7_ = new SwfLoad(_loc8_,_loc5_)).loader.uncaughtErrorEvents.addEventListener("uncaughtError",ErrorReporting.uncaughtErrorHandler);
      ...
      private function start() : void
      {
         ...
         Logger.enabled = Logger.dumping = Environment.info.isTestMode;
         new ApplicationRequest("initEnvironment",{},initEnvironment);
      }
      ...
      private function initEnvironment(param1:String, param2:RequestData, param3:Object, param4:String) : void
      {
         ...
         Environment.pushNotificationManager = new WebPushNotificationManager();
