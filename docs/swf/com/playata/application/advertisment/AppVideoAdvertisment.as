   ...
   public class AppVideoAdvertisment extends VideoAdvertisment
   {
      ...
      public static function setRemainingVideoAdvertismentCooldowns(param1:TypedObject) : void
      {
         ...
         for each(var _loc4_ in param1.keys)
         {
            if(_loc4_.indexOf("remaining_video_advertisment_cooldown__") != -1)
            {
               ...
               if(!(!_loc2_ || _loc2_ < 0))
               {
                  _lastShownAdvertismentTimestamp.setData(_loc3_,TimeUtil.now - (AppEnvironment.appPlatform.getAdvertismentInfoInt("video_advertisment_blocked_time__" + _loc3_.toString(),CConstant.video_advertisment_blocked_time) - _loc2_));
               }
            }
         }
      }
      ...
      public static function isAvailable(param1:int, param2:int) : Boolean
      {
         ...
         if(ExternalInterface.available)
         {
            ...
            ExternalInterface.call("hasApplixirVideoAdvertisment");
         }
         switch(int(type) - 1)
         {
            case 0:
      ...
      override protected function onInit(param1:ActionRequestResponse) : void
      {
         ...
         else if(param1.error.indexOf("errStartNotYetAvailable_") != 1)
         {
            ...
            _lastShownAdvertismentTimestamp.setData(_type,TimeUtil.now - (AppEnvironment.appPlatform.getAdvertismentInfoInt("video_advertisment_blocked_time__" + _type.toString(),CConstant.video_advertisment_blocked_time) - _loc2_));
         }
         else
         {
