package com.playata.application.billing
{
   ...
   public class AppPremiumSpecialBillingProductInfo extends PremiumSpecialBillingProductInfo
   {
      ...
      private var _isStandaloneOffer:Boolean = false;
      ...
      public function AppPremiumSpecialBillingProductInfo(param1:TypedObject)
      {
         ...
         _isStandaloneOffer = param1.getBoolean("standalone_offer");
      ...
      override public function get description() : String
      {
         ...
         if(specialOfferId.indexOf("_season_package") >= 0)
         {
            return _loc1_;
         }
      ...
      public function get isStandaloneOffer() : Boolean
      {
         return _isStandaloneOffer;
      }
