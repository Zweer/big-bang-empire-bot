   ...
   public class GameUtil
   {
      ...
      public static function questXpReward(param1:int, param2:int, param3:int, param4:Number = 1, param5:Number = 0) : int
      {
         ...
         if(param2 < _loc10_)
         {
            ...
            {
               _loc8_ *= _loc7_ - param2 / _loc10_ * (_loc7_ - 1);
            }
         }
      ...
      public static function calcNeededGameCurrency(param1:int) : int
      {
         ...
         return int(Math.round(_loc5_ + _loc3_ * Math.pow(_loc6_ * param1,_loc4_)));
      }
      ...
      public static function getFansString(param1:int) : String
      {
         return LocText.current.text("general/fans_name",LocText.current.formatHugeNumber(param1));
      }
      ...
      public static function premiumCostEnergyRefill(param1:int) : int
      {
         ...
         return int(Math.round(CConstant.quest_energy_refill_premium_amount * _loc2_));
      }
      ...
      public static function getGoalRewardAmount(param1:int, param2:Number, param3:int) : int
      {
         ...
         switch(int(param1) - 1)
         {
            case 0:
               ...
               _loc5_ = (_loc5_ = CConstant.goal_reward_game_currency_percentage_base) * param2;
               _loc11_ = (_loc11_ = Math.round(_loc11_ * _loc5_ * _loc10_)) + Math.pow(param3,CConstant.goal_reward_game_currency_exp);
               return Math.round(_loc11_);
            case 1:
               _loc4_ = Number((_loc4_ = Number(CConstant.goal_reward_premium_currency_base)) * param2);
               return Math.round(_loc4_);
            case 2:
               _loc4_ = Number((_loc4_ = Number(CConstant.goal_reward_stat_points_base)) * param2);
               return Math.round(_loc4_);
            case 3:
               ...
               _loc9_ = (_loc7_ = CLevel.fromId(param3 + 1).xp) - _loc8_;
               _loc6_ = (_loc6_ = CConstant.goal_reward_xp_percentage_base) * param2;
            ...
            case 6:
               return 0;
            case 5:
               _loc4_ = Number((_loc4_ = Number(CConstant.goal_reward_energy_base)) * param2);
               return Math.round(_loc4_);
            default:
               return 0;
         }
      ...
      public static function getItemPatternRewardAmount(param1:int, param2:Number) : int
      {
         ...
         switch(int(param1) - 1)
         {
            case 0:
               ...
               return int(_loc3_ * Math.round(param2));
            case 1:
               return 0;
            case 2:
      ...
      {
         return int(CGuildBattleAttackCost.fromId(Math.floor(param1)).gameCurrencyCost);
      }
      ...
      public static function getHint(param1:int) : String
      {
         ...
         {
            if((_loc4_ = CHint.fromId(_loc3_)).requiredLevel <= param1 && (_loc4_.maxLevel >= param1 || _loc4_.maxLevel == 0))
            {
               _loc2_.push(_loc3_);
            }
         }
      ...
      public static function compressAvatarImageSettings(param1:AppearanceSettings, param2:Vector.<String>) : String
      {
         ...
         {
            _loc12_ |= param1.getInt(_loc3_[_loc9_]) << _loc9_ * 6;
            _loc9_++;
         }
         _loc5_ += "b:" + _loc12_ + ";";
         _loc12_ = 0;
         ...
         {
            _loc12_ |= param1.getInt(_loc8_[_loc9_]) << _loc9_ * 6;
            _loc9_++;
         }
         _loc5_ += "b2:" + _loc12_ + ";";
         _loc12_ = 0;
         ...
         {
            _loc12_ |= param1.getInt(_loc11_[_loc9_]) << _loc9_ * 6;
            _loc9_++;
         }
         _loc5_ += "s:" + _loc12_ + ";";
         _loc12_ = 0;
         ...
         {
            _loc12_ |= param1.getInt(_loc13_[_loc9_]) << _loc9_ * 6;
            _loc9_++;
         }
         _loc5_ += "tt:" + _loc12_ + ";";
         _loc12_ = 0;
         ...
         {
            _loc12_ |= param1.getInt(_loc6_[_loc9_]) << _loc9_ * 6;
            _loc9_++;
         }
         _loc5_ += "uw:" + _loc12_ + ";";
         _loc12_ = 0;
         ...
         {
            _loc12_ |= param1.getInt(_loc15_[_loc9_]) << _loc9_ * 6;
            _loc9_++;
         }
         _loc5_ += "p:" + _loc12_ + ";";
         _loc12_ = 0;
         ...
         {
            _loc12_ |= param1.getInt(_loc7_[_loc9_]) << _loc9_ * 6;
            _loc9_++;
         }
         _loc5_ += "p2:" + _loc12_ + ";";
         for each(var _loc10_ in param2)
         {
            if(!(_loc10_ == "head" && !param1.show_head_item))
            {
               if(_loc10_ == "chest" && !param1.show_chest_item)
               {
                  ...
                  {
                     _loc5_ += getAppearanceShortForm("bra_quality") + ":" + CItemTemplate.fromId(param1.getString(_loc10_)).quality + ";";
                  }
               }
      ...
      public static function compressMovieCoverSettings(param1:MovieCoverSettings, param2:Array) : String
      {
         ...
         var _loc14_:* = null;
         var _loc4_:String = param1.gender;
         var _loc5_:String = (_loc5_ = "g:" + _loc4_ + ";") + ("t:" + param1.title + ";");
         var _loc12_:* = 0;
         var _loc3_:Array = ["hair_type","hair_color","eyebrows_type","facial_hair_type","decoration_type"];
         _loc9_ = 0;
         while(_loc9_ < _loc3_.length)
               ...
               else if(!(_loc10_ == "belt" && !param1.show_belt_item))
               {
                  if(!(_loc10_ == "legs" && !param1.show_legs_item))
                  {
                     if(!(_loc10_ == "boots" && !param1.show_boots_item))
                     {
                        ...
                        {
                           _loc14_ = getAppearanceShortForm(_loc10_);
                           _loc5_ += _loc14_ + ":" + param1.getData(_loc10_) + ";";
                        }
                     }
                  }
               }
         ...
         return (_loc5_ += "hba:" + AppEnvironment.appPlatform.isHideBraAllowed + ";") + ("hpa:" + AppEnvironment.appPlatform.isHidePantiesAllowed + ";");
      }
      ...
      public static function getMovieExtendTimePremiumCurrengy(param1:int) : int
      {
         ...
         return int(Math.round(CConstant.movie_extend_time_premium_amount * _loc2_));
      }
      ...
      {
         var _loc2_:int = BattleEffect.battleSkillToBattleSkillIdentifier(param1);
      ...
      public static function calculateStatQuestWinChance(param1:Character, param2:int, param3:int, param4:Number = 0) : int
      {
         var _loc5_:* = null;
         var _loc11_:Array;
         var _loc10_:Number = (_loc11_ = [CConstant.quest_stat_base_easy,CConstant.quest_stat_base_medium,CConstant.quest_stat_base_hard])[param3 - 1];
      ...
      {
         var _loc8_:Array;
         var _loc7_:Number = (_loc8_ = [CConstant.quest_stat_base_easy,CConstant.quest_stat_base_medium,CConstant.quest_stat_base_hard])[param3 - 1];
      ...
      public static function getCharacterStages(param1:Character, param2:Boolean = false) : Vector.<int>
      {
         var _loc4_:int = 0;
         var _loc3_:Vector.<int> = new Vector.<int>(0);
         _loc4_ = 1;
         while(_loc4_ <= param1.maxQuestStage)
         {
            _loc3_.push(_loc4_);
            _loc4_++;
         }
         _loc3_ = _loc3_.concat(getCustomStages(param1.level));
         if(param2)
         {
            _loc3_.sort(sortByStageUnlockLevel);
         }
         return _loc3_;
      }
      
      public static function getAllStages(param1:Boolean = false) : Vector.<int>
      {
         var _loc3_:int = 0;
         var _loc2_:Vector.<int> = new Vector.<int>(0);
         _loc3_ = 1;
         while(_loc3_ <= CConstant.quest_max_stage)
         {
            _loc2_.push(_loc3_);
            _loc3_++;
         }
         _loc2_ = _loc2_.concat(getCustomStages(CConstant.max_level));
         if(param1)
         {
            _loc2_.sort(sortByStageUnlockLevel);
         }
         return _loc2_;
      }
      
      private static function sortByStageUnlockLevel(param1:int, param2:int) : int
      {
         return getQuestStageUnlockLevel(param1) - getQuestStageUnlockLevel(param2);
      }
      ...
      public static function getCustomStages(param1:int = -1) : Vector.<int>
      {
         ...
         {
            if(((_loc5_ = CCustomStage.fromId(_loc2_)).locales.indexOf("all") != -1 || _loc5_.locales.indexOf(_loc4_) != -1) && (param1 == -1 || param1 >= _loc5_.minLevel))
            {
      ...
      public static function isCustomStageUnlocked(param1:Character, param2:int) : Boolean
      {
         ...
         {
            if(!((_loc5_ = CCustomStage.fromId(_loc3_)).locales.indexOf("all") == -1 && _loc5_.locales.indexOf(_loc4_) == -1))
            {
      ...
      public static function getQuestStageUnlockLevel(param1:int) : int
      {
         ...
         if(param1 > CConstant.quest_max_stage)
         {
            ...
            for each(var _loc2_ in CCustomStage.ids)
            {
               if(!((_loc4_ = CCustomStage.fromId(_loc2_)).locales.indexOf("all") == -1 && _loc4_.locales.indexOf(_loc3_) == -1))
               {
      ...
      public static function getEventQuestObjectiveRewardAmount(param1:int, param2:Number, param3:int) : int
      {
         ...
         switch(int(param1) - 1)
         {
            case 0:
               ...
               _loc11_ = (_loc11_ = CConstant.event_quest_objective_reward_game_currency_percentage_base) * param2;
               _loc10_ = (_loc10_ = Math.round(_loc10_ * _loc11_ * _loc8_)) + Math.pow(param3,CConstant.event_quest_objective_reward_game_currency_exp);
               return Math.round(_loc10_);
            case 1:
               return int((_loc4_ = CConstant.event_quest_objective_reward_premium_currency_base) * Math.round(param2));
            case 2:
               return int((_loc4_ = CConstant.event_quest_objective_reward_stat_points_base) * Math.round(param2));
            case 3:
               if(param3 >= CConstant.max_level)
               {
                  return 0;
               ...
               _loc7_ = (_loc5_ = CLevel.fromId(param3 + 1).xp) - _loc6_;
               _loc9_ = (_loc9_ = CConstant.event_quest_objective_reward_xp_percentage_base) * param2;
