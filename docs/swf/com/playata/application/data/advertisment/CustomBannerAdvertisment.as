package com.playata.application.data.advertisment
{
   ...
   public class CustomBannerAdvertisment extends DOCustomBannerAdvertisment
   {
      ...
      override public function get url() : String
      {
         ...
         return StringUtil.replace(_loc1_,"[serverid]",ServerInfo.serverId);
      }
      ...
      public function get rewardString() : String
      {
         ...
         {
            _loc1_ += GameUtil.getCustomBannerRewardString(_loc2_,_loc3_.getData(_loc2_),User.current.character.level);
         }
         return _loc1_;
      }
