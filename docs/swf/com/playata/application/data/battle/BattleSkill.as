package com.playata.application.data.battle
{
   ...
   public class BattleSkill
   {
      ...
      public static function getSkillDescription(param1:String, param2:*, param3:*, param4:*) : String
      {
         if(param2 !== null && param3 !== null && param4 !== null)
         {
            return LocText.current.text("battle_skill/" + param1 + "/description",param2,param3,param4);
         }
         if(param2 !== null && param3 !== null)
         {
            return LocText.current.text("battle_skill/" + param1 + "/description",param2,param3);
         }
         if(param2 !== null)
         {
            return LocText.current.text("battle_skill/" + param1 + "/description",param2);
         }
         return LocText.current.text("battle_skill/" + param1 + "/description");
      }
      ...
      {
         return getSkillDescription(identifier,value1,value2,value3);
      }
      ...
      {
         if(param1 == "value2" && BattleEffect.battleSkillToBattleEffect(_skillId) == 13)
         {
            return param2;
         }
      ...
      public function get isStatSkill() : Boolean
      {
         var _loc2_:int = CBattleSkill.fromId(_skillId).battleSkillId;
         var _loc1_:Vector.<int> = BattleEffect.battleEffectToBattleSkills(106);
         if(_loc1_.indexOf(_loc2_) >= 0)
         {
            return true;
         }
         _loc1_ = BattleEffect.battleEffectToBattleSkills(105);
         if(_loc1_.indexOf(_loc2_) >= 0)
         {
            return true;
         }
         _loc1_ = BattleEffect.battleEffectToBattleSkills(107);
         if(_loc1_.indexOf(_loc2_) >= 0)
         {
            return true;
         }
         _loc1_ = BattleEffect.battleEffectToBattleSkills(108);
         if(_loc1_.indexOf(_loc2_) >= 0)
         {
            return true;
         }
         _loc1_ = BattleEffect.battleEffectToBattleSkills(109);
         if(_loc1_.indexOf(_loc2_) >= 0)
         {
            return true;
         }
