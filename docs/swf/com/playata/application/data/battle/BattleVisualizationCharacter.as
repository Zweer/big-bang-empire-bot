package com.playata.application.data.battle
{
   ...
   public class BattleVisualizationCharacter extends BattleOpponent
   {
      ...
      protected var _seasonEffect:SeasonBattleEffect = null;
      ...
      public static function fromCharacter(param1:Character) : BattleVisualizationCharacter
      {
         ...
         return new BattleVisualizationCharacter(_loc4_);
      }
      ...
      public static function fromMissedBattle(param1:TypedObject, param2:TypedObject) : BattleVisualizationCharacter
      {
         var _loc5_:DOBattleOpponent = new DOBattleOpponent({
            ...
            "season_effect":(!!param1.hasData("season_effect") ? param1.getData("season_effect") : null),
         ...
         return new BattleVisualizationCharacter(_loc5_);
      }
      ...
      public function get seasonEffect() : SeasonBattleEffect
      {
         if(_seasonEffect == null && hasData("season_effect") && getData("season_effect") != null)
         {
            _seasonEffect = new SeasonBattleEffect(new TypedObject(getData("season_effect")));
         }
         return _seasonEffect;
      }
   }
}
