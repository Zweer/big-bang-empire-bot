package com.playata.application.data.character
{
   ...
   public class Character extends DOCharacter implements ICharacterTooltipProvider
   {
      ...
      private var _drawEvents:Vector.<DrawEvent>;
      ...
      private var _seasonProgress:SeasonProgress;
      ...
      public function Character(param1:DOCharacter)
      {
         ...
         _drawEvents = new Vector.<DrawEvent>();
         super(param1);
      ...
      override public function update(param1:TypedObject) : void
      {
         ...
         var _loc10_:* = null;
         var _loc3_:* = null;
         var _loc21_:DOCharacter;
         if((_loc21_ = new DOCharacter(param1)).hasData("level") && hasData("level"))
         {
            if(_loc21_.level > this.level)
            {
               ...
               {
                  if(!((_loc14_ = CCustomStage.fromId(_loc4_)).locales.indexOf("all") == -1 && _loc14_.locales.indexOf(_loc13_) == -1))
                  {
         ...
         if(_loc21_.hasData("max_quest_stage") && hasData("max_quest_stage"))
         {
            ...
            {
               UiPremiumCurrencyPanel.instance.offset += CConstant.stage_level_up_premium_amount;
      ...
      public function refreshGoalValues(param1:TypedObject) : void
      {
         ...
         else
         {
            ...
            for each(var _loc3_ in param1.keys)
            {
               ...
               if(_loc2_)
               {
                  _loc4_ = !(_loc5_ = _loc2_.currentTargetValue(this)).isCollectable(this) && !_loc5_.isCollected(this);
      ...
      public function refreshCollectedGoals(param1:TypedObject) : void
      {
         ...
         for each(var _loc5_ in param1.rawData)
         {
            for(var _loc6_ in _loc5_)
            {
               ...
               _loc7_ = (_loc4_ = new TypedObject(_loc5_[_loc6_])).getInt("value");
               if(!(_loc8_ = _collectedGoals.getData(_loc6_)).exists(_loc7_))
               {
            ...
            if(!(param2 > 0 && _loc7_.category != param2))
            {
               if(_loc7_.identifier != "account_confirmed")
               {
                  if(!(_loc7_.identifier == "first_quest_resource_request_accepted" && !AppEnvironment.appPlatform.isResourceRequestAllowed))
                  {
                     ...
                     {
                        if(!(CGoal.exists(_loc7_.identifier) && CGoal.fromId(_loc7_.identifier).hidden && _loc7_.currentValue(this) <= 0))
                        {
                           if(param3)
                           {
                              if(!(_loc6_ = _loc7_.currentTargetValue(this,true)).isCollected(this))
                              {
                                 _loc8_ = false;
      ...
      public function get isMe() : Boolean
      {
         ...
         return User.current.character.id == id && isOwnServer;
      }
      ...
      public function get activeQuest() : Quest
      {
         ...
         return _quests.getData(activeQuestId);
      }
      ...
      public function get activeConventionShow() : ConventionShow
      {
         ...
         return _conventionShows.getData(activeConventionShowId);
      }
      ...
      public function get itemStamina() : int
      {
         ...
         if(getItemByType(1))
         {
            _loc1_ += getItemByType(1).statStamina;
         }
         if(getItemByType(2))
         {
            _loc1_ += getItemByType(2).statStamina;
         }
         if(getItemByType(3))
         {
            _loc1_ += getItemByType(3).statStamina;
         }
         if(getItemByType(4))
         {
            _loc1_ += getItemByType(4).statStamina;
         }
         if(getItemByType(5))
         {
            _loc1_ += getItemByType(5).statStamina;
         }
         if(getItemByType(6))
         {
            _loc1_ += getItemByType(6).statStamina;
         }
         if(getItemByType(7))
         {
            _loc1_ += getItemByType(7).statStamina;
         }
         if(getItemByType(10))
         {
            _loc1_ += getItemByType(10).statStamina;
         }
         if(getItemByType(8))
         {
            _loc1_ += getItemByType(8).statStamina;
         }
         if(getItemByType(9))
         {
            _loc1_ += getItemByType(9).statStamina;
         }
         return _loc1_;
      }
      ...
      public function get itemStrength() : int
      {
         ...
         if(getItemByType(1))
         {
            _loc1_ += getItemByType(1).statStrength;
         }
         if(getItemByType(2))
         {
            _loc1_ += getItemByType(2).statStrength;
         }
         if(getItemByType(3))
         {
            _loc1_ += getItemByType(3).statStrength;
         }
         if(getItemByType(4))
         {
            _loc1_ += getItemByType(4).statStrength;
         }
         if(getItemByType(5))
         {
            _loc1_ += getItemByType(5).statStrength;
         }
         if(getItemByType(6))
         {
            _loc1_ += getItemByType(6).statStrength;
         }
         if(getItemByType(7))
         {
            _loc1_ += getItemByType(7).statStrength;
         }
         if(getItemByType(10))
         {
            _loc1_ += getItemByType(10).statStrength;
         }
         if(getItemByType(8))
         {
            _loc1_ += getItemByType(8).statStrength;
         }
         if(getItemByType(9))
         {
            _loc1_ += getItemByType(9).statStrength;
         }
         return _loc1_;
      }
      ...
      public function get itemCriticalRating() : int
      {
         ...
         if(getItemByType(1))
         {
            _loc1_ += getItemByType(1).statCriticalRating;
         }
         if(getItemByType(2))
         {
            _loc1_ += getItemByType(2).statCriticalRating;
         }
         if(getItemByType(3))
         {
            _loc1_ += getItemByType(3).statCriticalRating;
         }
         if(getItemByType(4))
         {
            _loc1_ += getItemByType(4).statCriticalRating;
         }
         if(getItemByType(5))
         {
            _loc1_ += getItemByType(5).statCriticalRating;
         }
         if(getItemByType(6))
         {
            _loc1_ += getItemByType(6).statCriticalRating;
         }
         if(getItemByType(7))
         {
            _loc1_ += getItemByType(7).statCriticalRating;
         }
         if(getItemByType(10))
         {
            _loc1_ += getItemByType(10).statCriticalRating;
         }
         if(getItemByType(8))
         {
            _loc1_ += getItemByType(8).statCriticalRating;
         }
         if(getItemByType(9))
         {
            _loc1_ += getItemByType(9).statCriticalRating;
         }
         return _loc1_;
      }
      ...
      public function get itemDodgeRating() : int
      {
         ...
         if(getItemByType(1))
         {
            _loc1_ += getItemByType(1).statDodgeRating;
         }
         if(getItemByType(2))
         {
            _loc1_ += getItemByType(2).statDodgeRating;
         }
         if(getItemByType(3))
         {
            _loc1_ += getItemByType(3).statDodgeRating;
         }
         if(getItemByType(4))
         {
            _loc1_ += getItemByType(4).statDodgeRating;
         }
         if(getItemByType(5))
         {
            _loc1_ += getItemByType(5).statDodgeRating;
         }
         if(getItemByType(6))
         {
            _loc1_ += getItemByType(6).statDodgeRating;
         }
         if(getItemByType(7))
         {
            _loc1_ += getItemByType(7).statDodgeRating;
         }
         if(getItemByType(10))
         {
            _loc1_ += getItemByType(10).statDodgeRating;
         }
         if(getItemByType(8))
         {
            _loc1_ += getItemByType(8).statDodgeRating;
         }
         if(getItemByType(9))
         {
            _loc1_ += getItemByType(9).statDodgeRating;
         }
         return _loc1_;
      }
      ...
      {
         return battleSkillStatValue(1);
      }
      
      public function get battleSkillStrength() : int
      {
         return battleSkillStatValue(2);
      }
      
      public function get battleSkillCriticalRating() : int
      {
         return battleSkillStatValue(3);
      }
      
      public function get battleSkillDodgeRating() : int
      {
         return battleSkillStatValue(4);
      }
      
      private function battleSkillStatValue(param1:int) : int
      {
         var _loc3_:* = null;
         var _loc7_:* = null;
         var _loc8_:* = undefined;
         var _loc4_:int = 0;
         if(AppConfig.battleSkillsEnabled !== true)
         {
            return 0;
         }
         var _loc6_:* = 0;
         ...
         {
            _loc3_ = getItem(_loc10_);
            if(!_loc3_)
            {
               continue;
            }
            if(!(_loc7_ = _loc3_.battleSkillData))
            {
               continue;
            }
            _loc8_ = BattleEffect.battleEffectToBattleSkills(109);
            for each(var _loc9_ in _loc8_)
            {
               _loc4_ = BattleEffect.battleSkillToBattleSkillIdentifier(_loc9_);
               if(_loc7_.id == _loc4_)
               {
                  _loc6_ += _loc7_.value1;
               }
            }
            switch(int(param1) - 1)
            {
               case 0:
                  _loc8_ = BattleEffect.battleEffectToBattleSkills(106);
                  ...
                  break;
               case 1:
                  _loc8_ = BattleEffect.battleEffectToBattleSkills(105);
                  for each(_loc9_ in _loc8_)
                  {
                     _loc4_ = BattleEffect.battleSkillToBattleSkillIdentifier(_loc9_);
                     if(_loc7_.id == _loc4_)
                  ...
                  break;
               case 2:
                  _loc8_ = BattleEffect.battleEffectToBattleSkills(107);
                  for each(_loc9_ in _loc8_)
                  {
                     _loc4_ = BattleEffect.battleSkillToBattleSkillIdentifier(_loc9_);
                     if(_loc7_.id == _loc4_)
                  ...
                  break;
               case 3:
                  _loc8_ = BattleEffect.battleEffectToBattleSkills(108);
                  for each(_loc9_ in _loc8_)
                  {
                     _loc4_ = BattleEffect.battleSkillToBattleSkillIdentifier(_loc9_);
                     if(_loc7_.id == _loc4_)
         ...
         {
            case 0:
               _loc5_ = statBaseStamina;
               break;
            case 1:
               _loc5_ = statBaseStrength;
               break;
            case 2:
               _loc5_ = statBaseCriticalRating;
               break;
            case 3:
               _loc5_ = statBaseDodgeRating;
         }
         return Math.ceil(_loc5_ * _loc6_);
      }
      ...
      public function get nameWithTitle() : String
      {
         ...
         return Titles.instance.getNameWithTitle(_loc1_,super.title,gender);
      }
      ...
      override public function get title() : String
      {
         ...
         return Titles.instance.getTitle(super.title).title;
      }
      ...
      public function get secondsToNextFreeDuel() : int
      {
         ...
         return int(secondsToNextDuelStaminaRefill + totalSecondsNeededForDuelStaminaProgress * _loc2_);
      }
      ...
      public function get secondsToNextDuelStaminaRefill() : int
      {
         ...
         {
            _duelStaminaCorrection += totalSecondsNeededForDuelStaminaProgress;
            _duelStaminaCorrectionValue += 1;
      ...
      public function getTotalStats(param1:Boolean = false) : int
      {
         return getStatValue(1,param1) + getStatValue(2,param1) + getStatValue(3,param1) + getStatValue(4,param1) + statWeaponDamage;
      }
      ...
      public function getStageQuestIdsForStage(param1:int) : Vector.<int>
      {
         ...
         return Vector.<int>(_loc2_[param1]);
      }
      ...
      public function getNeededImproveStatGameCurrency(param1:int, param2:int) : int
      {
         ...
         {
            _loc4_ += GameUtil.calcNeededGameCurrency(_loc3_);
            _loc3_++;
         }
         return _loc4_;
      }
      
      public function getStatValue(param1:int, param2:Boolean = false) : int
      {
         switch(int(param1) - 1)
         {
            case 0:
               return statTotalStamina + (!!param2 ? seasonBaseStatBonus(param1,106) + seasonBaseStatBonus(param1,109) : 0);
            case 1:
               return statTotalStrength + (!!param2 ? seasonBaseStatBonus(param1,105) + seasonBaseStatBonus(param1,109) : 0);
            case 2:
               return statTotalCriticalRating + (!!param2 ? seasonBaseStatBonus(param1,107) + seasonBaseStatBonus(param1,109) : 0);
            case 3:
               return statTotalDodgeRating + (!!param2 ? seasonBaseStatBonus(param1,108) + seasonBaseStatBonus(param1,109) : 0);
            default:
               return 0;
         }
      }
      ...
      public function getMissilesDamage(param1:Boolean = false) : int
      {
         var _loc2_:Item = getItem("missiles_item_id");
         if(_loc2_ == null)
         {
            return 0;
         }
         return _loc2_.getMissileDamage(param1);
      }
      ...
      {
         var _loc1_:* = null;
         if(AppConfig.dungeonsEnabled !== true)
         {
            return false;
         }
      ...
      {
         return movieId != 0 && _movies.exists(movieId);
      }
      ...
      public function refreshDrawEvent(param1:DODrawEvent) : void
      {
         var _loc2_:* = null;
         if(!param1.hasData("id") && !param1.hasData("identifier"))
         {
         ...
         if(param1.hasData("id"))
         {
            for each(var _loc3_ in _drawEvents)
            {
               if(_loc3_.hasData("id"))
               {
                  if(_loc3_.id == param1.id)
                  {
                     _loc4_ = _loc3_;
         ...
         if(!_loc4_)
         {
            for each(_loc3_ in _drawEvents)
            {
         ...
         if(_loc4_ == null)
         {
            _loc2_ = new DrawEvent(param1);
            _drawEvents.push(_loc2_);
         }
         else
         {
            _loc4_.update(param1);
      ...
      public function get drawEvent() : DrawEvent
      {
         if(!hasDrawEvent)
         {
            return null;
         }
         for each(var _loc1_ in _drawEvents)
         {
            if(_loc1_.id == drawEventId)
            {
               return _loc1_;
            }
         }
      ...
      public function get hasDrawEvent() : Boolean
      {
         return drawEventId != 0;
      }
      
      public function get unassignedDrawEvent() : DrawEvent
      {
         for each(var _loc1_ in _drawEvents)
         {
            if(_loc1_.isUnassigned)
      ...
      public function get hasUnassignedDrawEvent() : Boolean
      {
         return unassignedDrawEvent != null;
      }
      ...
      public function eventItemInStage(param1:int) : Vector.<String>
      {
         ...
         var _loc4_:Object;
         var _loc7_:Array = (_loc4_ = JsonUtil.decode(_loc3_))[param1];
         for each(var _loc2_ in _loc7_)
         {
            if((_loc6_ = _quests.getData(_loc2_)).reward.eventItemIdentifier != null)
            {
      ...
      public function getUnusedResourceCount(param1:int) : int
      {
         ...
         if(_loc3_ != "")
         {
            try
            {
               ...
               return _loc2_.getInt(param1.toString());
            }
            catch(e:Error)
            {
      ...
      public function itemSetStatValue(param1:int) : int
      {
         ...
         var _loc4_:TypedObject;
         if(!(_loc4_ = this.equippedItemSetData))
         {
            return 0;
         }
         var _loc3_:int = 0;
         ...
         {
            _loc5_ = (_loc7_ = new ItemSet(_loc8_,this)).characterBonusData;
            for(var _loc6_ in _loc5_)
            {
               if(_loc6_ == param1)
               {
                  _loc2_ += Math.ceil(_loc3_ * _loc5_[_loc6_]);
               }
            }
         }
         return _loc2_;
      ...
      public function get equippedItemSetData() : TypedObject
      {
         ...
         if(_loc1_ != "")
         {
            try
            {
               return new TypedObject(JsonUtil.decode(_loc1_));
            }
            catch(e:Error)
            {
               Logger.debug("[Character] Exception: \'" + e.message + "\'");
      ...
      public function setTutorialFlag(param1:String) : void
      {
         ...
         if(_loc2_.getBoolean(param1) !== true)
         {
            _loc2_.setBoolean(param1,true);
            _loc3_ = _loc2_.asJsonString;
            if(param1 == "tutorial_finished")
            {
               UiPremiumCurrencyPanel.instance.offset += CConstant.tutorial_finished_premium_currency;
            }
      ...
      public function getQuestsVisibleOnCitymapForStage(param1:int) : Vector.<Quest>
      {
         ...
         try
         {
            ...
            _loc7_ = (_loc4_ = JsonUtil.decode(_loc2_))[param1];
            _loc3_ = new Vector.<Quest>();
            for each(var _loc5_ in _loc7_)
            {
               if((_loc6_ = this.quests[_loc5_]).visibleOnMap)
               {
                  _loc3_.push(_loc6_);
               }
            }
      ...
      public function itemsInStage(param1:int) : Vector.<Item>
      {
         ...
         for each(var _loc2_ in _loc7_)
         {
            if((_loc6_ = _quests.getData(_loc2_)).reward.itemId > 0)
            {
      ...
      public function movieVotesInStage(param1:int) : Vector.<int>
      {
         ...
         for each(var _loc2_ in _loc7_)
         {
            if((_loc6_ = _quests.getData(_loc2_)).reward.movieVotes > 0)
            {
      ...
      public function dungeonKeyInStage(param1:int) : Boolean
      {
         ...
         var _loc3_:String = getString("quest_pool");
         var _loc4_:Object;
         var _loc6_:Array = (_loc4_ = JsonUtil.decode(_loc3_))[param1];
         for each(var _loc2_ in _loc6_)
         {
            if((_loc5_ = _quests.getData(_loc2_)).reward.dungeonKey)
            {
               return true;
            }
         }
      ...
      public function refreshTitle(param1:DOTitle, param2:Boolean = true) : void
      {
         ...
         if(_titles != null && !_titles.exists(_loc3_))
         {
      ...
      public function get currentWorkDuration() : int
      {
         ...
         return int(Math.floor(currentWorkDurationRaw / _loc2_) * _loc2_);
      }
      ...
      public function get secondsToNextMovieQuest() : int
      {
         ...
         if(movie && movie.isOpen)
         {
            ...
            return (_loc5_ = _loc4_.energyCost - movieEnergy - 1) * _loc3_ + _loc1_;
         }
         return 0;
      }
      ...
      public function get remainingMoviesToday() : int
      {
         ...
         var _loc5_:Number;
         if((_loc5_ = BonusInfo.getValue(9)) > 0)
         {
            _loc7_ *= _loc5_;
         }
      ...
      public function getUserStoryQuestInStage(param1:int) : Quest
      {
         ...
         var _loc6_:Array;
         var _loc4_:Object;
         if((_loc6_ = (_loc4_ = JsonUtil.decode(_loc3_))[param1]) != null)
         {
            for each(var _loc2_ in _loc6_)
            {
               if((_loc5_ = _quests.getData(_loc2_)).isUserStoryQuest)
               {
                  return _loc5_;
               }
            }
      ...
      public function refreshSeasonProgress(param1:DOSeasonProgress) : void
      {
         this.seasonProgress.refresh(param1);
      }
      
      public function get seasonProgress() : SeasonProgress
      {
         if(!_seasonProgress)
         {
            _seasonProgress = new SeasonProgress();
         }
         return _seasonProgress;
      }
      
      public function seasonBaseStatBonus(param1:int, param2:int) : int
      {
         var _loc4_:* = undefined;
         var _loc6_:Number = NaN;
         var _loc3_:int = 0;
         if(seasonProgress && seasonProgress.isActive())
         {
            _loc4_ = BattleEffect.battleEffectToBattleSkills(param2);
            for each(var _loc5_ in _loc4_)
            {
               if(seasonProgress.effectSkillId != _loc5_)
               {
                  continue;
               }
               _loc6_ = seasonProgress.effectSkillValue1;
               switch(int(param1) - 1)
               {
                  case 0:
                     _loc3_ += Math.ceil(statBaseStamina * _loc6_);
                     break;
                  case 1:
                     _loc3_ += Math.ceil(statBaseStrength * _loc6_);
                     break;
                  case 2:
                     _loc3_ += Math.ceil(statBaseCriticalRating * _loc6_);
                     break;
                  case 3:
                     _loc3_ += Math.ceil(statBaseDodgeRating * _loc6_);
                     break;
               }
            }
         }
      ...
      public function refreshNews(param1:TypedObject) : void
      {
         if(param1 == null)
         {
            return;
         }
         _news = new News(param1);
      }
