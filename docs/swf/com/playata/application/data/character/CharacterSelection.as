package com.playata.application.data.character
{
   ...
   public class CharacterSelection
   {
      ...
      public function CharacterSelection()
      {
         ...
         super();
         _useCache = Environment.platform.isSteam || Environment.info.isNativeMobile || Environment.application is WindowsApplication;
      }
      ...
      public function load(param1:Function) : void
      {
         ...
         if(_useCache)
         {
            ...
            if(_loc2_)
            {
               ...
               {
                  (_loc5_ = TypedObject.empty).setInt("user_id",_loc4_.user_id);
      ...
      private function handleRequests(param1:ActionRequestResponse) : void
      {
         ...
         if(param1.error == "")
         {
            ...
            if(_loc4_ = param1.appResponse.redirect_url)
            {
