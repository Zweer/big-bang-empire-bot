package com.playata.application.data.character
{
   ...
   public class LeaderboardCharacter extends DOLeaderboardCharacter implements ICharacterTooltipProvider
   {
      ...
      public function get nameWithTitle() : String
      {
         ...
         return Titles.instance.getNameWithTitle(_loc1_,getString("title"),gender);
      }
      ...
      override public function get attackedCount() : int
      {
         if(!hasData("attacked_count"))
         {
            return 0;
         }
         return getInt("attacked_count");
      }
      
      override public function get maxAttackCount() : int
      {
         if(!hasData("max_attack_count"))
         {
            return 3;
         }
         return getInt("max_attack_count");
      }
   }
}
