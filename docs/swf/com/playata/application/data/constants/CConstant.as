package com.playata.application.data.constants
{
   ...
   public class CConstant
   {
      ...
      public static function get season_min_level() : int
      {
         return Constants.current.getInt("season_min_level");
      }
      
      public static function get season_reward_game_currency_time() : int
      {
         return Constants.current.getInt("season_reward_game_currency_time");
      }
      
      public static function get season_reward_xp_time() : int
      {
         return Constants.current.getInt("season_reward_xp_time");
      }
