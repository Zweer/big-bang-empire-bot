package com.playata.application.data.dating
{
   ...
   public class DatingStep extends DODatingStep
   {
      ...
      public function get progressText() : String
      {
         ...
         return StringUtil.replace(_loc1_,"<progress_value>",LocText.current.formatHugeNumber(Math.min(pointsCollected,pointsNeeded)));
      }
      ...
      public function get failedAttributeHint() : String
      {
         ...
         var _loc5_:Character;
         var _loc6_:Outfit = (_loc5_ = User.current.character).outfits.getOutfitWithSetting(_loc7_);
         var _loc8_:int = 0;
         if(_loc6_)
         {
