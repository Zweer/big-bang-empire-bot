   ...
   public class EventQuest extends DOEventQuest
   {
      ...
      public function get progressValue() : int
      {
         ...
         for each(var _loc3_ in _objectives)
         {
            ...
            {
               _loc1_ += _loc3_.progressValue / 100 * _loc2_;
            }
         }
      ...
      public function get conventionStartTimes() : String
      {
         ...
         if(hasData("convention_start_times"))
         {
            ...
            {
               if((_loc4_ = DateTime.fromStringServer(_loc5_).timestamp) > _loc2_)
               {
                  _loc6_.push(_loc4_);
                  if(_loc6_.length >= 3)
                  {
         ...
         while(_loc3_ < _loc6_.length)
         {
            ...
            _loc1_ += AppDateTime.getDateTimeString(TimeUtil.localDateTime,_loc6_[_loc3_],1);
            _loc3_++;
         }
         return _loc1_;
      }
