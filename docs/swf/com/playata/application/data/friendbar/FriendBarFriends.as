package com.playata.application.data.friendbar
{
   ...
   public class FriendBarFriends
   {
      ...
      public function addFriend(param1:int, param2:int, param3:String, param4:int, param5:Boolean, param6:IImage) : void
      {
         ...
         var _loc7_:FriendBarFriend;
         (_loc7_ = new FriendBarFriend(new DOFriend({
            "user_id":param1,
            "character_id":param2,
      ...
      {
         var _loc2_:Vector.<FriendBarFriend> = new Vector.<FriendBarFriend>();
         for each(var _loc3_ in _friends)
         {
            if(_loc3_.characterName.toLowerCase().indexOf(param1.toLowerCase()) >= 0)
            {
               _loc2_.push(_loc3_);
            }
         }
