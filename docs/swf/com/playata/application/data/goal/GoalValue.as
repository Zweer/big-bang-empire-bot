package com.playata.application.data.goal
{
   ...
   public class GoalValue extends DataObject implements IListItem
   {
      ...
      public function isAvailable(param1:Character) : Boolean
      {
         ...
         return _goal.currentGoalValue(param1) == this;
      }
      ...
      public function get title() : String
      {
         ...
         var _loc1_:String = !!goal.isHidden ? "" : goal.position.toString() + ". ";
         return _loc2_ + _loc1_ + LocText.current.text("goal/" + _goal.identifier + "/title");
      }
      ...
      public function get itemId() : String
      {
         if(!_itemId)
         {
            _itemId = goal.position + "_" + value + (!!goal.isHidden ? "_hidden" : "");
         }
         return _itemId;
      }
   }
