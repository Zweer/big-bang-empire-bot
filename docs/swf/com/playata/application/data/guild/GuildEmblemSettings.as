package com.playata.application.data.guild
{
   ...
   public class GuildEmblemSettings
   {
      ...
      {
         return new GuildEmblemSettings(param1.emblemBackgroundShape,param1.emblemBackgroundColor,param1.emblemBackgroundBorderColor,param1.emblemIconShape,param1.emblemIconColor,param1.emblemIconSize);
      }
      ...
      {
         return new GuildEmblemSettings(param1.emblemBackgroundShapeId,param1.emblemBackgroundColorIndex,param1.emblemBackgroundBorderColorIndex,param1.emblemIconShapeId,param1.emblemIconColorIndex,param1.emblemIconSize);
      }
