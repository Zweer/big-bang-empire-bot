package com.playata.application.data.herobook
{
   ...
   public class HerobookObjective extends DOHerobookObjective
   {
      ...
      public function getValueText(param1:String) : String
      {
         ...
         return StringUtil.replace(_loc2_,"<progress_value>",LocText.current.formatHugeNumber(Math.min(currentValue,maxValue)));
      }
      ...
      public function get characterImageUrl() : String
      {
         ...
         if(User.current && User.current.character && User.current.character.isMale)
         {
      ...
      public function get rewardText() : String
      {
         ...
         {
            return reward.statPointsString;
         }
         if(isXpReward)
         {
         ...
         {
            return reward.questEnergyString;
         }
         if(isFansReward)
         {
            return reward.fansString;
         }
         if(isStreamingResourceReward)
         {
            return reward.streamingResourceString;
         }
         return "";
      }
      ...
      public function get isFansReward() : Boolean
      {
         return reward.fans > 0;
      }
      
      public function get isStreamingResourceReward() : Boolean
      {
         return reward.streamingResource > 0;
      }
