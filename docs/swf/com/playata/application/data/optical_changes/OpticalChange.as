package com.playata.application.data.optical_changes
{
   ...
   public class OpticalChange extends DataObject
   {
      ...
      public function hasSourceInfo() : Boolean
      {
         if(event != null && event != "")
         {
            return true;
      ...
      {
         if(tsAvailabilityEnd != null && DateTime.fromStringServer(tsAvailabilityEnd).timestamp < TimeUtil.now)
         {
            return LocText.current.text("optical_change/no_longer_available");
         }
         if(event != null && event != "")
         {
         ...
         if(season != null && season != "")
         {
            return LocText.current.text("optical_change/source/season/" + season);
         }
         return "";
      }
