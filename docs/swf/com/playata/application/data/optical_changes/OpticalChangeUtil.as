package com.playata.application.data.optical_changes
{
   ...
   public class OpticalChangeUtil
   {
      ...
      public static function setBackground(param1:Vector.<int>, param2:SymbolDummyGeneric = null, param3:int = 0, param4:int = 0, param5:Function = null) : void
      {
         if((param1 == null || param1.length == 0) && param4 != 1)
         {
            ViewManager.instance.setBackground(param4);
            if(param2)
            {
         ...
         var _loc6_:int = Environment.taskManager.startTask(OpticalChangeImageTask,null,onResult,AppFlashTaskManager.useAsyncTask,param1);
         activeTasks.push([_loc6_,param2,param5]);
      }
      ...
      private static function onResult(param1:int, param2:IByteArray, param3:int, param4:int) : void
      {
         ...
         try
         {
            ...
            if(!(_loc5_ = DisplayObjectFactory.createImageFromBitmapData(_loc6_)))
            {
               return;
            }
            if(_loc9_)
