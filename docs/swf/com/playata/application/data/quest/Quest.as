package com.playata.application.data.quest
{
   ...
   public class Quest extends DOQuest implements IDurationEvent, IStatQuest
   {
      ...
      public function get title() : String
      {
         ...
         if(isUserStoryQuest)
         {
            _loc1_ = UserStories.getUserStory(parseInt(identifier));
            if(_loc1_)
            {
               return _loc1_.title;
            }
         ...
         if(isTimeQuest)
         {
            return LocText.current.text("screen/quest/button_time_quest_tooltip");
         }
         if(isFightQuest)
         {
            return LocText.current.text("screen/quest/button_fight_quest_tooltip");
         }
         if(isStatQuest)
         {
            return LocText.current.text("screen/quest/button_stat_quest_tooltip");
         }
         return "";
      }
         ...
         if(reward.movieVotes > 0)
         {
            ...
            if(_loc3_)
            {
               ...
               else if(_loc3_.statPoints)
               {
                  ...
                  _loc4_ += Math.min(_loc7_,_loc5_,_loc8_,_loc6_);
               }
            }
         }
         return _loc4_;
