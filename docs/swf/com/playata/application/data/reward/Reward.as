package com.playata.application.data.reward
{
   ...
   public class Reward
   {
      ...
      {
         var _loc1_:TypedObject = _reward.getTypedObject("booster");
         if(!_loc1_)
         {
            return null;
         }
         if(_loc1_.hasData("booster_id"))
         {
            return _loc1_.getString("booster_id");
         }
         return null;
      }
      
      public function get boosterDays() : int
      {
         var _loc1_:TypedObject = _reward.getTypedObject("booster");
         if(!_loc1_)
         {
         ...
         if(_loc1_.hasData("days"))
         {
            return _loc1_.getInt("days");
         }
         return 0;
      }
      ...
      public function get hasOpticalChangeReward() : Boolean
      {
         return opticalChange != null && !opticalChange.isUnlocked;
      }
      
      public function get opticalChange() : OpticalChange
      {
         if(!_reward.hasData("optical_change",true))
         {
            return null;
         }
         return OpticalChanges.instance.getOpticalChangeById(_reward.getInt("optical_change"));
      }
      ...
      public function get datingItemIdentifier() : String
      {
         ...
         if(_loc3_)
         {
            ...
            {
               if((_loc4_ = _loc2_.datingSteps[_loc1_]).rewardReference == _loc3_ && _loc4_.isStarted)
               {
                  return _loc3_;
               }
               _loc1_++;
