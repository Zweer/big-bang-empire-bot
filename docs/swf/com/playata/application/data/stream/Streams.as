package com.playata.application.data.stream
{
   ...
   public class Streams
   {
      ...
      {
         var _loc1_:int = 0;
         _loc1_ += _serverSystemMessages.unreadCount;
         _loc1_ += _privateSystemMessages.unreadCount;
         _loc1_ += _privateConversations.unreadCount;
         _loc1_ += _resourceRequests.unreadCount;
         _loc1_ += _userVouchers.unreadCount;
