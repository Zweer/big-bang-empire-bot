package com.playata.application.data.user
{
   ...
   public class User extends UserBase
   {
      ...
      public function get userVoucherFilter() : UserVoucherFilter
      {
         if(hasSetting("user_voucher_filter_settings"))
         {
            return new UserVoucherFilter(getSettingValue("user_voucher_filter_settings"));
         }
         return null;
      }
      ...
      public function getWhiteLabelId() : String
      {
         ...
         if(_loc3_ != "")
         {
            if(_loc4_ = Platform.getWhiteLabelId(_loc3_))
            {
               return _loc4_;
            }
         }
         ...
         if(!_loc1_)
         {
            if(_loc4_ = AppEnvironment.appPlatform.whiteLabelId)
            {
               return _loc4_;
            }
            return null;
         ...
         {
            if((_loc5_ = _loc2_[_loc4_])["active"])
            {
      ...
      public function get titleFilter() : TitleFilter
      {
         if(hasSetting("title_filter_settings"))
         {
            return new TitleFilter(getSettingValue("title_filter_settings"));
         }
         return null;
      }
   }
