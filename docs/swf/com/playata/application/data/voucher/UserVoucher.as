package com.playata.application.data.voucher
{
   ...
   public class UserVoucher extends DOUserVoucher implements IListItem
   {
      ...
      public function get rewardString() : String
      {
         ...
         if(this.isQuestEnergyReward)
         {
            _loc1_ += LocText.current.text("dialog/redeem_voucher/explanation_line",LocText.current.text("message/generic_user_voucher/body_energy",this.reward.getRewardCount("quest_energy"))) + "\n";
         }
         if(this.isQuestBoosterReward)
         {
            _loc1_ += LocText.current.text("dialog/redeem_voucher/explanation_line",LocText.current.text("message/generic_user_voucher/body_quest_booster",this.reward.getBoosterType("quest_booster"),this.reward.getBoosterDuration("quest_booster"))) + "\n";
         }
         if(this.isStatBoosterReward)
         {
            _loc1_ += LocText.current.text("dialog/redeem_voucher/explanation_line",LocText.current.text("message/generic_user_voucher/body_stat_booster",this.reward.getBoosterType("stats_booster"),this.reward.getBoosterDuration("stats_booster"))) + "\n";
         }
         if(this.isWorkBoosterReward)
         {
            _loc1_ += LocText.current.text("dialog/redeem_voucher/explanation_line",LocText.current.text("message/generic_user_voucher/body_work_booster",this.reward.getBoosterType("work_booster"),this.reward.getBoosterDuration("work_booster"))) + "\n";
         }
         if(this.isSenseBoosterReward)
         {
            _loc1_ += LocText.current.text("dialog/redeem_voucher/explanation_line",LocText.current.text("message/generic_user_voucher/body_sense_booster",TimeUtil.secondsToString(this.reward.getBoosterDuration("sense_booster") * 3600))) + "\n";
         }
         if(this.isMultitaskingBoosterReward)
         {
            _loc1_ += LocText.current.text("dialog/redeem_voucher/explanation_line",LocText.current.text("message/generic_user_voucher/body_multitasking_booster",TimeUtil.secondsToString(this.reward.getBoosterDuration("multitasking_booster") * 3600))) + "\n";
         }
         if(this.isPremiumCurrencyReward)
         {
            _loc1_ += LocText.current.text("dialog/redeem_voucher/explanation_line",LocText.current.text("message/generic_user_voucher/body_premium_currency",this.reward.getRewardCount("body_premium_currency"))) + "\n";
         }
         if(this.isPremiumCurrencyDonatableReward)
         {
            _loc1_ += LocText.current.text("dialog/redeem_voucher/explanation_line",LocText.current.text("message/generic_user_voucher/body_premium_currency_donatable",this.reward.getRewardCount("premium_currency_donatable"))) + "\n";
         }
         if(!_loc1_)
         {
