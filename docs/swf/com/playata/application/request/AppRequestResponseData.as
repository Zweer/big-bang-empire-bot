package com.playata.application.request
{
   ...
   public class AppRequestResponseData extends TypedObject
   {
      ...
      public function get streaming_shows() : DataObjectArray
      {
         if(hasData("streaming_shows",true))
         {
            return new DataObjectArray(getArray("streaming_shows"),DOStreamingShow);
         }
         return null;
      }
      ...
      public function get user_story() : DOUserStory
      {
         if(hasData("user_story",true))
         {
            return new DOUserStory(getData("user_story"));
         }
         return null;
      }
      ...
      public function get draw_event() : DODrawEvent
      {
         if(hasData("draw_event",true))
         {
            return new DODrawEvent(getData("draw_event"));
         }
         return null;
      }
      ...
      public function get leaderboard_server_selection_data() : TypedObject
      {
         return getTypedObject("leaderboard_server_selection_data");
      }
      
      public function get streams_info() : TypedObject
      {
         return getTypedObject("streams_info");
      }
      ...
      public function get season_progress() : DOSeasonProgress
      {
         if(hasData("season_progress",true))
         {
            return new DOSeasonProgress(getData("season_progress"));
         }
         return null;
      }
      ...
      public function get goal_item_ids() : TypedObject
      {
         return getTypedObject("goal_item_ids");
      }
      ...
      public function get private_system_message() : DOPrivateSystemMessage
      {
         if(hasData("private_system_message",true))
         {
            return new DOPrivateSystemMessage(getData("private_system_message"));
         }
         return null;
      }
      ...
      public function get last_sync() : String
      {
      ...
      public function get season_reward() : DOSeasonReward
      {
         if(hasData("season_reward",true))
         {
            return new DOSeasonReward(getData("season_reward"));
         }
         return null;
      }
      
      public function get season_rewards() : DataObjectArray
      {
         if(hasData("season_rewards",true))
         {
            return new DataObjectArray(getArray("season_rewards"),DOSeasonReward);
         }
         return null;
      }
      ...
      public function get news() : TypedObject
      {
         return getTypedObject("news");
      }
      
      public function get private_conversation() : DOPrivateConversation
      {
         if(hasData("private_conversation",true))
         {
            return new DOPrivateConversation(getData("private_conversation"));
         }
         return null;
      }
      
      public function get stream_id() : int
      {
         return getInt("stream_id");
      }
      
      public function get private_conversation_message() : DOPrivateConversationMessage
      {
         if(hasData("private_conversation_message",true))
         {
            return new DOPrivateConversationMessage(getData("private_conversation_message"));
         }
         return null;
      }
      
      public function get messages_ignored_character_info() : DataObjectArray
      {
         if(hasData("messages_ignored_character_info",true))
         {
            return new DataObjectArray(getArray("messages_ignored_character_info"),DOIgnoredCharacter);
         }
         return null;
      }
      
      public function get all_loaded() : Boolean
      {
         return getBoolean("all_loaded");
      }
      
      public function get user_voucher() : DOUserVoucher
      {
         if(hasData("user_voucher",true))
         {
            return new DOUserVoucher(getData("user_voucher"));
         }
         return null;
      }
      
      public function get user_vouchers() : DataObjectArray
      {
         if(hasData("user_vouchers",true))
         {
            return new DataObjectArray(getArray("user_vouchers"),DOUserVoucher);
         }
         return null;
      }
      
      public function get server_system_messages() : DataObjectArray
      {
         if(hasData("server_system_messages",true))
         {
            return new DataObjectArray(getArray("server_system_messages"),DOServerSystemMessage);
         }
         return null;
      }
      
      public function get private_system_messages() : DataObjectArray
      {
         if(hasData("private_system_messages",true))
         {
            return new DataObjectArray(getArray("private_system_messages"),DOPrivateSystemMessage);
         }
         return null;
      }
      
      public function get private_conversation_messages() : DataObjectArray
      {
         if(hasData("private_conversation_messages",true))
         {
            return new DataObjectArray(getArray("private_conversation_messages"),DOPrivateConversationMessage);
         }
         return null;
      }
      
      public function get private_conversations() : DataObjectArray
      {
         if(hasData("private_conversations",true))
         {
            return new DataObjectArray(getArray("private_conversations"),DOPrivateConversation);
         }
         return null;
      }
      
      public function get streaming() : DOStreaming
      {
         if(hasData("streaming",true))
         {
            return new DOStreaming(getData("streaming"));
         }
         return null;
      }
      
      public function get streaming_show() : DOStreamingShow
      {
         if(hasData("streaming_show",true))
         {
            return new DOStreamingShow(getData("streaming_show"));
         }
         return null;
      }
      
      public function get global_tournament_end_timestamp() : int
      {
         return getInt("global_tournament_end_timestamp");
      }
      ...
      public function get global_tournament_rewards() : DOGlobalCharacterTournamentReward
      {
         if(hasData("global_tournament_rewards",true))
         {
            return new DOGlobalCharacterTournamentReward(getData("global_tournament_rewards"));
         }
         return null;
      }
      ...
      public function get has_marketing_email() : Boolean
      {
         return getBoolean("has_marketing_email");
      }
      ...
      public function get server_system_message_teaser_info() : String
      {
         return getString("server_system_message_teaser_info");
      }
      ...
      public function get reported_user_stories() : Vector.<int>
      {
         return getIntVector("reported_user_stories");
      }
      
      public function get locale_version() : String
      {
         return getString("locale_version");
      }
      ...
      public function get user_story_count() : int
      {
         return getInt("user_story_count");
      }
      
      public function get user_story_ids() : Vector.<int>
      {
         return getIntVector("user_story_ids");
      }
      
      public function get user_stories() : DataObjectArray
      {
         if(hasData("user_stories",true))
         {
            return new DataObjectArray(getArray("user_stories"),DOUserStory);
         }
         return null;
      }
      
      public function get user_stories_end_timestamp() : int
      {
         return getInt("user_stories_end_timestamp");
      }
