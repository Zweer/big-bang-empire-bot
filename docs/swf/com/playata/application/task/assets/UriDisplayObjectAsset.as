package com.playata.application.task.assets
{
   ...
   public class UriDisplayObjectAsset extends Sprite
   {
      ...
      {
         var _loc11_:UriDisplayObjectAssetDefinition;
         (_loc11_ = new UriDisplayObjectAssetDefinition()).uri = param1;
      ...
      public function clone(param1:Function) : UriDisplayObjectAsset
      {
         ...
         var _loc8_:* = null;
         var _loc6_:* = null;
         var _loc4_:UriDisplayObjectAsset;
         (_loc4_ = new UriDisplayObjectAsset())._uri = _uri;
