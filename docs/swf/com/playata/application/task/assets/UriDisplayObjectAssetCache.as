package com.playata.application.task.assets
{
   ...
   public class UriDisplayObjectAssetCache
   {
      ...
      public function getUriDisplayObjectAsset(param1:UriDisplayObjectAssetDefinition, param2:int) : UriDisplayObjectAsset
      {
         ...
         {
            _loc3_ = (_loc6_ = _cache.getData(_loc5_) as Vector.<UriDisplayObjectAsset>)[0] as UriDisplayObjectAsset;
            ...
            if(_loc3_.isDownloaded)
            {
               ...
               if((_loc4_ = _loc6_[_loc7_]).isDownloaded)
               {
         ...
         var _loc10_:UriDisplayObjectAsset;
         (_loc10_ = new UriDisplayObjectAsset(param1.settings)).loadAsset();
         var _loc9_:Vector.<UriDisplayObjectAsset>;
         (_loc9_ = new Vector.<UriDisplayObjectAsset>()).push(_loc10_);
