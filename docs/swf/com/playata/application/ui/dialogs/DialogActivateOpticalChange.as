package com.playata.application.ui.dialogs
{
   ...
   public class DialogActivateOpticalChange extends UiDialog
   {
      ...
      private function refreshOpticalChange(param1:OpticalChange) : void
      {
         ...
         _btnPrevious.enabled = _btnNext.enabled = _opticalChangeCategorie != null;
         _previewTarget = 0;
         refresh();
      }
      ...
      private function updatePreview() : void
      {
         ...
         OpticalChangeUtil.setBackground(_loc1_,null,0,0,onBackgroundLoaded);
      ...
      private function showBackground() : void
      {
         ...
         try
         {
            _content.preview.addChild(_animationLayerBehind);
            _content.preview.addChild(_backgroundImage);
            _content.preview.addChild(_animationLayerInfront);
         }
         catch(e:Error)
         {
         }
      ...
      private function updateButton() : void
      {
         ...
         _btnSourceInfo.visible = _opticalChange.hasSourceInfo();
      ...
      override public function dispose() : void
      {
         ...
         _animationLayerBehind.dispose();
         _animationLayerBehind = null;
         _animationLayerInfront.dispose();
         _animationLayerInfront = null;
         if(_backgroundImage)
         {
            _backgroundImage.dispose();
            _backgroundImage = null;
