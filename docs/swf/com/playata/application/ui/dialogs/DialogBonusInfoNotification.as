package com.playata.application.ui.dialogs
{
   ...
   public class DialogBonusInfoNotification extends UiDialog
   {
      ...
      private var _scrollContainer:UiLabelScrollContainer = null;
      ...
      public function DialogBonusInfoNotification()
      {
         ...
         for each(var _loc2_ in _loc14_)
         {
            ...
            if(!_loc7_)
            {
               (_loc10_ = new Vector.<DOBonusInfoDay>()).push(_loc2_);
               _loc6_.push(_loc10_);
            }
         }
         ...
         _scrollContainer = new UiLabelScrollContainer(_loc16_.txtInfo);
         _scrollContainer.text = LocText.current.text("dialog/bonus_info_notification/" + _loc1_ + "/info");
         ...
         if(_bonus.length != MAX_BONUS_INFOS)
         {
            ...
            while(_loc9_ <= MAX_BONUS_INFOS)
            {
               _loc16_["position" + _loc9_].x += _loc3_;
               _loc9_++;
            }
         }
         ...
         if(_loc16_.txtBonusInfo.numLines > 1)
         {
            ...
            _btnOk.y += _loc3_;
            _loc16_.bonusBackground.height += _loc3_;
            _loc16_.dialogBackground.height += _loc3_;
            _yOffset = -_loc3_ / 2;
         }
      }
