package com.playata.application.ui.dialogs
{
   ...
   public class DialogBoosters extends UiDialog
   {
      ...
      public function DialogBoosters(param1:Function = null)
      {
         ...
         if(_loc3_)
         {
            if((_loc5_ = _loc4_.txtBoostQuest.text).indexOf(" ") >= 0)
            {
               _loc4_.txtBoostQuest.y -= 20;
               _loc4_.txtBoostQuest.height += 30;
            ...
            if((_loc5_ = _loc4_.txtBoostStats.text).indexOf(" ") >= 0)
            {
               _loc4_.txtBoostStats.y -= 20;
               _loc4_.txtBoostStats.height += 30;
               _loc4_.txtBoostStats.text = _loc5_.substr(0,_loc5_.lastIndexOf(" ")) + "\n" + _loc5_.substr(_loc5_.lastIndexOf(" ") + 1);
               _loc4_.txtBoostStats.autoFontSize = true;
            }
            if((_loc5_ = _loc4_.txtBoostWork.text).indexOf(" ") >= 0)
            {
               _loc4_.txtBoostWork.y -= 20;
               _loc4_.txtBoostWork.height += 30;
