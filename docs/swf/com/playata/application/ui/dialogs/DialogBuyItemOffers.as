   ...
   public class DialogBuyItemOffers extends DialogPaymentBase
   {
      ...
      public function DialogBuyItemOffers()
      {
         ...
         if(_loc1_)
         {
            ...
            _loc2_ = 100;
            vo.dialogBackground.height -= _loc2_;
            vo.dialogBackground.y += _loc2_;
            vo.btnHelp.y += _loc2_;
            vo.btnClose.y += _loc2_;
            vo.txtDialogTitle.y += _loc2_;
            _yOffset = -50;
         }
      ...
      public static function hasConsumableOfferPaymentMethod(param1:Vector.<IBillingProduct>, param2:String, param3:int) : Boolean
      {
         ...
         for each(var _loc4_ in param1)
         {
            if(_loc4_.paymentMethodId == param3)
            {
               ...
               {
                  if((_loc5_ = _loc4_.info as ConsumableBillingProductInfo).consumableOfferId == param2)
                  {
                     return true;
                  }
               }
      ...
      private function onRequestProductsComplete(param1:Vector.<IBillingProduct>) : void
      {
         ...
         for each(var _loc8_ in ItemOfferCategories.instance.itemOfferCategories)
         {
            ...
            {
               (_loc9_ = new SymbolButtonTabGeneric()).scale = 0.65;
               _loc9_.clear.caption.fontSize = 18;
               _loc9_.tabbed.caption.fontSize = 18;
               _loc9_.clear.caption.autoFontSize = true;
               _loc9_.tabbed.caption.autoFontSize = true;
         ...
         {
            AppUiUtil.alignVerticallyCentered(vo,-30,_loc5_);
         }
         vo.avatar.bringToTop();
