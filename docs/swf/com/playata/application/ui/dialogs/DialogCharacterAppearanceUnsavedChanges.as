package com.playata.application.ui.dialogs
{
   ...
   public class DialogCharacterAppearanceUnsavedChanges extends UiDialog
   {
      ...
      private function resizeDialog(param1:SymbolDialogCharacterAppearanceUnsavedChangesGeneric) : void
      {
         ...
         param1.dialogBackground.height -= _loc5_ - _loc6_;
         param1.dialogBackground.y += _loc5_ - _loc6_;
      }
      ...
      private function refresh() : void
      {
         ...
         var _loc1_:int = 0;
         _loc2_.txtPremiumCurrencyTattoo.visible = _loc2_.iconPremiumCurrencyTattoo.visible = _ckbTattoo.checked && _tattooConfigurator.costPremium > 0;
         _loc2_.txtTattoo.visible = _loc2_.checkTattoo.visible = _tattooConfigurator.costCoins > 0 || _tattooConfigurator.costPremium > 0;
         if(_ckbTattoo.checked && _tattooConfigurator.costPremium > 0)
         {
            _loc1_ += _tattooConfigurator.costPremium;
            _loc2_.txtPremiumCurrencyTattoo.text = LocText.current.formatHugeNumber(_tattooConfigurator.costPremium);
         }
         _loc2_.txtPremiumCurrencyBarber.visible = _loc2_.iconPremiumCurrencyBarber.visible = _ckbBarber.checked && _barberConfigurator.costPremium > 0;
         _loc2_.txtBarber.visible = _loc2_.checkBarber.visible = _barberConfigurator.costCoins > 0 || _barberConfigurator.costPremium > 0;
         if(_ckbBarber.checked && _barberConfigurator.costPremium > 0)
         {
            _loc1_ += _barberConfigurator.costPremium;
            _loc2_.txtPremiumCurrencyBarber.text = LocText.current.formatHugeNumber(_barberConfigurator.costPremium);
         }
         _loc2_.txtPremiumCurrencySurgeon.visible = _loc2_.iconPremiumCurrencySurgeon.visible = _ckbSurgeon.checked && _surgeonConfigurator.costPremium > 0;
         _loc2_.txtSurgeon.visible = _loc2_.checkSurgeon.visible = _surgeonConfigurator.costCoins > 0 || _surgeonConfigurator.costPremium > 0;
         if(_ckbSurgeon.checked && _surgeonConfigurator.costPremium > 0)
         {
            _loc1_ += _surgeonConfigurator.costPremium;
            _loc2_.txtPremiumCurrencySurgeon.text = LocText.current.formatHugeNumber(_surgeonConfigurator.costPremium);
         }
         _loc2_.txtPremiumCurrencyUnderwear.visible = _loc2_.iconPremiumCurrencyUnderwear.visible = _ckbUnderwear.checked && _underwearConfigurator.costPremium > 0;
         _loc2_.txtUnderwear.visible = _loc2_.checkUnderwear.visible = _underwearConfigurator.costCoins > 0 || _underwearConfigurator.costPremium > 0;
         if(_ckbUnderwear.checked && _underwearConfigurator.costPremium > 0)
         {
            _loc1_ += _underwearConfigurator.costPremium;
         ...
         if(_loc1_ > 0)
         {
            ...
            _loc2_.iconPremiumCurrencySum.visible = _loc2_.txtPremiumCurrencySum.visible = true;
         }
         else
         {
            _loc2_.iconPremiumCurrencySum.visible = _loc2_.txtPremiumCurrencySum.visible = false;
         }
