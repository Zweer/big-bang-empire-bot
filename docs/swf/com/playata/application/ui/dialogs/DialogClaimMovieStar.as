package com.playata.application.ui.dialogs
{
   ...
   public class DialogClaimMovieStar extends UiDialog
   {
      ...
      public function DialogClaimMovieStar(param1:Movie, param2:Function)
      {
         ...
         _loc3_.txtCoins.autoFontSize = true;
         _loc3_.txtXp.autoFontSize = true;
         _loc3_.txtStatPointsPremiumCurrency.autoFontSize = true;
         _loc3_.txtStreamingResource.autoFontSize = true;
         ...
         _loc3_.txtStreamingResource.visible = _loc3_.iconStreamingResource.visible;
         _loc3_.txtStreamingResource.text = _reward.streamingResourceString;
         _loc3_.txtStatPointsPremiumCurrency.visible = false;
         ...
         {
            _loc3_.txtStatPointsPremiumCurrency.visible = true;
            _loc3_.txtStatPointsPremiumCurrency.text = _reward.premiumCurrencyString;
         }
         else if(_loc3_.txtStatPointsPremiumCurrency.visible)
         {
            _loc3_.txtStatPointsPremiumCurrency.visible = true;
            _loc3_.txtStatPointsPremiumCurrency.text = _reward.statPointsString;
         }
         if(_loc3_.txtStreamingResource.visible)
         {
            _loc3_.iconStatPoints.y += _loc3_.txtXp.y - _loc3_.txtCoins.y;
            _loc3_.iconPremiumCurrency.y += _loc3_.txtXp.y - _loc3_.txtCoins.y;
            _loc3_.txtStatPointsPremiumCurrency.y += _loc3_.txtXp.y - _loc3_.txtCoins.y;
         }
         var _loc4_:SeasonProgress = User.current.character.seasonProgress;
         var _loc5_:int = 11;
         if(_claimedStar == 3 && _loc4_.isActive() && _loc4_.hasSeasonPointLocation(12))
         {
            _loc5_ = 12;
         }
         _seasonPointReward = new UiSeasonPointReward(_loc3_.seasonPointReward,User.current.character.seasonProgress,_loc5_,true);
         if(_loc3_.iconStatPoints.visible || _loc3_.iconStreamingResource.visible)
         {
            _seasonPointReward.content.y += 37;
         }
      ...
      private function showRewardEffect(param1:Boolean) : void
      {
         ...
         if(_loc3_.iconStreamingResource.visible)
         {
            EffectsLayer.instance.show(15,{
               ...
               "amount":_reward.streamingResource
            });
         }
