   ...
   public class DialogConventionComplete extends UiDialog
   {
      ...
      public function DialogConventionComplete(param1:Convention)
      {
         ...
         else
         {
            ...
            _reward2 = new UiConventionReward(_loc2_.reward2);
            _reward2.refresh(2,_convention.reward.streamingResource);
            if(_loc2_.reward2.visible)
            {
               _loc2_.btnClose.y += 20;
               _loc2_.dialogBackground.height += 20;
               _yOffset = -20;
            }
         }
         ...
         var _loc4_:IDisplayObject;
         (_loc4_ = UriSprite.load(_convention.bannerLeftUrl,130,290,true)).x = -130;
