package com.playata.application.ui.dialogs
{
   ...
   public class DialogCustomizeItemResult extends UiDialog
   {
      ...
      {
         refresh(false);
         Runtime.delayFunction(revealSkills,0.3);
      }
      ...
      private function revealSkills() : void
      {
         ...
         if(_skill1.isNew)
         {
            Runtime.delayFunction(_skill1.reveal,_loc3_);
            _loc3_ += _loc1_;
            _loc4_.push(_skill1.skill.quality);
         }
         else
         {
            _loc4_.push(0);
         }
         Runtime.delayFunction(_skill2.reveal,_loc3_);
         _loc3_ += _loc1_;
         Runtime.delayFunction(_skill3.reveal,_loc3_);
         _loc4_.push(_skill2.skill.quality);
         _loc4_.push(_skill3.skill.quality);
         var _loc5_:int;
         if((_loc5_ = !!_skill1.isNew ? Math.max(_skill1.skill.quality,_skill2.skill.quality,_skill3.skill.quality) : Number(Math.max(_skill2.skill.quality,_skill3.skill.quality))) > 1)
         {
            Runtime.delayFunction(Environment.audio.playFX,_loc2_ + _loc4_.indexOf(_loc5_) * _loc1_ + 0.1,[_loc5_ == 2 ? "event_guild_artifact_won.mp3" : "event_tutorial_complete.mp3"]);
         }
         Runtime.delayFunction(enableRerollButton,_loc3_ + 0.5);
      }
