package com.playata.application.ui.dialogs
{
   ...
   public class DialogDatingPicture extends UiDialog
   {
      ...
      public function DialogDatingPicture(param1:int, param2:int, param3:Function = null, param4:Function = null, param5:Function = null, param6:Function = null)
      {
         ...
         _loc9_.background.width += LayoutUtil.deviceAdjustedWidthCorrection;
         _loc9_.background.height += LayoutUtil.deviceAdjustedHeightCorrection;
         _loc9_.background.x -= _loc8_;
         _loc9_.background.y -= _loc7_;
         _loc9_.btnClose.x += _loc8_;
         _loc9_.btnClose.y -= _loc7_;
         _loc9_.btnLeft.x -= _loc8_;
         _loc9_.btnRight.x += _loc8_;
         _loc9_.btnShowMessage.x += _loc8_;
         _loc9_.btnShowMessage.y += _loc7_;
         ...
         _loc9_.girl.x -= _loc9_.girl.scale * 450 - 450;
         _loc9_.girl.y -= _loc9_.girl.scale * 315 - 315;
      ...
      public function refresh(param1:int = -2, param2:int = -1, param3:Boolean = true) : void
      {
         ...
         var _loc4_:SymbolDialogDatingPictureGeneric;
         (_loc4_ = _vo as SymbolDialogDatingPictureGeneric).girl.setUriSprite(DatingUtil.getGirlRewardImageUrl(_datingIndex,_stepIndex),900,630,false,1,null,true);
