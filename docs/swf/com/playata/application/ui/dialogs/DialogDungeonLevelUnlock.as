   ...
   public class DialogDungeonLevelUnlock extends UiDialog
   {
      ...
      public function DialogDungeonLevelUnlock(param1:DungeonLevel, param2:Function)
      {
         ...
         else
         {
            ...
            _tooltipLock.text = _tooltipFans.text = LocText.current.text("dialog/dungeon_level_unlock/tooltip_fans_locked",_loc8_,_loc3_);
         ...
         {
            (_loc4_ = new UiItemSlot(_loc7_.itemReward,0)).item = User.current.character.getItemById(param1.rewardItemId);
         }
         ...
         _loc7_.photo.completed.visible = _loc7_.photo.locked.visible = false;
      }
