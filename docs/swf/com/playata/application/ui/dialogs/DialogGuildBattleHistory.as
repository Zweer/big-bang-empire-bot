package com.playata.application.ui.dialogs
{
   ...
   public class DialogGuildBattleHistory extends UiDialog
   {
      ...
      private function refreshList() : void
      {
         ...
         _line1.refresh(guildBattleHistoryFightCount >= _offset + 1 ? _guildBattleHistoryFights[_offset + 0] : null,1);
         _line2.refresh(guildBattleHistoryFightCount >= _offset + 2 ? _guildBattleHistoryFights[_offset + 1] : null,2);
         _line3.refresh(guildBattleHistoryFightCount >= _offset + 3 ? _guildBattleHistoryFights[_offset + 2] : null,3);
         _line4.refresh(guildBattleHistoryFightCount >= _offset + 4 ? _guildBattleHistoryFights[_offset + 3] : null,4);
         _line5.refresh(guildBattleHistoryFightCount >= _offset + 5 ? _guildBattleHistoryFights[_offset + 4] : null,5);
         _line6.refresh(guildBattleHistoryFightCount >= _offset + 6 ? _guildBattleHistoryFights[_offset + 5] : null,6);
         _line7.refresh(guildBattleHistoryFightCount >= _offset + 7 ? _guildBattleHistoryFights[_offset + 6] : null,7);
         _line8.refresh(guildBattleHistoryFightCount >= _offset + 8 ? _guildBattleHistoryFights[_offset + 7] : null,8);
         _line9.refresh(guildBattleHistoryFightCount >= _offset + 9 ? _guildBattleHistoryFights[_offset + 8] : null,9);
         _line10.refresh(guildBattleHistoryFightCount >= _offset + 10 ? _guildBattleHistoryFights[_offset + 9] : null,10);
