package com.playata.application.ui.dialogs
{
   ...
   public class DialogGuildBoosters extends UiDialog
   {
      ...
      public function DialogGuildBoosters(param1:Guild)
      {
         ...
         if(_loc2_)
         {
            if((_loc4_ = _loc3_.txtBoostQuest.text).indexOf(" ") >= 0)
            {
               _loc3_.txtBoostQuest.y -= 20;
               _loc3_.txtBoostQuest.height += 30;
            ...
            if((_loc4_ = _loc3_.txtBoostDuel.text).indexOf(" ") >= 0)
            {
               _loc3_.txtBoostDuel.y -= 20;
               _loc3_.txtBoostDuel.height += 30;
