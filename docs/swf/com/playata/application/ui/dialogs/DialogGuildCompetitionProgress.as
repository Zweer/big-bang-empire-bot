package com.playata.application.ui.dialogs
{
   ...
   public class DialogGuildCompetitionProgress extends UiDialog
   {
      ...
      private function refresh() : void
      {
         ...
         var _loc4_:GuildCompetition;
         if(!(_loc4_ = _guild.guildCompetition) || !_loc4_.isActive)
         {
            close();
            return;
         }
         ...
         {
            if((_loc5_ = _loc4_.conventionStartTimes) != "")
            {
      ...
      {
         var guildCompetition:GuildCompetition = param1;
         ...
         Runtime.delayFunction(function():void
         {
            ...
            if(_loc2_ > 0 && _loc1_ < 0)
            {
               ...
               vo.txtFlavor.height += diff;
               vo.txtDesciption.height -= diff;
               vo.txtDesciption.y += diff;
            }
