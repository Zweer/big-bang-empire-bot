   ...
   public class DialogGuildCompetitionReward extends UiDialog
   {
      ...
      private function refresh() : void
      {
         ...
         if(_guildCompetition)
         {
            ...
            _loc1_.npc.setUriSprite(_guildCompetition.npcImageUrl,348,670,true);
         }
         ...
         {
            _loc1_.iconXP.visible = _loc1_.iconStatPoints.visible = false;
            _loc1_.txtXP.visible = _loc1_.txtStatPoints.visible = false;
            _loc1_.item.visible = false;
