package com.playata.application.ui.dialogs
{
   ...
   public class DialogGuildDonation extends UiDialog
   {
      ...
      public function DialogGuildDonation(param1:int = 0, param2:int = 0, param3:Boolean = false)
      {
         ...
         _btnPremiumCurrencyDecrease.textTooltip.positionType = _btnPremiumCurrencyIncrease.textTooltip.positionType = _tooltipPremiumCurrencyIcon.positionType = _tooltipPremiumCurrencyCaption.positionType = _tooltipPremiumCurrencyInput.positionType = 3;
         _btnPremiumCurrencyDecrease.textTooltip.offset = _btnPremiumCurrencyIncrease.textTooltip.offset = _tooltipPremiumCurrencyIcon.offset = _tooltipPremiumCurrencyCaption.offset = _tooltipPremiumCurrencyInput.offset = -20;
      ...
      private function refreshTooltips() : void
      {
         ...
         if(currentPremiumCurrencyInput > Math.min(maxSpendablePremiumCurrency,User.current.premiumCurrency))
         {
            ...
            if((_loc4_ = currentPremiumCurrencyInput - Math.min(maxSpendablePremiumCurrency,User.current.premiumCurrency)) == currentPremiumCurrencyInput)
            {
