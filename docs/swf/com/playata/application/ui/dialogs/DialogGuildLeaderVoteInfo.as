package com.playata.application.ui.dialogs
{
   ...
   public class DialogGuildLeaderVoteInfo extends UiDialog
   {
      ...
      public function DialogGuildLeaderVoteInfo(param1:GuildLeaderVote)
      {
         ...
         {
            _loc4_.txtInfoBottom.text += LocText.current.text("dialog/guild_voteout/new_leader_value",_guildLeaderVote.voteResultNewLeader.name);
         }
         else
         {
            _loc4_.txtInfoBottom.text += LocText.current.text("dialog/guild_voteout/same_leader_value",_guildLeaderVote.currentLeader.name);
         }
