package com.playata.application.ui.dialogs
{
   ...
   public class DialogGuildSearch extends UiDialog
   {
      ...
      private function updateButtons() : void
      {
         ...
         {
            _btnTabNotOpen.visible = _btnTabOpen.visible = true;
         }
      ...
      private function onClickApply(param1:InteractionEvent) : void
      {
         ...
         {
            Environment.panelManager.showDialog(new DialogGuildApplication(_selectedLine.guild.id,_selectedLine.guild.name));
         }
      }
