   ...
   public class DialogItemPatternSource extends UiDialog
   {
      ...
      public function DialogItemPatternSource(param1:String, param2:String, param3:String)
      {
         ...
         if(_loc7_ > _loc6_)
         {
            ...
            _loc8_.dialogBackground.height += _loc5_;
            _loc8_.txtText.height += _loc5_ + 5;
            _loc8_.scrollLine.height += _loc5_ + 5;
            _loc8_.btnOk.y += _loc5_;
            _loc8_.dialogBackground.y -= _loc5_ / 2;
            _loc8_.txtText.y -= _loc5_ / 2;
            _loc8_.btnOk.y -= _loc5_ / 2;
            _loc8_.txtDialogTitle.y -= _loc5_ / 2;
            _loc8_.scrollKnob.y -= _loc5_ / 2;
            _loc8_.scrollLine.y -= _loc5_ / 2;
         }
         else
         {
