package com.playata.application.ui.dialogs
{
   ...
   import com.playata.application.ui.elements.leaderboard.UiLeaderboardFilter;
   ...
   import com.playata.application.ui.elements.leaderboard.UiLeaderboardTournamentContent;
   ...
   public class DialogLeaderboard extends UiDialog
   {
      ...
      private var _tournamentContent:UiLeaderboardTournamentContent = null;
      ...
      private var _btnTabTournament:UiTabButton = null;
      ...
      private var _filter:UiLeaderboardFilter = null;
      ...
      public function DialogLeaderboard()
      {
         ...
         _tournamentContent = new UiLeaderboardTournamentContent(_loc1_.tournamentContent,refreshButtons,onClickViewPlayer,refreshContentButtons);
         ...
         _btnTabTournament = new UiTabButton(_loc1_.btnTabTournament,LocText.current.text("dialog/leadboard/button_tab_tournament"),"",onClickTabTournament);
         ...
         _filter = new UiLeaderboardFilter(_loc1_.filter,onFilterChanged);
      ...
      public static function reset() : void
      {
         ...
         UiLeaderboardTournamentContent.reset();
      }
      ...
      override public function dispose() : void
      {
         ...
         _btnTabMovies = null;
         _btnTabTournament.dispose();
         _btnTabTournament = null;
         ...
         _movieContent = null;
         _tournamentContent.dispose();
         _tournamentContent = null;
         super.dispose();
      }
      ...
      private function onClickTabCharacters(param1:InteractionEvent) : void
      {
         ...
         _btnTabTournament.tabbed = false;
         ...
         _loc2_.tournamentContent.visible = _btnTabTournament.tabbed;
         _btnScrollUp.content.y = -195;
         _characterContent.show();
         _loc2_.btnFilter.visible = !Environment.platform.isNaughtyEmpire;
      }
      ...
      private function onClickTabGuildCompetition(param1:InteractionEvent) : void
      {
         ...
         _loc2_.btnFilter.visible = false;
      }
      ...
      {
         _activeLeaderboard = 3;
         _btnTabCharacters.tabbed = false;
         _btnTabGuilds.tabbed = false;
         _btnTabGuildCompetition.tabbed = false;
         _btnTabMovies.tabbed = false;
         _btnTabTournament.tabbed = true;
         refreshContentButtons();
         var _loc2_:SymbolDialogLeaderboardGeneric = _vo as SymbolDialogLeaderboardGeneric;
         _loc2_.characterContent.visible = _btnTabCharacters.tabbed;
         _loc2_.guildContent.visible = _btnTabGuilds.tabbed;
         ...
         _loc2_.tournamentContent.visible = _btnTabTournament.tabbed;
         _btnScrollUp.content.y = -195;
         _tournamentContent.show();
         _loc2_.btnFilter.visible = false;
      }
      
      private function refreshContentButtons() : void
      {
         var _loc1_:Boolean = _btnTabCharacters.tabbed || _btnTabTournament.tabbed && _tournamentContent.isCharacterTournament;
         if(_loc1_)
         {
      ...
      private function scrollUp(param1:int, param2:Boolean) : void
      {
         ...
         else if(_btnTabTournament.tabbed)
         {
            _tournamentContent.scrollUp(param1,param2);
         }
      }
      ...
      private function scrollDown(param1:int, param2:Boolean) : void
      {
         ...
         {
            _tournamentContent.scrollDown(param1,param2);
         }
      }
      ...
      {
         var _loc2_:SymbolDialogLeaderboardGeneric = _vo as SymbolDialogLeaderboardGeneric;
         var _loc3_:Boolean = UiLeaderboardFilter.isFilterActive;
         _loc2_.btnFilter.iconExclamationMark.visible = _loc3_;
         _loc2_.characterContent.checkOnlySameLocale.visible = !_loc3_ && AppConfig.teamLocaleEnabled;
         _loc2_.characterContent.txtOnlySameLocale.visible = !_loc3_ && AppConfig.teamLocaleEnabled;
         _loc2_.guildContent.checkOnlySameLocale.visible = !_loc3_ && AppConfig.teamLocaleEnabled;
         _loc2_.guildContent.txtOnlySameLocale.visible = !_loc3_ && AppConfig.teamLocaleEnabled;
         if(_filter.currentServer != _characterLeaderboardContext.serverId)
         {
            _characterLeaderboardContext.reset();
         }
         if(_filter.currentServer != _guildLeaderboardContext.serverId)
         {
            _guildLeaderboardContext.reset();
         }
         _characterLeaderboardContext.serverId = _filter.currentServer;
         _guildLeaderboardContext.serverId = _filter.currentServer;
         if(param1)
         {
            switch(int(activeLeaderboard) - 1)
            {
      ...
      private function onClickViewPlayer(param1:InteractionEvent) : void
      {
         ...
         if(_btnTabCharacters.tabbed)
         {
            ...
            _loc3_ = _characterContent.currentCharacter.serverId;
         }
         else if(_btnTabMovies.tabbed)
         {
         ...
         {
            switch(int(_tournamentContent.activeTournamentType) - 1)
            {
               case 0:
                  _loc2_ = _tournamentContent.tournament1Content.currentCharacter.id;
                  break;
               case 1:
                  _loc2_ = _tournamentContent.tournament2Content.currentCharacter.id;
                  break;
               case 6:
                  _loc2_ = _tournamentContent.globalTournamentContent.currentCharacter.id;
                  _loc3_ = _tournamentContent.globalTournamentContent.currentCharacter.serverId;
            }
         }
         else if(_btnTabGuildCompetition.tabbed)
         {
      ...
      private function onClickViewGuild(param1:InteractionEvent) : void
      {
         ...
         else if(_btnTabGuilds.tabbed)
         {
            ...
            _loc3_ = _guildContent.currentGuild.serverId;
         }
         else if(_btnTabGuildCompetition.tabbed)
         {
         ...
         else if(_btnTabTournament.tabbed)
         {
            ...
            {
               case 0:
                  _loc2_ = _tournamentContent.tournament1Content.currentCharacter.guildId;
                  break;
               case 1:
                  _loc2_ = _tournamentContent.tournament2Content.currentCharacter.guildId;
                  break;
               case 6:
                  _loc2_ = _tournamentContent.globalTournamentContent.currentCharacter.guildId;
                  _loc3_ = _tournamentContent.globalTournamentContent.currentCharacter.serverId;
            }
         }
         ViewManager.instance.loadGuild(_loc2_,closeCallback,_loc3_);
      }
      ...
      private function onClickViewTop(param1:InteractionEvent) : void
      {
         ...
         {
            _tournamentContent.scrollToTop();
         }
      }
      ...
      private function onClickSearch(param1:InteractionEvent) : void
      {
         ...
         {
            _tournamentContent.search(_loc2_.inputSearch.text);
         }
      }
      ...
      private function refreshButtons() : void
      {
         ...
         else if(_btnTabTournament && _btnTabTournament.tabbed)
         {
            switch(int(_tournamentContent.activeTournamentType) - 1)
            {
               case 0:
                  _btnViewPlayer.buttonEnabled = _tournamentContent.tournament1Content.characterCount > 0;
                  _btnViewTop.buttonEnabled = _tournamentContent.tournament1Content.characterCount > 0;
                  _btnSearch.buttonEnabled = _tournamentContent.tournament1Content.characterCount > 0;
                  _btnScrollUp.visible = _tournamentContent.tournament1Content.characterCount > 9;
                  _btnScrollDown.visible = _tournamentContent.tournament1Content.characterCount > 9;
                  break;
               case 1:
                  _btnViewPlayer.buttonEnabled = _tournamentContent.tournament2Content.characterCount > 0;
                  _btnViewTop.buttonEnabled = _tournamentContent.tournament2Content.characterCount > 0;
                  _btnSearch.buttonEnabled = _tournamentContent.tournament2Content.characterCount > 0;
                  _btnScrollUp.visible = _tournamentContent.tournament2Content.characterCount > 9;
                  _btnScrollDown.visible = _tournamentContent.tournament2Content.characterCount > 9;
                  break;
               case 6:
                  _btnViewPlayer.buttonEnabled = _tournamentContent.globalTournamentContent.characterCount > 0;
                  _btnViewTop.buttonEnabled = _tournamentContent.globalTournamentContent.characterCount > 0;
                  _btnSearch.buttonEnabled = _tournamentContent.globalTournamentContent.characterCount > 0;
                  _btnScrollUp.visible = _tournamentContent.globalTournamentContent.characterCount > 9;
                  _btnScrollDown.visible = _tournamentContent.globalTournamentContent.characterCount > 9;
            }
         }
      }
