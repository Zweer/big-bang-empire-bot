package com.playata.application.ui.dialogs
{
   ...
   public class DialogMovieQuestBriefing extends UiDialog
   {
      ...
      public function DialogMovieQuestBriefing(param1:MovieQuest)
      {
         ...
         if(_loc2_ > _loc5_)
         {
            _btnPreviousQuest.x -= Math.round((_loc2_ - _loc5_) / 2);
            _btnNextQuest.x += Math.round((_loc2_ - _loc5_) / 2);
         }
      ...
      {
         if(!User.current || !User.current.character || !User.current.character.movie)
         {
            return;
         }
      ...
      private function handleRequests(param1:ActionRequestResponse) : void
      {
         ...
         if(response.error == "")
         {
            ...
            close();
            if(_movieQuest != null && User.current != null && User.current.character != null && User.current.character.movie != null && User.current.character.movie.isOpen)
            {
