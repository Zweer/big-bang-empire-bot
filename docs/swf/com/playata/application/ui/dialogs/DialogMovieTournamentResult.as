package com.playata.application.ui.dialogs
{
   ...
   public class DialogMovieTournamentResult extends UiDialog
   {
      ...
      private function refresh() : void
      {
         ...
         _loc2_.txtPremiumCurrency.visible = _loc2_.iconPremiumCurrency.visible = _loc1_.premiumCurrency > 0;
         _loc2_.txtXp.visible = _loc2_.iconXp.visible = _loc1_.xp > 0;
         _loc2_.txtStatPoints.visible = _loc2_.iconStatPoints.visible = _loc1_.statPoints > 0;
         _loc2_.titleTooltip.visible = _loc2_.txtTitleReward.visible = _loc2_.iconTitle.visible = _loc1_.title != null && !Titles.instance.isTitleAvailable(User.current.character,_loc1_.title);
