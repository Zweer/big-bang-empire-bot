package com.playata.application.ui.dialogs
{
   ...
   public class DialogOutOfEnergy extends UiDialog
   {
      ...
      public function DialogOutOfEnergy(param1:Function, param2:Boolean)
      {
         ...
         var _loc4_:int;
         if((_loc4_ = GameUtil.getEnergyRefillDiscountMaxLevel(User.current.character.level)) > 0 && _loc8_ <= _loc3_)
         {
         ...
         if(AppEnvironment.appPlatform.isHidePantiesAllowed)
         {
            ...
            if(_loc9_ <= 0)
            {
               ...
               _btnBuyEnergyForPremiumCurrency.x -= _btnBuyEnergyForPremiumCurrency.content.x;
            }
         }
         _loc10_.lady.alpha = 0;
         _loc10_.lady.y += LayoutUtil.deviceAdjustedHeightCorrection / 2;
      }
