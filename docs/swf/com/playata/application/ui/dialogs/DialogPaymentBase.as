package com.playata.application.ui.dialogs
{
   ...
   public class DialogPaymentBase extends UiDialog
   {
      ...
      public function DialogPaymentBase()
      {
         ...
         _checkIsGift.tooltipElement.offset = _checkIsGift.tooltipElement.offset = -15;
      ...
      public static function set currentPaymentMethod(param1:PaymentMethod) : void
      {
      ...
      public static function get currentPaymentLocale() : String
      {
         ...
         if(_currentPaymentLocale == null)
         {
            ...
            {
               (_loc4_ = new Vector.<String>()).push(Environment.info.defaultLocale);
               if(AppConfig.paymentAlternativeLocales != null)
               {
      ...
      public static function get cacheKeyAdditionalPaymentMethod() : String
      {
         return "additionalPaymentMethod_" + ServerInfo.serverId + "_" + User.current.id.toString();
      }
      
      public static function get cacheKeySelectedLanguage() : String
      {
      ...
      protected function initDefaultLayout(param1:Boolean = false) : void
      {
         ...
         {
            if((_loc12_ = vo.getChildByName("btnMethod" + (_loc3_ + 1).toString()) as SymbolButtonPaymentMethodGeneric) == null || _loc3_ >= _loc4_ - 1 && _loc6_.length > _loc4_)
            {
               _loc10_.push(_loc7_);
            }
            else
         ...
         {
            _loc5_ = _loc10_[0];
            if(_loc9_ = Cache.getData(cacheKeyAdditionalPaymentMethod))
            {
         ...
         {
            if((_loc12_ = vo.getChildByName("btnMethod" + (_loc4_ - _loc8_).toString()) as SymbolButtonPaymentMethodGeneric) != null)
            {
