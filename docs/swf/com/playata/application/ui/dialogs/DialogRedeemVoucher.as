package com.playata.application.ui.dialogs
{
   ...
   public class DialogRedeemVoucher extends UiDialog
   {
      ...
      private var _voucherNewsId:String = null;
      ...
      private function onClickRedeem(param1:InteractionEvent) : void
      {
         ...
         else
         {
            ...
            if(_voucherNewsId != null)
            {
               _loc2_.setString("voucher_news_id",_voucherNewsId);
            }
      ...
      public function setNewsId(param1:String) : void
      {
         _voucherNewsId = param1;
      }
