   ...
   public class DialogReportUserStory extends UiDialog
   {
      ...
      public function DialogReportUserStory(param1:UserStory, param2:Function = null, param3:Boolean = false)
      {
         ...
         else
         {
            ...
            _loc4_.btnReport.y -= 100;
            _loc4_.btnView.y -= 100;
            _loc4_.dialogBackground.height -= 100;
            _yOffset += 50;
         }
      }
      ...
      private function onClickReport(param1:InteractionEvent) : void
      {
         ...
         var _loc4_:String;
         if(!(_loc4_ = StringUtil.trim(_loc3_.inputText.text)) || _loc4_.length == 0 || _loc4_ == LocText.current.text("dialog/report_user_story/report_input_text"))
         {
