package com.playata.application.ui.dialogs
{
   ...
   public class DialogReportUserStream extends UiDialog
   {
      ...
      public function DialogReportUserStream(param1:int, param2:String, param3:int)
      {
         ...
         var _loc5_:Boolean;
         var _loc6_:Sprite = !!(_loc5_ = platform.isSSO) ? new SymbolDialogReportUserSSOGeneric() : new SymbolDialogReportUserGeneric();
         super(_loc6_);
         _queued = false;
         if(_loc5_)
         {
            (_loc4_ = _loc6_ as SymbolDialogReportUserSSOGeneric).txtDialogTitle.text = LocText.current.text("dialog/report_character/caption");
         ...
         {
            (_loc7_ = _loc6_ as SymbolDialogReportUserGeneric).txtDialogTitle.text = LocText.current.text("dialog/report_character/caption");
