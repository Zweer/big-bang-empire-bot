   ...
   public class DialogTutorialComplete extends UiDialog
   {
      ...
      public function DialogTutorialComplete(param1:Function)
      {
         ...
         if(DatingUtil.isAvailable)
         {
            ...
            _loc2_.dialogBackground.height += 65;
            _loc2_.btnClose.y += 45;
         ...
         _loc2_.lady.alpha = 0;
         _loc2_.lady.y += LayoutUtil.deviceAdjustedHeightCorrection / 2;
      ...
      private function onClickClose(param1:InteractionEvent) : void
      {
         ...
         UiPremiumCurrencyPanel.instance.offset -= _loc2_;
