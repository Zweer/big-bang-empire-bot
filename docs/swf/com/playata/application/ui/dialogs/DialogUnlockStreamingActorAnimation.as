package com.playata.application.ui.dialogs
{
   ...
   public class DialogUnlockStreamingActorAnimation extends UiDialog
   {
      ...
      public function DialogUnlockStreamingActorAnimation(param1:CStreamingActorAnimation, param2:Function, param3:Function)
      {
         ...
         var _loc6_:int = 14;
         var _loc7_:Number;
         if((_loc7_ = _buttonUnlockPremium.x - _buttonUnlockPremium.width / 2 - (_buttonUnlockStreaming.x + _buttonUnlockStreaming.width / 2)) < _loc6_)
         {
            _buttonUnlockStreaming.x -= (_loc6_ - _loc7_) / 2;
            _buttonUnlockPremium.x += (_loc6_ - _loc7_) / 2;
            _loc8_ = _buttonUnlockStreaming.x - _buttonUnlockStreaming.width / 2;
            _loc4_ = _buttonUnlockPremium.x + _buttonUnlockPremium.width / 2;
            _buttonUnlockStreaming.x -= (_loc4_ + _loc8_) / 2;
            _buttonUnlockPremium.x -= (_loc4_ + _loc8_) / 2;
         }
      }
