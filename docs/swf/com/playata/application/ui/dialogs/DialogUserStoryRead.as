package com.playata.application.ui.dialogs
{
   ...
   public class DialogUserStoryRead extends UiDialog
   {
      ...
      public function init() : void
      {
         ...
         _loc1_.btnTabBriefing.y = _loc1_.btnTabOutro.y = _loc1_.txtStage.y + 57;
         _loc1_.txtBriefingOutro.y = _loc1_.btnTabOutro.y + 33;
         _loc1_.txtCaptionDate.y = _loc1_.txtDate.y = _loc1_.txtBriefingOutro.y + 182;
         ...
         if(_userStory.status != 3)
         {
            _loc1_.background.height -= 30;
         }
         if(!_btnReport.visible)
         {
            _loc1_.background.height -= 50;
         }
      }
