package com.playata.application.ui.dialogs
{
   ...
   public class DialogUserStorySettings extends UiDialog
   {
      ...
      public function DialogUserStorySettings(param1:Function)
      {
         ...
         var _loc6_:int;
         if((_loc6_ = Math.ceil(_userStoryLocales.length / 3) - 1) > 0)
         {
            _loc4_.background.height += _loc6_ * 50;
            _loc4_.btnSave.y += _loc6_ * 50;
            _loc4_.backgroundSeperator.y += _loc6_ * 50;
            _loc4_.btnDeactivate.y += _loc6_ * 50;
            _loc4_.textDeactivate.y += _loc6_ * 50;
            _yOffset -= _loc6_ * 50 / 2;
         }
      }
