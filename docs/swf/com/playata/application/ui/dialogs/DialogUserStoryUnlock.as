package com.playata.application.ui.dialogs
{
   ...
   public class DialogUserStoryUnlock extends UiDialog
   {
      ...
      public function DialogUserStoryUnlock()
      {
         ...
         _loc1_.txtAcceptTerms.visible = _ckbAcceptTerms.visible = _btnUnlock.visible = !User.current.character.userStoryActivated;
         _loc1_.backgroundSeperator.visible = _loc1_.textDeactivate.visible = _btnDeactivate.visible = User.current.character.userStoryActivated;
      }
