package com.playata.application.ui.effects.flash
{
   ...
   public class SparkEffect extends FlashEffect
   {
      ...
      {
         var _loc4_:SpriteInformationSpark;
         (_loc4_ = new SpriteInformationSpark()).speed = Math.random() * 600 + 120;
      ...
      override public function update(param1:Number) : Boolean
      {
         ...
         var _loc4_:int = 0;
         var _loc5_:int;
         _timeStamp = _loc5_ = Runtime.getTimer();
         ...
         for each(var _loc6_ in _spriteInformation)
         {
            ...
            else
            {
               ...
               _loc3_.x += _loc6_.directionX * _loc6_.speed * param1 * _loc6_.pos;
               _loc3_.y += _loc6_.directionY * _loc6_.speed * param1 * _loc6_.pos + (1 - _loc6_.pos) * 2;
            }
         }
