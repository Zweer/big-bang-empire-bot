package com.playata.application.ui.elements.action_bar
{
   ...
   public class ActionBarLayer
   {
      ...
      {
         var origin:IDisplayObject = param1;
         var type:int = param2;
         var onAction:Function = param3;
         var tag:Object = param4;
         var offsetX:int = param5;
         var offsetY:int = param6;
         var delayedTooltip:Tooltip = param7;
         var onClose:Function = param8;
