package com.playata.application.ui.elements.advertisement
{
   ...
   public class UiVideoAdvertismentButton extends Sprite
   {
      ...
      public function refresh(param1:String, param2:int, param3:int) : void
      {
         ...
         _type = param2;
         var _loc4_:Boolean;
         if(_loc4_ = AppVideoAdvertisment.isAvailable(param2,param3))
         {
      ...
      {
         var videoAvailable:Boolean = param1;
         if(videoAvailable)
         {
      ...
      {
         return AppVideoAdvertisment.getLastShownAdvertismentTimestamp(_type) + AppEnvironment.appPlatform.getAdvertismentInfoInt("video_advertisment_blocked_time__" + _type.toString(),CConstant.video_advertisment_blocked_time) - TimeUtil.now;
      }
