package com.playata.application.ui.elements.application
{
   ...
   public class UiLoadingScreen
   {
      ...
      public function refreshLayout() : void
      {
         ...
         _content.logo.x += _loc3_;
         _content.textStatus.x += _loc3_;
         _content.completionText.x += _loc3_;
         _content.progressBarBackground.x += _loc3_;
         _content.progressBarFill.x += _loc3_;
