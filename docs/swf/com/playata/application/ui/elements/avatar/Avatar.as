package com.playata.application.ui.elements.avatar
{
   ...
   public class Avatar extends Sprite
   {
      ...
      public function Avatar(param1:Boolean = false, param2:Boolean = false, param3:Boolean = false, param4:Boolean = false)
      {
         ...
         _bodyBitmap.scaleX = _bodyBitmap.scaleY = 0.5;
         addChild(new MovieClip()).name = "layerItemHeadBack";
      ...
      private function createBodyImage() : void
      {
         ...
         if(_loc5_)
         {
            _loc1_ = (_loc7_ = getDisplayOption(_loc5_)) == 7 || _loc7_ == 8 || _loc7_ == 14;
         }
         ...
         var _loc4_:Boolean;
         if(_loc4_ = !_loc2_ && (!_loc5_ || getDisplayOption(_loc5_) == 10))
         {
         ...
         if(_loc2_ && !_loc3_ || !_loc2_ && (!_loc4_ || !_loc3_))
         {
            ...
            if(!_censorBars)
            {
               ...
               _censorBars.scaleX = _censorBars.scaleY = 0.5;
      ...
      private function drawBackHair() : void
      {
         var _loc1_:* = null;
         var _loc2_:* = null;
         if((getDisplayOption(_currentSettings.head) == 5 || getDisplayOption(_currentSettings.head) == 12) && (!_currentSettings.hasData("show_head_item") || _currentSettings.show_head_item))
         {
            return;
         }
         _loc1_ = getAppearanceImageLinkeage("hair_back");
         if(_loc1_ && (!_currentSettings.show_head_item || _currentSettings.show_head_item && getDisplayOption(_currentSettings.head) != 6 && getDisplayOption(_currentSettings.head) != 13))
         {
      ...
      private function prepareHairColorFilter() : void
      {
         ...
         _loc2_.hue = _loc2_.saturation = 0;
      ...
      private function getChestItemQuality() : int
      {
         ...
         if(!_loc1_)
         {
            ...
            {
               return _currentSettings.bra_quality;
            }
            return 1;
         }
      ...
      private function drawBodyPart(param1:String, param2:BitmapData = null, param3:Point = null) : void
      {
         var _loc6_:* = null;
         var _loc4_:String;
         if(!(_loc4_ = getAppearanceImageLinkeage(param1)))
         {
            return;
         }
         var _loc5_:BitmapData;
         if(_loc5_ = getBodyBitmap(_loc4_))
         {
            (_loc6_ = param2 == null ? _bodyBitmapDataBase : param2).copyPixels(_loc5_,_loc5_.rect,param3 || ZERO,null,null,true);
         }
      }
      ...
      private function drawTattoo(param1:String, param2:BitmapData = null, param3:Point = null) : void
      {
         ...
         if(_loc5_ = getBodyBitmap(_loc4_))
         {
            (_loc6_ = param2 == null ? _bodyBitmapDataBase : param2).draw(_loc5_,null,null,"multiply");
         }
      }
      ...
      private function getDisplayOption(param1:String) : int
      {
         ...
         if(param1 != null)
         {
            ...
            {
               _loc2_ = CItemTemplate.fromId(param1);
               if(_currentSettings.isFemale && _loc2_.hasData("display_options_f",true))
               {
                  return _loc2_.displayOptionsF;
               }
               return _loc2_.displayOptions;
            }
         }
         return 0;
      }
      ...
      private function setEquipment(param1:int, param2:AppearanceSettings) : void
      {
         ...
         switch(int(param1) - 1)
         {
            case 0:
               _loc6_ = "head";
               _loc10_ = "layerItemHead";
               if(param2.hasData("show_head_item") && param2.show_head_item == false)
               {
                  param2.setData(_loc6_,null);
                  emptyLayer("layerItemHead");
                  emptyLayer("layerItemHeadBack");
               }
               else if((_loc11_ = param2.getString(_loc6_)) != null)
               {
                  if((_loc5_ = getDisplayOption(_loc11_)) == 11 || _loc5_ == 12 || _loc5_ == 13)
                  {
                     if(!param2.hasData(_loc6_,true))
                     {
                        emptyLayer("layerItemHeadBack");
                     }
                     else
                     {
                        _loc12_ = getEquipmentImageUrl(param2.getString(_loc6_),param2.gender,"_back");
                        updateLayer("layerItemHeadBack",_loc12_);
                     }
                  }
               }
               else
            ...
            case 1:
               ...
               {
                  if((_loc5_ = getDisplayOption(_loc11_)) == 1 || _loc5_ == 0)
                  {
                     _loc10_ = "layerItemChestFront";
                     emptyLayer("layerItemChestBack");
                  }
                  ...
                  {
                     _loc10_ = "layerItemChestBack";
                     emptyLayer("layerItemChestFront");
                  }
                  else if(_loc5_ == 3)
                  {
                     _loc3_ = getEquipmentIdentifier(5);
                     _loc14_ = true;
                     if(_loc3_ != null && (!param2.hasData("show_boots_item") || param2.show_boots_item == true))
                     {
                        if((_loc8_ = getDisplayOption(_loc3_)) == 4)
                        {
                           _loc14_ = false;
                        }
                     }
                  ...
                  else if(_loc5_ == 14)
                  {
                     ...
                     {
                        _loc9_ = getEquipmentImageUrl(param2.getString(_loc6_),param2.gender,"_back");
                        updateLayer("layerItemChestBack",_loc9_);
                     }
                  }
                  else if(_loc5_ == 15)
                  {
                     ...
                     {
                        _loc4_ = getEquipmentImageUrl(param2.getString(_loc6_),param2.gender,"_back");
                        updateLayer("layerItemChestBack",_loc4_);
                     }
                  }
                  else
                  {
            ...
            case 3:
               ...
               {
                  if((_loc5_ = getDisplayOption(_loc11_)) == 1)
                  {
                     _loc10_ = "layerItemLegsFront";
                     emptyLayer("layerItemLegsBack");
                  }
         ...
         if(_loc6_ != null && _loc10_ != null)
         {
            ...
            _loc7_ = getEquipmentImageUrl(param2.getString(_loc6_),param2.gender);
            _loc13_ = updateLayer(_loc10_,_loc7_);
            if(_censorBars && _loc13_)
            {
               if(param1 == 2 && _censorBarsTopNeeded && !isAssetLoaded(_loc13_))
               {
                  _censorBars.top.visible = true;
                  if(_loc5_ == 7 || _loc5_ == 8 || _loc5_ == 14)
                  {
                     _censorBars.bottom.visible = true;
                  }
               }
               if(param1 == 4 && _censorBarsBottomNeeded && !isAssetLoaded(_loc13_))
               {
                  _censorBars.bottom.visible = true;
               }
            }
      ...
      private function emptyLayer(param1:String) : void
      {
         ...
         if(_loc3_ == null)
         {
            _loc3_ = getChildByName(param1) as MovieClip;
         }
      ...
      private function updateLayer(param1:String, param2:String) : UriDisplayObjectAsset
      {
         ...
         var _loc5_:int = 212;
         var _loc6_:int = 450;
         var _loc3_:DisplayObjectContainer = UriDisplayObjectAsset.load(param2,_loc5_,_loc6_,true,5);
         if(param2.indexOf("SymbolCharacter") == -1)
         {
            _itemsToLoad.push(_loc3_);
         }
         var _loc4_:MovieClip;
         if((_loc4_ = _itemLayers.getChildByName(param1) as MovieClip) == null)
         {
            _loc4_ = getChildByName(param1) as MovieClip;
         }
         _loc4_.addChild(_loc3_);
         return _loc3_ as UriDisplayObjectAsset;
      }
      
      private function getEquipmentImageUrl(param1:String, param2:String, param3:String = "") : String
      {
         var _loc4_:String = !!_large ? "items_hd/" : "items/";
         return Assets.assetURL(_loc4_ + Item.getBaseIdentifier(param1) + "_" + param2 + param3,"png");
      }
      ...
      private function getAppearanceImageLinkeage(param1:String) : String
      {
         ...
         if(param1 == "hair_back")
         {
            _loc6_ = (_loc11_ = CCharacterAppearance.fromId(_currentSettings.gender)).hairType;
            if((_loc4_ = _loc11_.hairBack).length == 0)
            {
               return null;
            }
            if(!(_loc13_ = _loc4_[getAppearanceValueIndex(_loc6_,_currentSettings.hair_type)]))
            {
               return null;
            }
         }
         ...
         {
            _loc6_ = (_loc11_ = CCharacterAppearance.fromId(_currentSettings.gender)).hairType;
            if((_loc7_ = _loc11_.hairMiddle).length == 0)
            {
               return null;
            }
            if(!(_loc9_ = _loc7_[getAppearanceValueIndex(_loc6_,_currentSettings.hair_type)]))
            {
               return null;
            }
         }
         ...
         return "SymbolCharacter" + _loc5_.toUpperCase() + _loc12_ + _loc3_ + _loc10_;
      }
