package com.playata.application.ui.elements.avatar
{
   ...
   public class AvatarAnimation extends Sprite
   {
      ...
      private function setEquipment(param1:int, param2:AppearanceSettings) : void
      {
         ...
         switch(int(param1) - 1)
         {
            ...
            case 3:
               ...
               else if((_loc8_ = getDisplayOption(2,param2)) == 7 || _loc8_ == 8)
               {
                  param2.setData(_loc3_,null);
               }
               break;
         ...
         var _loc7_:String;
         if(_loc7_ = param2.getString(_loc3_))
         {
      ...
      private function getDisplayOption(param1:int, param2:AppearanceSettings) : int
      {
         ...
         var _loc5_:String;
         if((_loc5_ = param2.getString(_loc3_)) != null)
         {
            if(CItemTemplate.exists(_loc5_))
            {
               _loc4_ = CItemTemplate.fromId(_loc5_);
               if(param2.isFemale && _loc4_.hasData("display_options_f",true))
               {
                  return _loc4_.displayOptionsF;
               }
               return _loc4_.displayOptions;
            }
         }
         return 0;
      }
