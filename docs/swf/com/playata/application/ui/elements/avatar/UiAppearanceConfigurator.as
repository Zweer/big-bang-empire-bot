   ...
   public class UiAppearanceConfigurator
   {
      ...
      public function set currentSettings(param1:AppearanceSettings) : void
      {
         ...
         if(param1.gender == "f")
         {
            ...
            {
               _currentSettings.bra_quality = 1;
            }
         }
      ...
      {
         var _loc4_:AppearanceSettings;
         (_loc4_ = new AppearanceSettings({})).gender = param1.gender;
         var _loc2_:StringMap = getAvailableAppearances(_currentSettings.gender);
         for each(var _loc3_ in _loc2_.keys)
         {
            if(_relevantAppearances.indexOf(_loc3_) >= 0)
      ...
      protected function getNextAppearanceValue(param1:String, param2:int) : int
      {
         ...
         var _loc5_:int;
         if((_loc5_ = (_loc5_ = getAppearanceValueIndex(_loc3_,_loc6_)) + param2) == _loc3_.length)
         {
            _loc5_ = 0;
         }
         else if(_loc5_ < 0)
      ...
      protected function updatePriceTag(param1:String) : void
      {
         var _loc4_:int = 0;
         var _loc9_:int = 0;
         var _loc5_:CCharacterAppearance;
         var _loc8_:Vector.<int> = (_loc5_ = CCharacterAppearance.fromId(_currentSettings.gender)).getIntVector(param1);
         ...
         _loc3_.text = "";
         _loc13_.text = "";
         _loc10_.visible = _loc2_.visible = false;
      ...
      private function updateTotalPrice() : void
      {
         ...
         for each(var _loc1_ in _prices)
         {
            if(_loc1_.isPremium)
            {
               _costPremium += _loc1_.amount;
            }
            else
            {
               _costCoins += _loc1_.amount;
            }
         }
