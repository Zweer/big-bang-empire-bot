package com.playata.application.ui.elements.avatar
{
   ...
   public class UiAppearanceConfiguratorHideCloths
   {
      ...
      public function UiAppearanceConfiguratorHideCloths(param1:SymbolCharacterConfiguratorHideClothsGeneric)
      {
         ...
         _content.btnUnlockHideTop.x += int((_content.btnUnlockHideTop.width - _loc2_) / 2);
         ...
         _content.btnUnlockHideBelt.x += int((_content.btnUnlockHideBelt.width - _loc2_) / 2);
         ...
         _content.btnUnlockHideLegs.x += int((_content.btnUnlockHideLegs.width - _loc2_) / 2);
         ...
         _content.btnUnlockHideBoots.x += int((_content.btnUnlockHideBoots.width - _loc2_) / 2);
