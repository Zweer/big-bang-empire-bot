   ...
   public class UiCharacterTooltip extends UiClosableTooltip
   {
      ...
      override public function onAssigned() : void
      {
         ...
         if(_compareWithPlayer)
         {
            ...
            _statsBarStamina.refreshCompareValue(_loc10_.totalStamina,_loc3_.getStatValue(1,true),true);
            _statsBarStrength.refreshCompareValue(_loc10_.totalStrength,_loc3_.getStatValue(2,true),true);
            _statsBarCriticalRating.refreshCompareValue(_loc10_.totalCriticalRating,_loc3_.getStatValue(3,true),true);
            _statsBarDodgeRating.refreshCompareValue(_loc10_.totalDodgeRating,_loc3_.getStatValue(4,true),true);
            _loc8_ = _loc3_.getStatValue(1,true) + _loc3_.getStatValue(2,true) + _loc3_.getStatValue(3,true) + _loc3_.getStatValue(4,true) - (_loc10_.totalStamina + _loc10_.totalStrength + _loc10_.totalCriticalRating + _loc10_.totalDodgeRating);
            _loc1_ = 59396;
            _loc7_ = 14155776;
         ...
         else
         {
            ...
            if(_introText != "")
            {
               ...
               _loc6_ += Math.round(_tooltipContent.tooltipTop.textHeight);
               if(_outroText != "")
               {
                  _loc6_ += 5;
               }
            ...
            if(_outroText != "")
            {
               ...
               _loc6_ += Math.round(_tooltipContent.tooltipBottom.textHeight);
            }
            _loc6_ = (_loc6_ -= _tooltipContent.background.y) + 25;
