   ...
   public class UiBackgroundFader
   {
      ...
      public static function scaleWidthCenter(param1:IDisplayObject, param2:int = 0, param3:Number = -1, param4:Align = null) : void
      {
         ...
         else
         {
            ...
            param1.x = 0;
            _loc6_ = (_loc5_ = Environment.layout.appDefaultHeight * param1.scale) - Environment.layout.appDefaultHeight;
      ...
      {
         var backgroundType:int = param1;
         var customPosition:Point = param2;
         var fromCustomPosition:Point = param3;
         var tweenBackground:Boolean = param4;
         var tweenStartCallback:Function = param5;
         var backgroundLoadedCallback:Function = param6;
         ...
         if(!_backgroundCache.exists(_currentBackgroundType) || !_cacheBackgrounds)
         {
            ...
            switch(_currentBackgroundType)
            {
               case 1:
                  ...
                  break;
               case 22:
                  _loc1_ = "SymbolBackgroundLowCharacterEmpty";
               ...
               case 3:
                  ...
                  {
                     _loc1_ = "SymbolBackgroundLowStreaming";
                     _loc12_ = "streaming";
                     _loc7_ = "ambience_appartment.mp3";
                  }
                  else
      ...
      private function getBackgroundAssetUrl(param1:String, param2:Boolean = false) : String
      {
         ...
         if(param2)
         {
            ...
            _loc4_ += "_" + _loc3_.width + "_" + _loc3_.height;
         }
         return _loc4_;
      }
