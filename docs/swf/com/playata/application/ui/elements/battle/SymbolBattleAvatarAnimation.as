package com.playata.application.ui.elements.battle
{
   ...
   public class SymbolBattleAvatarAnimation
   {
      ...
      public function defeated() : void
      {
         ...
         _loc1_.fromTo(_displayObject.container,0.6333333333333333,{
            "x":0,
            "y":0,
            "alpha":1,
      ...
      {
         var criticalHit:Boolean = param1;
         ...
         container.to(_displayObject.container,0.43333333333333335,{
            "x":0,
            "y":6
         });
         ...
         attackWooshB.fromTo(_displayObject.attackWooshB,0.8333333333333334,{
            "x":68.4,
            "alpha":1,
            "immediateRender":false
         },{
         ...
         attackWooshA.fromTo(_displayObject.attackWooshA,0.8333333333333334,{
            "x":126.15,
            "alpha":1,
            "immediateRender":false
         },{
         ...
         teamMissileThrowB.fromTo(_displayObject.teamMissileThrowB,0.4666666666666667,{
            "x":66,
            "y":125,
            "alpha":1,
            "immediateRender":false
         ...
         teamMissileThrowA.fromTo(_displayObject.teamMissileThrowA,0.4666666666666667,{
            "x":86,
            "y":125,
            "alpha":1,
            "immediateRender":false
      ...
      public function being_attacked_hit_from_right() : void
      {
         ...
         container.to(_displayObject.container,0.9333333333333333,{
            "x":0,
            "y":0
         });
         container.play();
         ...
         damageDisplay.fromTo(_displayObject.damageDisplay,0.13333333333333333,{
            "x":79,
            "y":82.75,
            "alpha":0,
            "scaleX":1,
         ...
         damageDisplay.to(_displayObject.damageDisplay,0.6666666666666666,{
            "x":79,
            "y":82.75,
            "alpha":0,
            "scaleX":1,
         ...
         damageDisplay.play();
         being_attacked_hit_from_right.add(damageDisplay,0.8333333333333334);
         ...
         },null,0.9666666666666667);
         being_attacked_hit_from_right.call(function():void
         {
            _avatar.handleEvent("hitAnimationComplete");
         },null,1.6333333333333333);
      ...
      public function being_attacked_critical_from_right() : void
      {
         ...
         container.to(_displayObject.container,0.7666666666666666,{
            "x":0,
            "y":0
         });
         container.play();
         being_attacked_critical_from_right.add(container,0.7333333333333333);
         var criticalDisplay:TimelineMax = new TimelineMax({"paused":true});
         criticalDisplay.fromTo(_displayObject.criticalDisplay,0.13333333333333333,{
            "alpha":0,
            "immediateRender":false
         },{"alpha":1});
         criticalDisplay.to(_displayObject.criticalDisplay,0.6333333333333333,{"alpha":0});
         criticalDisplay.play();
         being_attacked_critical_from_right.add(criticalDisplay,0.9333333333333333);
         var damageDisplay:TimelineMax = new TimelineMax({"paused":true});
         damageDisplay.fromTo(_displayObject.damageDisplay,0.13333333333333333,{
            "x":51,
            "y":84.75,
         ...
         damageDisplay.to(_displayObject.damageDisplay,0.6333333333333333,{
            "x":51,
            "y":84.75,
            "alpha":0,
            "scaleX":1,
         ...
         damageDisplay.play();
         being_attacked_critical_from_right.add(damageDisplay,0.9333333333333333);
         being_attacked_critical_from_right.call(function():void
         {
            _avatar.handleEvent("attackSoundGetHitCritical");
         },null,0.7666666666666666);
         being_attacked_critical_from_right.call(function():void
         {
            _avatar.handleEvent("damageDone");
         },null,1.0333333333333332);
         being_attacked_critical_from_right.call(function():void
         {
            _avatar.handleEvent("hitAnimationComplete");
         },null,1.7);
      ...
      public function being_attacked_missile_from_right() : void
      {
         ...
         container.play();
         being_attacked_missile_from_right.add(container,0.7333333333333333);
         var criticalDisplay:TimelineMax = new TimelineMax({"paused":true});
         criticalDisplay.fromTo(_displayObject.criticalDisplay,0.13333333333333333,{
            "alpha":0,
            "immediateRender":false
         ...
         criticalDisplay.to(_displayObject.criticalDisplay,0.6333333333333333,{"alpha":0});
         criticalDisplay.play();
         being_attacked_missile_from_right.add(criticalDisplay,0.9333333333333333);
         var damageDisplay:TimelineMax = new TimelineMax({"paused":true});
         damageDisplay.fromTo(_displayObject.damageDisplay,0.13333333333333333,{
            "x":51,
            "y":84.75,
      ...
      public function being_attacked_hit_from_left() : void
      {
         ...
         damageDisplay.play();
         being_attacked_hit_from_left.add(damageDisplay,0.8333333333333334);
      ...
      public function being_attacked_dodge() : void
      {
         ...
         var container:TimelineMax = new TimelineMax({"paused":true});
         container.fromTo(_displayObject.container,0.23333333333333334,{
            "x":0,
            "y":0,
            "immediateRender":false
         },{
         ...
         container.to(_displayObject.container,0.6666666666666666,{
            "x":0,
            "y":0
         });
         container.to(_displayObject.container,0.3333333333333333,{
            "x":0,
            "y":0
         });
         container.play();
         being_attacked_dodge.add(container,0.5333333333333333);
         var dodgedDisplay:TimelineMax = new TimelineMax({"paused":true});
         dodgedDisplay.fromTo(_displayObject.dodgedDisplay,0.13333333333333333,{
            "alpha":0,
            "immediateRender":false
         },{"alpha":1});
         dodgedDisplay.to(_displayObject.dodgedDisplay,0.8333333333333334,{"alpha":0});
         dodgedDisplay.play();
      ...
      public function damage_from_dot() : void
      {
         ...
         var container:TimelineMax = new TimelineMax({"paused":true});
         container.fromTo(_displayObject.container,0.13333333333333333,{
            "x":0,
            "y":0,
            "immediateRender":false
         },{
         ...
         container.to(_displayObject.container,0.5666666666666667,{
            "x":0,
            "y":0
         });
         container.play();
         ...
         damageDisplay.to(_displayObject.damageDisplay,0.43333333333333335,{
            "x":84,
            "y":102.75,
            "alpha":0,
            "scaleX":1,
         ...
         damageDisplay.play();
         damage_from_dot.add(damageDisplay,0.13333333333333333);
         damage_from_dot.call(function():void
         {
            _avatar.handleEvent("attackSoundGetHit");
         },null,0.03333333333333333);
         damage_from_dot.call(function():void
         {
            _avatar.handleEvent("dotDamageDone");
         },null,0.23333333333333334);
         damage_from_dot.call(function():void
         {
      ...
      public function being_backfired_from_right() : void
      {
         ...
         container.to(_displayObject.container,0.7333333333333333,{
            "x":0,
            "y":0
         });
         container.play();
         being_backfired_from_right.add(container,0.03333333333333333);
         var damageDisplay:TimelineMax = new TimelineMax({"paused":true});
         damageDisplay.fromTo(_displayObject.damageDisplay,0.13333333333333333,{
            "x":79,
            "y":82.75,
         ...
         damageDisplay.to(_displayObject.damageDisplay,0.4666666666666667,{
            "x":79,
            "y":82.75,
            "alpha":0,
            "scaleX":1,
         ...
         damageDisplay.play();
         being_backfired_from_right.add(damageDisplay,0.26666666666666666);
         ...
         },null,0.36666666666666664);
         being_backfired_from_right.call(function():void
         {
            _avatar.handleEvent("backfireAnimationComplete");
         },null,0.8666666666666667);
      ...
      public function being_backfired_from_left() : void
      {
         ...
         container.play();
         being_backfired_from_left.add(container,0.03333333333333333);
         var damageDisplay:TimelineMax = new TimelineMax({"paused":true});
         damageDisplay.fromTo(_displayObject.damageDisplay,0.13333333333333333,{
            "x":79,
            "y":82.75,
         ...
         damageDisplay.play();
         being_backfired_from_left.add(damageDisplay,0.26666666666666666);
      ...
      {
         var displayObject:SymbolTeamMissileExplodeAnimationGeneric = param1;
         ...
         splash.fromTo(displayObject.splash,0.7,{
            "x":-47,
            "y":-44.95,
            "scaleX":0.3725433349609375,
            "scaleY":0.3725433349609375,
            "alpha":1,
            "immediateRender":false
         },{
            "x":-127,
            "y":-150.95,
            "scaleY":1.7413177490234375,
            "alpha":0,
            "scaleX":1
         });
         splash.play();
