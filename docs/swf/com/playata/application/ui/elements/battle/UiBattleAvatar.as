package com.playata.application.ui.elements.battle
{
   ...
   public class UiBattleAvatar
   {
      ...
      public function battleSkillIconAnimation() : void
      {
         ...
         icon.fromTo(_avatar.iconAnimation.icon,0.36666666666666664,{
            "x":-88,
            "y":100,
            "scaleX":0.4444427490234375,
            "scaleY":0.4444427490234375,
            "alpha":0,
         ...
         icon.to(_avatar.iconAnimation.icon,0.5666666666666667,{
            "x":-113,
            "y":0,
            "scaleX":1,
            "scaleY":1,
         ...
         icon.to(_avatar.iconAnimation.icon,0.5,{
            "x":-143,
            "y":-30,
            "scaleX":1.666656494140625,
            "scaleY":1.666656494140625,
            "alpha":0
         });
         icon.play();
      ...
      public function fillNpc(param1:String, param2:int, param3:Boolean = false) : void
      {
         ...
         var _loc4_:int = 360;
         var _loc6_:int = 420;
         var _loc5_:IDisplayObjectContainer;
         (_loc5_ = UriSprite.load(param1,_loc4_,_loc6_,true,1,null,true)).x = 212 - _loc4_ >> 1;
         _loc5_.y = 15;
         _avatar.container.alpha = 1;
