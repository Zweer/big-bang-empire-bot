package com.playata.application.ui.elements.battle
{
   ...
   public class UiBattleSkillGenerationResult
   {
      ...
      public function UiBattleSkillGenerationResult(param1:SymbolBattleSkillGenerationResultGeneric, param2:Function, param3:int)
      {
         ...
         _button.tag = param3;
         param1.txtNameSkill.autoFontSize = param1.txtInfo.autoFontSize = true;
      }
      ...
      private function onSelectSkill(param1:InteractionEvent) : void
      {
         ...
         _onSkillChosen((param1.target as UiButton).tag);
      }
      ...
      private function reset() : void
      {
         ...
         _content.animationContainer.scaleX = _content.animationContainer.scaleY = 1;
         _content.animationContainer.skill.visible = true;
         _content.animationContainer.unknown.visible = false;
         _content.txtNameSkill.x = -110;
         _content.txtNameSkill.scaleX = _content.txtNameSkill.scaleY = 1;
         _content.txtInfo.scaleX = _content.txtInfo.scaleY = 1;
         _content.btn.scaleX = _content.btn.scaleY = 1;
         _content.txtNameSkill.visible = _content.txtInfo.visible = true;
      ...
      public function get buildEffect() : BattleSkillGeneratedCloudEffect
      {
         return _buildEffect;
      }
   }
