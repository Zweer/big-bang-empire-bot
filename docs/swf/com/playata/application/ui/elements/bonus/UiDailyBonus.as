package com.playata.application.ui.elements.bonus
{
   ...
   public class UiDailyBonus extends UiDailyBonusBase
   {
       
      
      private var _content:SymbolDailyBonusGeneric = null;
      
      public function UiDailyBonus(param1:SymbolDailyBonusGeneric, param2:int)
      {
         _content = param1;
