package com.playata.application.ui.elements.bonus
{
   ...
   public class UiDailyBonusBase
   {
      ...
      public function refresh() : void
      {
         ...
         if(_dailyBonusLookupType == 3 && !AppConfig.dailyBonusQuestEnergyEnabled)
         {
            return;
         }
         ...
         fill.width = (background.width - 10) * (currentValue / maxValue);
         var _loc3_:int = 0;
         ...
         {
            case 0:
               _tooltip.text = LocText.current.text("daily_bonus/herobook/info");
               break;
            case 1:
               _tooltip.text = LocText.current.text("daily_bonus/duel_battles/info");
               break;
            case 2:
               _tooltip.text = LocText.current.text("daily_bonus/quest_energy_spent/info");
         }
      }
      ...
      private function get currentValue() : int
      {
         ...
         switch(int(_dailyBonusLookupType) - 1)
         {
            ...
            case 1:
               ...
               break;
            case 2:
               _loc1_ = _dailyBonusLookup.questEnergySpent;
         }
