package com.playata.application.ui.elements.citymap
{
   ...
   public class UiCitymapStageRewards
   {
      ...
      private var _buttons:Vector.<ICitymapQuestButton>;
      ...
      public function UiCitymapStageRewards(param1:SymbolCitymapStageRewardGeneric, param2:int, param3:Function)
      {
         ...
         _buttons = new Vector.<ICitymapQuestButton>();
         super();
         _content = param1;
         _stage = param2;
      ...
      public function refresh(param1:Vector.<GoalValue>) : void
      {
         ...
         var _loc10_:Character;
         if((_loc12_ = (_loc10_ = User.current.character).getStageQuestIdsForStage(_stage)) == null)
         {
            return;
         }
         var _loc29_:String = _loc12_.join(";");
         if(_currentDisplayHash == _loc29_ && !_loc10_.hasEventQuest && (!_loc10_.herobook || !_loc10_.herobook.hasCollectItemObjective()))
         {
            return;
         }
         hideElements();
         ...
         {
            if((_loc8_ = _quest[_loc21_]).reward.movieVotes > 0)
            {
               _loc23_++;
               _elementsAdded++;
               getItemButton("eventItem" + _loc23_).visible = true;
               (_loc25_ = new UiMovieVoteItemButton(getItemButton("eventItem" + _loc23_),_loc8_,onClickCitymapQuestButton,handleInteractionOver,handleMouseMove)).movieVotes = _loc8_.reward.movieVotes;
            ...
            if(_loc8_.reward.eventItemIdentifier)
            {
               ...
               _elementsAdded++;
               getItemButton("eventItem" + _loc23_).visible = true;
               (_loc11_ = new UiEventItemButton(getItemButton("eventItem" + _loc23_),_loc8_,onClickCitymapQuestButton,handleInteractionOver,handleMouseMove)).eventItem = _loc8_.reward.eventItemIdentifier;
            ...
            if(_loc8_.reward.repeatDatingIndex > 0)
            {
               ...
               (_loc5_ = new UiRepeatDatingKeyButton(getItemButton("storyDungeonItem" + _loc17_),_loc8_,onClickCitymapQuestButton,handleInteractionOver,handleMouseMove)).dating = _loc8_.reward.repeatDatingIndex;
            ...
            if(_loc8_.reward.datingItemIdentifier)
            {
               ...
               _elementsAdded++;
               getItemButton("eventItem" + _loc23_).visible = true;
               (_loc27_ = new UiDatingItemButton(getItemButton("eventItem" + _loc23_),_loc8_,onClickCitymapQuestButton,handleInteractionOver,handleMouseMove)).datingItem = _loc8_.reward.datingItemIdentifier;
            ...
            if(_loc8_.reward.repeatStoryDungeonIndex > 0)
            {
               ...
               _elementsAdded++;
               getItemButton("storyDungeonItem" + _loc17_).visible = true;
               (_loc6_ = new UiRepeatStoryDungeonKeyButton(getItemButton("storyDungeonItem" + _loc17_),_loc8_,onClickCitymapQuestButton,handleInteractionOver,handleMouseMove)).storyDungeon = _loc8_.reward.repeatStoryDungeonIndex;
            ...
            if(_loc8_.reward.storyDungeonUnlockPoint)
            {
               ...
               if(_loc30_ && _loc30_.storyDungeonIndex == _loc8_.reward.storyDungeonUnlockPoint && !_loc30_.allPointsCollected())
               {
                  ...
                  _elementsAdded++;
                  getItemButton("storyDungeonItem" + _loc17_).visible = true;
                  (_loc20_ = new UiStoryDungeonItemButton(getItemButton("storyDungeonItem" + _loc17_),_loc8_,onClickCitymapQuestButton,handleInteractionOver,handleMouseMove)).storyDungeon = _loc30_.storyDungeonIndex;
               ...
               else if(_loc7_ && _loc7_.storyDungeonIndex == _loc8_.reward.storyDungeonUnlockPoint && !_loc7_.allPointsCollected())
               {
                  ...
                  _elementsAdded++;
                  getItemButton("storyDungeonItem" + _loc17_).visible = true;
                  (_loc20_ = new UiStoryDungeonItemButton(getItemButton("storyDungeonItem" + _loc17_),_loc8_,onClickCitymapQuestButton,handleInteractionOver,handleMouseMove)).storyDungeon = _loc7_.storyDungeonIndex;
                  _buttons.push(_loc20_);
               }
            }
            if(_loc8_.reward.guildCompetitionItemIdentifier)
            {
               ...
               _elementsAdded++;
               getItemButton("eventItem" + _loc23_).visible = true;
               (_loc24_ = new UiGuildCompetitionItemButton(getItemButton("eventItem" + _loc23_),_loc8_,onClickCitymapQuestButton,handleInteractionOver,handleMouseMove)).guildCompetitionItem = _loc8_.reward.guildCompetitionItemIdentifier;
            ...
            if(_loc8_.reward.herobookItemIdentifier)
            {
               ...
               _elementsAdded++;
               getItemButton("eventItem" + _loc23_).visible = true;
               (_loc18_ = new UiHerobookItemButton(getItemButton("eventItem" + _loc23_),_loc8_,onClickCitymapQuestButton,handleInteractionOver,handleMouseMove)).refresh(_loc8_.reward.herobookItemIdentifier);
            ...
            while(_loc22_ < param1.length)
            {
               ...
               if(_loc2_.goal.identifier == _loc3_ && !_loc2_.isCollectable(_loc10_))
               {
                  ...
                  (_loc26_ = new UiGoalButton(_content.getChildByName("goal" + _loc15_) as SymbolGoalItemGeneric,_loc8_,onClickCitymapQuestButton,handleInteractionOver,handleMouseMove)).goalValue = _loc2_;
            ...
            if(_loc8_.reward.itemId > 0)
            {
               ...
               (_loc16_ = new UiItemSlotButton(_content.getChildByName("item" + _loc28_) as SymbolItemSlotGeneric,_loc8_,0,onClickCitymapQuestButton,handleInteractionOver,handleMouseMove)).item = _loc10_.getItemById(_loc8_.reward.itemId);
            ...
            if(_loc8_.reward.slotMachinJetons > 0)
            {
               ...
               (_loc9_ = new UiSlotMachineJetonButton(_content.getChildByName("jeton" + _loc14_) as SymbolSlotmachineJetonRewardGeneric,_loc8_,onClickCitymapQuestButton,handleInteractionOver,handleMouseMove)).amount = _loc8_.reward.slotMachinJetons;
            ...
            if(_loc8_.reward.opticalChangeResource > 0)
            {
               ...
               (_loc13_ = new UiOpticalChangeResourceButton(_content.getChildByName("opticalChangeResource" + _loc19_) as SymbolOpticalChangeResourceRewardGeneric,_loc8_,onClickCitymapQuestButton,handleInteractionOver,handleMouseMove)).amount = _loc8_.reward.opticalChangeResource;
      ...
      private function onClickCitymapQuestButton(param1:ICitymapQuestButton) : void
      {
         ...
         _onClickFunction(param1.quest);
      }
      
      private function onItemAction(param1:String) : Boolean
      {
         if(!_currentQuestButton || !_currentQuestButton.quest)
         {
            return true;
         }
         if(param1 == "openQuest")
