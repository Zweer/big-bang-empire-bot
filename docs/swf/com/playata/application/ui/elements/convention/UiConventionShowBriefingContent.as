package com.playata.application.ui.elements.convention
{
   ...
   public class UiConventionShowBriefingContent
   {
      ...
      private var _reward1:UiConventionReward = null;
      
      private var _reward2:UiConventionReward = null;
      ...
      public function UiConventionShowBriefingContent(param1:SymbolConventionShowBriefingContentGeneric, param2:IDisplayObjectContainer, param3:IDisplayObjectContainer)
      {
         ...
         _content.reward1.txtValue.width = _content.reward2.txtValue.width = 110;
         _content.reward1.txtValue.autoFontSize = _content.reward2.txtValue.autoFontSize = true;
         _reward1 = new UiConventionReward(_content.reward1);
         _reward2 = new UiConventionReward(_content.reward2);
      ...
      public function refresh(param1:Convention) : void
      {
         ...
         _reward2.setValue(2,LocText.current.text("dialog/convention_show_briefing/reward_streaming_resource"),LocText.current.text("dialog/convention_show_briefing/reward_streaming_resource_tooltip",GameUtil.getHighestConventionRewardValue(2)));
         refreshHitpoints();
         _bannerLeftContainer.removeAllChildren();
