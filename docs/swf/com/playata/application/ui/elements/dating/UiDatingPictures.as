package com.playata.application.ui.elements.dating
{
   ...
   public class UiDatingPictures extends InteractiveDisplayObject
   {
      ...
      public function UiDatingPictures(param1:SymbolUiDatingPicturesGeneric, param2:Function)
      {
         ...
         {
            if(_loc5_ = User.current.character.dating.getUnlockedPicturesByDatingIndex(_loc4_) > 0 || User.current.character.dating.hasActiveDatingStep(_loc4_) || User.current.character.dating.isDatingAvailable(User.current.character,_loc4_))
            {
      ...
      private function onSelectLine(param1:UiDatingPictureLine) : void
      {
         ...
         if(_currentDatingIndex >= 0)
         {
            ...
            else
            {
               ...
               if(_loc4_ = _loc3_.getActiveDatingStepByDating(_currentDatingIndex))
               {
