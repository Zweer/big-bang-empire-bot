   ...
   public class UiDatingStepReward
   {
      ...
      public function refresh(param1:int, param2:int, param3:Boolean) : void
      {
         ...
         if(param1 > 0 && param2 > 0)
         {
            ...
            if(_loc4_ = DatingUtil.getRewardItemIsRandom(param1,param2,param3))
            {
            ...
            _content.txtGirlPictureReward.visible = _content.iconGirlPictureReward.visible = DatingUtil.hasRewardImage(param1,param2,param3);
