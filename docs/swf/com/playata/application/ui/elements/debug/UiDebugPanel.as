package com.playata.application.ui.elements.debug
{
   ...
   public class UiDebugPanel
   {
      ...
      public function UiDebugPanel(param1:SymbolDebugPanelGeneric)
      {
         ...
         addDebug("addItem","gameTestAddItem","");
         addSeperator("Guild");
         ...
         addDebug("SyncDuelOpponents","gameTestSyncDuelOpponents");
         ...
         addSeperator("Draw Quest");
         addDebug("AbortDrawEvent","gameTestAbortDrawEvent");
         ...
         addSeperator("Tournament");
         addDebug("LockTournament","gameTestLockTournament");
         addDebug("UnlockTournament","gameTestUnlockTournament");
         addDebug("ProcessTournament","gameTestProcessTournament");
         addDebug("CreateTournamentTestData","gameTestCreateTournamentTestData");
         ...
         addDebug("AddCharacterTournamentReward","gameTestAddCharacterTournamentReward","");
         ...
         addSeperator("Season");
         addDebug("AddSeasonPoints","gameTestAddSeasonPoints","3");
         addDebug("RemoveSeason","gameTestRemoveSeason");
         addDebug("UnlockNextSeasonReward","gameTestUnlockNextSeasonReward");
         _list.refreshList();
      ...
      private function addDebug(param1:String, param2:String, param3:String = null) : void
      {
