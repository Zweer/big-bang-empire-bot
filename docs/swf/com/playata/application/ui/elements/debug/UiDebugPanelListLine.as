package com.playata.application.ui.elements.debug
{
   ...
   public class UiDebugPanelListLine extends ListLine
   {
      ...
      {
         return Math.min(30,super.height);
      }
      ...
      override public function refresh(param1:IListItem, param2:int) : void
      {
         ...
         if(_rawItem.defaultValue !== null)
         {
            _rawContent.inputBackground.visible = _rawContent.txtInput.visible = true;
         ...
         {
            _rawContent.inputBackground.visible = _rawContent.txtInput.visible = false;
