package com.playata.application.ui.elements.dungeon
{
   ...
   public class UiDungeonPath
   {
      ...
      private function showCheckPoint(param1:int, param2:Boolean) : void
      {
         ...
         while(_loc3_ <= 20)
         {
            if(!(_loc5_ = _currentPath.getChildByName("step" + param1 + "_" + _loc3_)))
            {
               break;
            }
         ...
         var _loc6_:SymbolDungeonPathCheckPointGeneric;
         if(_loc6_ = _currentPath.getChildByName("checkpoint" + param1) as SymbolDungeonPathCheckPointGeneric)
         {
         ...
         if(_loc4_ = _currentPath.getChildByName("overlayHide" + param1))
         {
