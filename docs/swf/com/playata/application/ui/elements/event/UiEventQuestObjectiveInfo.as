package com.playata.application.ui.elements.event
{
   ...
   public class UiEventQuestObjectiveInfo
   {
      ...
      public function UiEventQuestObjectiveInfo(param1:SymbolEventQuestObjectiveInfoGeneric, param2:Function, param3:Function)
      {
         ...
         var _loc4_:SeasonProgress;
         if((_loc4_ = User.current.character.seasonProgress).isActive() && _loc4_.hasSeasonPointLocation(2))
         {
            _seasonPointReward = new UiSeasonPointReward(param1.seasonPointReward,_loc4_,2);
            _content.reward.txtValue.width = param1.seasonPointReward.x - (_content.reward.x + _content.reward.txtValue.x);
         }
         else
         {
      ...
      public function refresh(param1:EventQuestObjective) : void
      {
         ...
         if(_seasonPointReward)
         {
            _content.seasonPointReward.x = _content.reward.x + _content.reward.txtValue.x + _content.reward.txtValue.textWidth + 5;
         }
      }
