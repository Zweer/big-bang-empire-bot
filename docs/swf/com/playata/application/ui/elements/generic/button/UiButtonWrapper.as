package com.playata.application.ui.elements.generic.button
{
   ...
   public class UiButtonWrapper
   {
      ...
      {
         _tooltipLayer.onClick.remove(handleClick);
         _tooltipLayer.onInteractionOut.remove(handleInteractionOut);
         _tooltipLayer.onInteractionOver.remove(handleInteractionOver);
         _content = null;
      }
