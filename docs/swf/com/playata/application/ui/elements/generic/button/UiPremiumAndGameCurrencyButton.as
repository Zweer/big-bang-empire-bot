package com.playata.application.ui.elements.generic.button
{
   ...
   public class UiPremiumAndGameCurrencyButton extends UiButton
   {
      ...
      public function UiPremiumAndGameCurrencyButton(param1:SymbolButtonPremiumAndGameCurrencyGeneric, param2:String, param3:int, param4:int, param5:String, param6:Function)
      {
         ...
         _contentVO = param1;
         param1.costGameCurrency.caption.autoFontSize = param1.costPremium.caption.autoFontSize = true;
         this.caption = param2;
      }
      ...
      {
         _contentVO.costPremium.visible = _contentVO.iconPremiumCurrency.visible = premiumAmount > 0;
         _contentVO.costGameCurrency.visible = _contentVO.iconGameCurrency.visible = gameCurrencyAmount > 0;
         ...
         {
            _loc3_ += _contentVO.iconGameCurrency.width + _contentVO.costGameCurrency.caption.width + 30;
         }
         if(premiumAmount > 0)
         {
            _loc3_ += _contentVO.iconPremiumCurrency.width + _contentVO.costPremium.caption.width + 28;
         }
         if(_loc3_ > _loc1_)
         {
         ...
         if(gameCurrencyAmount > 0)
         {
            _loc2_ -= _contentVO.costGameCurrency.width + 20;
            _contentVO.costGameCurrency.x = _loc2_;
            _loc2_ -= 10;
            _contentVO.iconGameCurrency.x = _loc2_;
            _loc2_ -= 20;
            _contentVO.costGameCurrency.visible = _contentVO.iconGameCurrency.visible = true;
         }
         else
         {
            _contentVO.costGameCurrency.visible = _contentVO.iconGameCurrency.visible = false;
         }
         if(premiumAmount > 0)
         {
            _loc2_ -= _contentVO.costPremium.width + 20;
            _contentVO.costPremium.x = _loc2_;
            _loc2_ -= 18;
            _contentVO.iconPremiumCurrency.x = _loc2_;
            _loc2_ -= 10;
            _contentVO.costPremium.visible = _contentVO.iconPremiumCurrency.visible = true;
         }
         else
         {
            _contentVO.costPremium.visible = _contentVO.iconPremiumCurrency.visible = false;
         }
      ...
      override public function set buttonEnabled(param1:Boolean) : void
      {
         ...
         if(!param1)
         {
            _premiumAmount = _gameCurrencyAmount = 0;
            refresh();
         }
      }
   }
