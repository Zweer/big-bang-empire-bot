package com.playata.application.ui.elements.generic.button
{
   ...
   public class UiPremiumButton extends UiButton
   {
      ...
      private function adjustWidth() : void
      {
         ...
         var _loc6_:ILabel;
         var _loc5_:Number = (_loc6_ = _loc1_.caption as ILabel).width;
         var _loc2_:Number = _loc6_.textWidth;
         if(_loc2_ > _loc5_)
         {
            _loc4_ = _loc2_ - _loc5_ + 10;
            _loc6_.width += _loc4_;
            _loc6_.x -= Math.round(_loc4_ / 2);
            _loc1_.background.width += _loc4_;
            _loc1_.background.x -= Math.round(_loc4_ / 2);
            _loc1_.iconPremiumCurrency.x += Math.round(_loc4_ / 2);
            _loc3_ = _loc1_.cost as Object;
            _loc3_.caption.x += Math.round(_loc4_ / 2);
         }
      }
   }
}
