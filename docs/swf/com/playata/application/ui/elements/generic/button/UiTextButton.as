package com.playata.application.ui.elements.generic.button
{
   ...
   public class UiTextButton extends UiButton
   {
      ...
      public function UiTextButton(param1:IDisplayObject, param2:String, param3:String, param4:Function, param5:Boolean = true, param6:String = "center")
      {
         ...
         var _loc7_:Object;
         (_loc7_ = param1 as Object).caption.text = param2;
      ...
      public function changeWidth(param1:Number) : void
      {
         ...
         _loc4_.width += _loc3_;
         _loc2_.bg.width += _loc3_;
         if(_dynamicWidthAdjustmentAlign == "center")
         {
            _loc4_.x -= Math.round(_loc3_ / 2);
            _loc2_.bg.x -= Math.round(_loc3_ / 2);
         }
         else if(_dynamicWidthAdjustmentAlign != "left")
         {
            if(_dynamicWidthAdjustmentAlign == "right")
            {
               _loc4_.x -= Math.round(_loc3_);
               _loc2_.bg.x -= Math.round(_loc3_);
            }
         }
      }
      ...
      protected function adjustWidth() : void
      {
         ...
         var _loc1_:Object = content as Object;
         var _loc4_:ILabel;
         var _loc3_:Number = (_loc4_ = _loc1_.caption as ILabel).width;
         ...
         if(_loc2_ > _loc3_)
         {
            ...
            _loc4_.width += _widthAdjustment;
            _loc1_.bg.width += _widthAdjustment;
            if(_dynamicWidthAdjustmentAlign == "center")
            {
               _loc4_.x -= Math.round(_widthAdjustment / 2);
               _loc1_.bg.x -= Math.round(_widthAdjustment / 2);
            }
            else if(_dynamicWidthAdjustmentAlign != "left")
            {
               if(_dynamicWidthAdjustmentAlign == "right")
               {
                  _loc4_.x -= Math.round(_widthAdjustment);
                  _loc1_.bg.x -= Math.round(_widthAdjustment);
               }
            }
         }
      }
