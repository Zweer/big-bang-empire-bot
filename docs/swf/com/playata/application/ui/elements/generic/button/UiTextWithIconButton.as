package com.playata.application.ui.elements.generic.button
{
   ...
   public class UiTextWithIconButton extends UiTextButton
   {
      ...
      override protected function adjustWidth() : void
      {
         ...
         var _loc5_:ILabel;
         var _loc4_:Number = (_loc5_ = _loc1_.caption as ILabel).width;
         ...
         if(_loc2_ > _loc4_)
         {
            ...
            _loc5_.width += _widthAdjustment;
            _loc1_.bg.width += _widthAdjustment * 1.05;
            if(_dynamicWidthAdjustmentAlign == "center")
            {
               _loc5_.x -= Math.round(_widthAdjustment / 2) + 2;
               _icon.x -= Math.round(_widthAdjustment / 2) + 2;
            ...
            else if(_dynamicWidthAdjustmentAlign != "left")
            {
               ...
               {
                  _loc5_.x -= Math.round(_widthAdjustment);
