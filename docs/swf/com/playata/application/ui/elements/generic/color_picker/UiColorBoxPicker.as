   ...
   public class UiColorBoxPicker
   {
      ...
      public function open(param1:Vector.<uint>, param2:uint, param3:Function = null) : void
      {
         ...
         for each(var _loc5_ in param1)
         {
            ...
            {
               _loc4_ = 0;
               _loc7_ += _content.boxes.getChildAt(0).height + 4;
            }
            (_loc8_ = new UiColorBox(new SymbolColorBoxGeneric(),_loc5_,"",onClickSelect)).content.x = _loc4_ + _loc8_.content.width / 2;
