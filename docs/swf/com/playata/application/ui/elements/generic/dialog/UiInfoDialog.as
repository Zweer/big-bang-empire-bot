package com.playata.application.ui.elements.generic.dialog
{
   ...
   public class UiInfoDialog extends UiDialog
   {
      ...
      public function UiInfoDialog(param1:String, param2:String, param3:String, param4:Function = null, param5:Boolean = false, param6:Boolean = false)
      {
         ...
         var _loc10_:Number;
         if((_loc10_ = _loc8_.textMessage.textHeight) > _loc9_)
         {
            _loc7_ = _loc10_ - _loc9_;
            _loc8_.background.height += _loc7_;
            _loc8_.textMessage.height += _loc7_ + 5;
            _loc8_.button1.y += _loc7_;
            _loc8_.background.y -= _loc7_ / 2;
            _loc8_.textTitle.y -= _loc7_ / 2;
            _loc8_.textMessage.y -= _loc7_ / 2;
            _loc8_.button1.y -= _loc7_ / 2;
         }
         else
         {
