package com.playata.application.ui.elements.generic.textfield
{
   ...
   public class UiChatOutputRichTextArea extends UiChatOutputBase
   {
      ...
      {
         super();
         var _loc2_:String = "FontCopyChat";
         _loc2_ = param1.fontName;
         ...
         for each(var _loc4_ in GuildChatEmoticon.getAllEmoticons())
         {
            for each(var _loc3_ in _loc4_.codes)
            {
               _richTextArea.registerElement(_loc3_,requestVisual,new TypedObject({
                  "imageUrl":_loc4_.imageUrl,
                  "identifier":_loc4_.identifier
               }));
            }
         }
