package com.playata.application.ui.elements.goal
{
   ...
   public class UiGoalFilter implements IListFilter
   {
      ...
      public function UiGoalFilter(param1:SymbolGoalFilterGeneric, param2:Function, param3:Character)
      {
         super();
         _content = param1;
      ...
      public static function isAllowed(param1:GoalValue, param2:Character, param3:Boolean = true) : Boolean
      {
         var _loc4_:Boolean = true;
         switch(int(param1.rewardType) - 1)
         {
            case 0:
               _loc4_ = _showGameCurrencyGoals;
               break;
            case 1:
               _loc4_ = _showPremiumGoals;
               break;
            case 2:
               _loc4_ = _showStatGoals;
               break;
            case 3:
               _loc4_ = _showXPGoals;
               break;
            case 4:
               _loc4_ = _showItemGoals;
               break;
            case 5:
               _loc4_ = _showEnergyGoals;
               break;
            case 6:
               _loc4_ = _showBoosterGoals;
         }
         if(param1.hasTitleReward)
         {
            _loc4_ = _showTitleGoals;
         }
         if(!_loc4_)
         {
            return _loc4_;
         }
         if(param3 && _filterText != "" && _filterText != LocText.current.text("dialog/goals/search_text"))
         {
      ...
      {
         var _loc2_:GoalValue = param1 as GoalValue;
         if(_filterLocked && !_loc2_.isCollectable(_character) && !_loc2_.isAvailable(_character))
         {
            return false;
         }
         return UiGoalFilter.isAllowed(_loc2_,_character,false);
      }
