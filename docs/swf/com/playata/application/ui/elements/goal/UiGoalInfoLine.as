   ...
   public class UiGoalInfoLine extends ListLine
   {
      ...
      private function refreshContent() : void
      {
         ...
         try
         {
            ...
            _rawContent.iconDating.visible = _rawContent.txtDatingReward.visible = DatingUtil.isAvailable && _goalValue.goal.identifier == "second_quests_completed";
            ...
            {
               _rawContent.iconNew.visible = _rawContent.txtNew.visible = false;
