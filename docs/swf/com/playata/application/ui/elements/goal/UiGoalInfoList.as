package com.playata.application.ui.elements.goal
{
   ...
   public class UiGoalInfoList extends ScrollList
   {
      ...
      {
         var _loc4_:UiGoalInfoLine;
         (_loc4_ = super.addExistingLine(param1,param2,param3) as UiGoalInfoLine).character = _character;
      ...
      public function refresh(param1:Goal, param2:GoalValue) : void
      {
         ...
         var _loc4_:UiGoalInfoLine;
         if(_loc4_ = getLineForItem(param2) as UiGoalInfoLine)
         {
