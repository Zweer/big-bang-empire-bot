package com.playata.application.ui.elements.guild
{
   ...
   public class UiGuildBattleSearchLine extends InteractiveDisplayObject
   {
      ...
      public function getResultTooltip() : String
      {
         ...
         if(_loc3_ == 0)
         {
            _loc1_ += LocText.current.text("dialog/guild_battle_search/tooltip_lose_no_honor");
         }
         else
         {
            _loc1_ += LocText.current.text("dialog/guild_battle_search/tooltip_lose_honor",GameUtil.getHonorString(_loc3_));
         }
         return _loc1_;
      }
