package com.playata.application.ui.elements.guild
{
   ...
   public class UiGuildBoosterExpiredButton
   {
      ...
      public function UiGuildBoosterExpiredButton(param1:SymbolButtonGuildBoosterExtendGeneric, param2:String, param3:Guild, param4:Function)
      {
         ...
         refresh(param3);
         _btnBuyForGameCurrency.x -= 10;
         _btnBuyForPremiumCurrency.x -= 10;
      ...
      {
         var _loc8_:CGuildBooster;
         var _loc5_:int = (_loc8_ = CGuildBooster.fromId(_boosterId)).amount;
         ...
         _content.backgroundQuest.alpha = _content.backgroundDuel.alpha = !!_content.checkmark.visible ? 0.3 : 0.15;
