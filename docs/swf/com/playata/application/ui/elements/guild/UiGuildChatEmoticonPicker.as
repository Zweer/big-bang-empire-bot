   ...
   public class UiGuildChatEmoticonPicker
   {
      ...
      public function open(param1:Function = null) : void
      {
         ...
         if(!_emoticons)
         {
            ...
            if(Environment.info.isTouchScreen)
            {
               _content.background.width += 50;
               _content.background.height += 25;
            }
            _content.icons.y += _loc3_ - _content.background.height;
            _content.background.y += _loc3_ - _content.background.height;
