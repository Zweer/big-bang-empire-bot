package com.playata.application.ui.elements.guild
{
   ...
   public class UiGuildCustomizeStudioTab
   {
      ...
      public function UiGuildCustomizeStudioTab(param1:SymbolGuildCustomizationGeneric, param2:IDisplayObjectContainer, param3:Function)
      {
         ...
         param1.txtPriceFreeRoom.text = param1.txtPriceFreeQuarter.text = param1.txtPriceFreeMotivation.text = param1.txtPriceFreePopularity.text = param1.txtPriceFreeEquipment.text = param1.txtPriceFreeActorsLeft.text = param1.txtPriceFreeActorsRight.text = LocText.current.text("screen/guild/studio_customization/free_customization");
         param1.txtPriceFreeRoom.visible = param1.txtPriceFreeQuarter.visible = param1.txtPriceFreeMotivation.visible = param1.txtPriceFreePopularity.visible = param1.txtPriceFreeEquipment.visible = param1.txtPriceFreeActorsLeft.visible = param1.txtPriceFreeActorsRight.visible = false;
      ...
      private function getValue(param1:String, param2:int) : String
      {
         ...
         var _loc4_:int;
         if((_loc4_ = (_loc4_ = _loc3_.indexOf(_settings.getString(param1))) + param2) < 0)
         {
      ...
      private function getPossibleValues(param1:String) : Vector.<String>
      {
         ...
         {
            if((_loc6_ = CGuildBackgroundLayer.fromId(_loc5_)).type == param1 && _loc6_.value <= _loc4_)
            {
      ...
      private function refreshPriceList() : void
      {
         ...
         _priceGameCurrencyTotal += _loc1_[0];
         _pricePremiumTotal += _loc1_[1];
         ...
         _content.iconPremiumTotal.visible = _content.txtPricePremiumTotal.visible = true;
         _content.txtPriceGameCurrencyTotal.text = LocText.current.formatHugeNumber(_priceGameCurrencyTotal);
         _content.iconGameCurrencyTotal.visible = _content.txtPriceGameCurrencyTotal.visible = true;
      }
      ...
      private function updatePrice(param1:String) : Vector.<int>
      {
         ...
         {
            _loc10_.visible = _loc2_.visible = _loc3_.visible = _loc9_.visible = false;
         }
         else
         {
            _loc10_.visible = true;
            _loc4_ = (_loc6_ = _loc11_.indexOf(_settings.getString(param1)) >= 0 ? 0 : getPremiumPriceOfValue(param1,_settings.getString(param1))) > 0 ? 0 : (_loc11_.indexOf(_settings.getString(param1)) >= 0 ? 0 : getGameCurrencyPriceOfValue(param1,_settings.getString(param1)));
      ...
      private function getPremiumPriceOfValue(param1:String, param2:String) : int
      {
         ...
         {
            if((_loc4_ = CGuildBackgroundLayer.fromId(_loc3_)).type == param1 && _loc4_.assetIdentifier == param2)
            {
