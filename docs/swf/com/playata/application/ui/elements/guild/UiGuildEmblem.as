package com.playata.application.ui.elements.guild
{
   ...
   public class UiGuildEmblem extends InteractiveDisplayObject
   {
      ...
      public function UiGuildEmblem(param1:SymbolGuildEmblemGeneric, param2:GuildEmblemSettings, param3:int, param4:int, param5:Function = null, param6:Boolean = true, param7:int = 1)
      {
         ...
         var _loc9_:Matrix;
         (_loc9_ = new Matrix()).createGradientBox(_emblemWidth,_emblemHeight,3.141592653589793 * 0.4);
         var _loc8_:Shape;
         (_loc8_ = new Shape()).graphics.beginGradientFill("linear",[16777215,16777215,16777215,16777215,16777215,16777215,16777215],[0,0,0.1,0.15,0.25,0.25,0],[0,20,25,80,85,100,105],_loc9_);
      ...
      private function onCompletedShapeFlash(param1:IUriSprite) : void
      {
         ...
         try
         {
            ...
            (_loc9_ = new BitmapData(int(_loc8_.width),int(_loc8_.height),true,0)).draw(_loc8_);
            ...
            _loc5_.x *= _loc5_.scaleX;
            _loc5_.y *= _loc5_.scaleY;
            if((_loc7_ = FlashDisplayObject.getNativeDisplayObject(_content) as Sprite).getChildByName("frameCopy") != null)
            {
      ...
      private function duplicateDisplayObject(param1:DisplayObject) : DisplayObject
      {
         ...
         var _loc5_:Class;
         (_loc6_ = new (_loc5_ = Object(param1).constructor)()).transform = param1.transform;
