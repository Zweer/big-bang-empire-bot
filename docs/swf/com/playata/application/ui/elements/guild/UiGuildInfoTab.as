package com.playata.application.ui.elements.guild
{
   ...
   import com.playata.application.ui.dialogs.DialogGuildApplication;
   ...
   public class UiGuildInfoTab
   {
      ...
      private function refreshButtons() : void
      {
         ...
         _btnAttack.visible = _guild.isOwnServer;
         ...
         _btnMovies.visible = _guild.isOwnServer && _guild.status != 2;
      ...
      {
         Environment.panelManager.showDialog(new DialogGuildApplication(_guild.id,_guild.name));
      }
      ...
      private function handleRequests(param1:ActionRequestResponse) : void
      {
         ...
         switch(param1.action)
         {
            ...
            case "checkAttackGuild":
               ...
               {
                  Environment.application.updateData(param1.data);
                  Environment.panelManager.showDialog(new DialogGuildBattleCreate(_guild.id));
               }
