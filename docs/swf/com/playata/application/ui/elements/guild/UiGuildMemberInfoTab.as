package com.playata.application.ui.elements.guild
{
   ...
   public class UiGuildMemberInfoTab extends InteractiveDisplayObject
   {
      ...
      private function onClickMessage(param1:InteractionEvent) : void
      {
         ...
         ViewManager.instance.baseUserPanel.streamsPanel.createPrivateConversation(_loc3_);
      }
      ...
      {
         Environment.panelManager.showDialog(new DialogCreatePrivateConversation(_guild.name,null,null,true));
      }
      ...
      private function selectLine(param1:UiGuildMemberInfoLine, param2:Boolean = true) : void
      {
         ...
         if(_selectedLine != null)
         {
            ...
            _btnMessage.buttonEnabled = _selectedMembers.length > 0 && !_loc4_ && _guild.isOwnServer;
      ...
      private function doubleClickLine(param1:UiGuildMemberInfoLine) : void
      {
         ...
         ViewManager.instance.loadCharacter(_selectedLine.member.id,null,_selectedLine.member.serverId);
      }
   }
}
