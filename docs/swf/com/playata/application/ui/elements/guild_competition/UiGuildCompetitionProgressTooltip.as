   ...
   public class UiGuildCompetitionProgressTooltip extends UiClosableTooltip
   {
      ...
      override public function onAssigned() : void
      {
         ...
         if(_guildCompetition.score >= CConstant.guild_competition_min_score)
         {
            ...
            {
               _tooltipContent.iconPremiumCurrency.visible = _tooltipContent.iconStatPoints.visible = _tooltipContent.iconXP.visible = false;
               _tooltipContent.txtPremiumCurrency.visible = _tooltipContent.txtStatPoints.visible = _tooltipContent.txtXP.visible = false;
            ...
            {
               _tooltipContent.iconPremiumCurrency.visible = _tooltipContent.iconStatPoints.visible = _tooltipContent.iconXP.visible = true;
               _tooltipContent.txtPremiumCurrency.visible = _tooltipContent.txtStatPoints.visible = _tooltipContent.txtXP.visible = true;
         ...
         if(_tooltipContent.txtRewardsCaption.visible)
         {
            ...
            {
               _tooltipContent.iconPremiumCurrency.y = _tooltipContent.iconStatPoints.y = _tooltipContent.txtRewardsCaption.y + 26;
               _tooltipContent.txtPremiumCurrency.y = _tooltipContent.txtStatPoints.y = _tooltipContent.txtRewardsCaption.y + 26;
