package com.playata.application.ui.elements.herobook
{
   ...
   public class UiHerobookButton extends UiButton
   {
      ...
      private function requestTooltip() : String
      {
         ...
         {
            _loc1_ += LocText.current.text("screen/quest/button_herobook_active_tooltip",_herobook.activeObjectiveCount);
         }
         if(_herobook.activeObjectiveCount > 0 && _herobook.minTimeRemainingLongString != "")
         {
            ...
            _loc1_ += LocText.current.text("screen/quest/button_herobook_time_tooltip",_herobook.minTimeRemainingLongString);
         }
         if(_herobook.collectableObjectiveCount > 0)
         {
            if(_loc1_ != "")
            ...
            _loc1_ += LocText.current.text("screen/quest/button_herobook_collectable_tooltip");
         }
         return _loc1_;
      }
      ...
      private function showTimer(param1:Herobook) : void
      {
         ...
         {
            _loc2_ = (_loc5_ = param1.objectives[_loc3_]).remainingSeconds;
