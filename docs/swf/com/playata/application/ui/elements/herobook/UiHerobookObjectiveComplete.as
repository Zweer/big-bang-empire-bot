package com.playata.application.ui.elements.herobook
{
   ...
   public class UiHerobookObjectiveComplete
   {
      ...
      private var _defaultButtonY:Number = 0;
      ...
      public function UiHerobookObjectiveComplete(param1:SymbolHerobookCompleteGeneric, param2:Function, param3:Function)
      {
         ...
         _seasonPointReward = new UiSeasonPointReward(_content.seasonPointReward,User.current.character.seasonProgress,0,true);
         _defaultButtonY = _content.btnCollect.y;
      }
      ...
      public function refresh(param1:HerobookObjective) : void
      {
         ...
         _seasonPointReward.refresh(_loc2_);
         if(_seasonPointReward.content.visible)
         {
            _content.btnCollect.y = _defaultButtonY + 20;
         }
         else
         {
            _content.btnCollect.y = _defaultButtonY;
         }
      }
         ...
         try
         {
            ...
            if(_content.iconStreamingResource.visible)
            {
               EffectsLayer.instance.show(15,{
                  "emitter":_content.iconStreamingResource,
                  "amount":_objective.reward.streamingResource
               });
            }
