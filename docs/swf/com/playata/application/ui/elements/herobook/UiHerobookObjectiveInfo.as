package com.playata.application.ui.elements.herobook
{
   ...
   public class UiHerobookObjectiveInfo
   {
      ...
      private var _seasonPointRewardWide:UiSeasonPointReward = null;
      ...
      public function UiHerobookObjectiveInfo(param1:SymbolHerobookInfoGeneric, param2:Function, param3:Function)
      {
         ...
         _seasonPointReward = new UiSeasonPointReward(_content.seasonPointRewards,User.current.character.seasonProgress,0);
         _seasonPointRewardWide = new UiSeasonPointReward(_content.seasonPointRewardWide,User.current.character.seasonProgress,0,true);
      }
      
      private function timerFinished() : void
      {
         _onClickBackFunction();
      }
      ...
      public function dispose() : void
      {
         ...
         _seasonPointRewardWide.dispose();
         _seasonPointRewardWide = null;
      ...
      public function refresh(param1:HerobookObjective) : void
      {
         ...
         var _loc3_:int = 10;
         if(_objective.durationType == 2)
         {
            _loc3_ = 9;
         }
         if(_content.itemReward.visible)
         {
            _seasonPointReward.refresh(_loc3_);
            _seasonPointRewardWide.refresh(0);
         }
         else
         {
            _seasonPointReward.refresh(0);
            _seasonPointRewardWide.refresh(_loc3_);
         }
      }
