package com.playata.application.ui.elements.hud
{
   ...
   public class UiHint
   {
      ...
      public function UiHint(param1:Sprite, param2:UiButton, param3:String = null, param4:String = null)
      {
         ...
         {
            (_loc5_ = _hint as Object).caption.fontSize = 18;
      ...
      public function set caption(param1:String) : void
      {
         ...
         if(_loc3_.caption.textWidth + 20 > _loc3_.caption.width)
         {
            ...
            _loc3_.bg.width += _loc2_;
            _loc3_.caption.width += _loc2_;
            _loc3_.cost.x += _loc2_;
            _loc3_.iconPremiumCurrency.x += _loc2_;
         }
      }
      ...
      public function set cost(param1:String) : void
      {
         ...
         if(_cost)
         {
            ...
            _loc2_.iconPremiumCurrency.visible = _loc2_.cost.visible = true;
         ...
         {
            _loc2_.iconPremiumCurrency.visible = _loc2_.cost.visible = false;
