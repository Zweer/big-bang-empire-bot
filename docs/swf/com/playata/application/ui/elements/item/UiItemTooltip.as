package com.playata.application.ui.elements.item
{
   ...
   public class UiItemTooltip extends UiClosableTooltip
   {
      ...
      private function refreshSewPattern() : void
      {
         ...
         _tooltipContent.txtItemEffectName.visible = _tooltipContent.iconItemEffect.visible = _item != null && _item.hasAnimation;
      ...
      private function refreshItem() : void
      {
         ...
         if(!_item.isUsable && _item.isOwnItem && !_loc4_)
         {
            ...
            {
               if((_loc7_ = ItemPatterns.instance.itemPattern(_item.itemPattern)) && !_loc7_.isItemCollected(_item.identifier))
               {
                  _tooltipContent.txtItemPatternInfo.visible = true;
         ...
         _loc2_ += _tooltipContent.txtStatsCaption.y + _loc8_;
         ...
         if(_battleSkill.height > 0)
         {
            ...
            _loc9_ += _battleSkill.height + 5;
            _loc2_ += _battleSkill.height + 5;
         }
         ...
         if(_loc11_)
         {
            ...
            _loc9_ += _tooltipContent.setInfo.height + 15;
            _loc2_ += _tooltipContent.setInfo.height + 15;
         }
         if(_tooltipContent.txtDescription.visible)
         {
            ...
            _loc2_ += _tooltipContent.txtDescription.height + 10;
         }
         _tooltipContent.txtItemEffectName.visible = _tooltipContent.iconItemEffect.visible = _item != null && _item.hasAnimation;
         if(_tooltipContent.iconItemEffect.visible)
         {
         ...
         var _loc12_:Vector.<Outfit>;
         if((_loc12_ = User.current.character.outfits.getOutfitsWithItem(_item)).length > 0)
         {
            _loc10_ = "";
            ...
            _loc2_ += _tooltipContent.txtOutfits.height + 20;
         }
         ...
         if(_item.isOutfitItem)
         {
            ...
            {
               _tooltipContent.iconOutfit.y -= 50;
            }
         ...
         {
            _tooltipContent.iconItemPatternInfo.y = _tooltipContent.txtItemPatternInfo.y = !!_item.isOutfitItem ? _tooltipContent.txtOutfit.y + _tooltipContent.txtOutfit.textHeight + 10 : Number(_tooltipContent.iconCoins.y + 29);
      ...
      private function refreshCompareItem(param1:StatTypes) : int
      {
         ...
         var _loc11_:Item;
         if((_loc11_ = UiItemTooltip.compareItem) == null && UiItemTooltip.compareOutfit != null)
         {
            _loc11_ = UiItemTooltip.compareOutfit.getItem(_item.type);
         }
         if(_loc11_ != null)
         {
            _loc5_ -= _loc11_.totalStats;
            _loc10_ = ItemSet.getStatValueDiff(_loc11_,_item);
            for(var _loc9_ in _loc10_)
            {
               _loc5_ += _loc10_.getData(_loc9_);
            }
         }
         var _loc4_:* = _loc2_;
         _tooltipContent.txtCompareCaption.visible = true;
         ...
         if(_loc11_ && _item.getMissileDamage() != _loc11_.getMissileDamage() && !containsStat(_loc7_,6))
         {
