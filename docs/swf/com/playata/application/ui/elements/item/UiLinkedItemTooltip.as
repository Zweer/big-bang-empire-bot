package com.playata.application.ui.elements.item
{
   ...
   public class UiLinkedItemTooltip extends UiClosableTooltip
   {
      ...
      private function refreshItem() : void
      {
         ...
         _loc1_ += _tooltipContent.txtStatsCaption.y + _loc3_;
         ...
         if(_battleSkill.height > 0)
         {
            ...
            _loc4_ += _battleSkill.height + 5;
            _loc1_ += _battleSkill.height + 5;
         }
         ...
         if(_loc5_)
         {
            ...
            _loc4_ += _tooltipContent.setInfo.height + 15;
            _loc1_ += _tooltipContent.setInfo.height + 15;
         }
         if(_tooltipContent.txtDescription.visible)
         {
            ...
            _loc1_ += _tooltipContent.txtDescription.height + 10;
         }
