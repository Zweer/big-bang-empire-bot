package com.playata.application.ui.elements.item
{
   ...
   public class UiLinkedItemTooltipSetInfo
   {
      ...
      public function UiLinkedItemTooltipSetInfo(param1:SymbolItemTooltipSetInfoGeneric)
      {
         super();
         _content = param1;
      ...
      public function refresh(param1:LinkedItem, param2:ItemSet) : void
      {
         var _loc5_:* = null;
         var _loc6_:* = null;
         ...
         for each(var _loc4_ in _loc3_.bonusIds)
         {
            ...
            _loc7_++;
            (_loc6_ = _content.getChildByName("stat" + _loc7_.toString()) as SymbolItemTooltipSetInfoStatGeneric).txtStat.text = LocText.current.text("general/item_set_value",Math.round(_loc5_.value * 100),GameUtil.getStatName(_loc5_.type));
            ...
            if(UiItemTooltip.compareItem != null && UiItemTooltip.compareItem.itemSetIdentifier && UiItemTooltip.compareItem.itemSetIdentifier != param1.itemSetIdentifier)
            {
               if(_loc8_ + 1 == _loc4_)
               {
            ...
            else if(UiItemTooltip.compareItem == null)
            {
               if(_loc8_ + 1 == _loc4_)
               {
                  getCompareLabel(_loc7_).text = "+" + Math.round(_loc5_.value * 100) + "%";
            ...
            else if(UiItemTooltip.compareItem != null && !UiItemTooltip.compareItem.itemSetIdentifier && param1.itemSetIdentifier)
            {
               if(_loc8_ + 1 == _loc4_)
               {
                  getCompareLabel(_loc7_).text = "+" + Math.round(_loc5_.value * 100) + "%";
