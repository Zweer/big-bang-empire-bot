package com.playata.application.ui.elements.leaderboard
{
   ...
   public class UiLeaderboardCharacterGlobalTournamentContent
   {
      ...
      public function UiLeaderboardCharacterGlobalTournamentContent(param1:SymbolLeaderboardGlobalTournamentContentGeneric, param2:Function, param3:Function, param4:Function, param5:CharacterGlobalTournamentLeaderboardContext)
      {
         super();
         _content = param1;
         _refreshButtons = param2;
         _onClick = param3;
         _onTournamentLocked = param4;
         _context = param5;
