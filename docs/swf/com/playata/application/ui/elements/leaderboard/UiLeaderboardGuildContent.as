package com.playata.application.ui.elements.leaderboard
{
   ...
   public class UiLeaderboardGuildContent
   {
      ...
      private function retrieveGuildLeaderboard(param1:Object) : void
      {
         ...
         Environment.application.sendActionRequest("retrieveGuildLeaderboard",param1,handleRequests);
      }
      ...
      private function handleRequests(param1:ActionRequestResponse) : void
      {
         ...
         else if(param1.error == "errRetrieveGuildLeaderboardSync")
         {
            Environment.panelManager.showDialog(new UiInfoDialog(LocText.current.text("error/retrieve_guild_leaderboard_sync_title"),LocText.current.text("error/retrieve_guild_leaderboard_sync_text"),LocText.current.text("general/button_ok")));
         }
         else
         {
