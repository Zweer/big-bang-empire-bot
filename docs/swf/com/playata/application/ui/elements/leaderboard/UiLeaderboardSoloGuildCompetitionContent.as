package com.playata.application.ui.elements.leaderboard
{
   ...
   public class UiLeaderboardSoloGuildCompetitionContent
   {
      ...
      public function UiLeaderboardSoloGuildCompetitionContent(param1:SymbolLeaderboardSoloGuildCompetitionContentGeneric, param2:Function, param3:Function, param4:Function, param5:Function, param6:SoloGuildCompetitionLeaderboardContext)
      {
         ...
         _line1 = new UiLeaderboardSoloGuildCompetitionLine(param1.line1,1,selectCharacterLine,doubleClickCharacterLine,_context);
         _line2 = new UiLeaderboardSoloGuildCompetitionLine(param1.line2,2,selectCharacterLine,doubleClickCharacterLine,_context);
         _line3 = new UiLeaderboardSoloGuildCompetitionLine(param1.line3,3,selectCharacterLine,doubleClickCharacterLine,_context);
         _line4 = new UiLeaderboardSoloGuildCompetitionLine(param1.line4,4,selectCharacterLine,doubleClickCharacterLine,_context);
         _line5 = new UiLeaderboardSoloGuildCompetitionLine(param1.line5,5,selectCharacterLine,doubleClickCharacterLine,_context);
         _line6 = new UiLeaderboardSoloGuildCompetitionLine(param1.line6,6,selectCharacterLine,doubleClickCharacterLine,_context);
         _line7 = new UiLeaderboardSoloGuildCompetitionLine(param1.line7,7,selectCharacterLine,doubleClickCharacterLine,_context);
         _line8 = new UiLeaderboardSoloGuildCompetitionLine(param1.line8,8,selectCharacterLine,doubleClickCharacterLine,_context);
         _line9 = new UiLeaderboardSoloGuildCompetitionLine(param1.line9,9,selectCharacterLine,doubleClickCharacterLine,_context);
      }
      ...
      public function set currentCharacter(param1:LeaderboardSoloGuildCompetition) : void
      {
         ...
         _onSelectCharacter(_context.currentCharacter);
      }
