package com.playata.application.ui.elements.leaderboard
{
   ...
   public class UiLeaderboardSoloGuildCompetitionLine extends InteractiveDisplayObject
   {
      ...
      public function UiLeaderboardSoloGuildCompetitionLine(param1:SymbolLeaderboardSoloGuildCompetitionLineGeneric, param2:int, param3:Function, param4:Function, param5:SoloGuildCompetitionLeaderboardContext)
      {
         _content = param1;
         super(_content);
         _index = param2;
         ...
         var _loc6_:SeasonProgress;
         if((_loc6_ = User.current.character.seasonProgress).isActive() && _loc6_.tsEnd > param5.endTimestamp)
         {
            _seasonPointReward = new UiSeasonPointReward(_content.seasonPointReward,_loc6_,0);
         }
         else
         {
