package com.playata.application.ui.elements.movie
{
   ...
   public class MovieCover
   {
      ...
      private function finishPreviewGeneration() : void
      {
         ...
         _preview.avatarContainer.scaleX = _preview.avatarContainer.scaleY = _loc18_.getNumber("scale");
         ...
         else
         {
            ...
            if(_preview.actorFront.visible)
            {
               ...
               _preview.actorFront.scaleX = _preview.actorFront.scaleY = _loc13_.getNumber("scale");
               _preview.actorFront.x = _loc13_.getNumber("x");
               _preview.actorFront.y = _loc13_.getNumber("y");
               if(_loc13_.getBoolean("mirror_x"))
               {
                  _preview.actorFront.scaleX *= -1;
                  _preview.actorFront.x += _preview.actorFront.width;
               }
            }
            ...
            if(_preview.actorBackground.visible)
            {
               ...
               _preview.actorBackground.scaleX = _preview.actorBackground.scaleY = _loc9_.getNumber("scale");
               _preview.actorBackground.x = _loc9_.getNumber("x");
               _preview.actorBackground.y = _loc9_.getNumber("y");
               if(_loc9_.getBoolean("mirror_x"))
               {
                  _preview.actorBackground.scaleX *= -1;
                  _preview.actorBackground.x += _preview.actorBackground.width;
               }
            }
         }
         ...
         var _loc21_:TextField;
         (_loc21_ = _preview.layout[_loc8_.getString("font")]).visible = true;
         _loc21_.text = "";
         var _loc22_:TextFormat;
         (_loc22_ = _loc21_.defaultTextFormat).size = _loc3_.getNumber("font_size");
         ...
         if(_settings.cover_filter_type && _settings.cover_filter_type != 1)
         {
            ...
            switch(int(_settings.cover_filter_type) - 2)
            {
               ...
               case 1:
                  drawLayers(_previewBitmapData,[_preview.background,_preview.actorBackground,_preview.avatarContainer,_preview.actorFront]);
                  _loc7_ = (_loc28_ = _previewBitmapData.clone()).clone();
               ...
               case 9:
                  ...
                  while(_loc25_ < _width)
                  {
                     ...
                     {
                        _loc12_ = uint(((_loc23_ = uint(_previewBitmapData.getPixel(_loc25_,_loc16_))) & 16711680) >> 16);
