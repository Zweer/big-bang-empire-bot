package com.playata.application.ui.elements.movie
{
   ...
   public class UiMovieCoverConfigurator
   {
      ...
      private function getNextAppearanceValue(param1:String, param2:int) : int
      {
         ...
         do
         {
            if((_loc4_ += param2) == _loc3_.length)
            {
               _loc4_ = 0;
            }
            else if(_loc4_ < 0)
      ...
      private function updatePriceTag(param1:String) : void
      {
         ...
         var _loc4_:int;
         if((_loc4_ = _initialSettings.getAppearance(param1) != _currentSettings.getAppearance(param1) ? _loc11_[_loc7_] : 0) > 0)
         {
         ...
         var _loc9_:int;
         if((_loc9_ = _initialSettings.getAppearance(param1) != _currentSettings.getAppearance(param1) ? _loc5_[_loc7_] : 0) > 0)
         {
            _loc2_.visible = true;
