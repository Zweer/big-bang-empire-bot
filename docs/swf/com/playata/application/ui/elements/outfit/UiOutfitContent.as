package com.playata.application.ui.elements.outfit
{
   ...
   public class UiOutfitContent
   {
      ...
      public function UiOutfitContent(param1:SymbolOutfitContentGeneric, param2:Function)
      {
         ...
         _content.btnRename.bringToTop();
         _content.btnSave.bringToTop();
         _content.btnSettings.bringToTop();
         _content.btnEquip.bringToTop();
         ...
         _content.iconExclamationMarkHead.nativeInstance.mouseEnabled = _content.iconExclamationMarkHead.nativeInstance.mouseChildren = false;
         _content.iconExclamationMarkChest.nativeInstance.mouseEnabled = _content.iconExclamationMarkChest.nativeInstance.mouseChildren = false;
         _content.iconExclamationMarkBelt.nativeInstance.mouseEnabled = _content.iconExclamationMarkBelt.nativeInstance.mouseChildren = false;
         _content.iconExclamationMarkLegs.nativeInstance.mouseEnabled = _content.iconExclamationMarkLegs.nativeInstance.mouseChildren = false;
         _content.iconExclamationMarkBoots.nativeInstance.mouseEnabled = _content.iconExclamationMarkBoots.nativeInstance.mouseChildren = false;
         _content.iconExclamationMarkNecklace.nativeInstance.mouseEnabled = _content.iconExclamationMarkNecklace.nativeInstance.mouseChildren = false;
         _content.iconExclamationMarkRing.nativeInstance.mouseEnabled = _content.iconExclamationMarkRing.nativeInstance.mouseChildren = false;
         _content.iconExclamationMarkPiercing.nativeInstance.mouseEnabled = _content.iconExclamationMarkPiercing.nativeInstance.mouseChildren = false;
         _content.iconExclamationMarkGadget.nativeInstance.mouseEnabled = _content.iconExclamationMarkGadget.nativeInstance.mouseChildren = false;
      }
      ...
      public function refresh(param1:Outfit) : void
      {
         ...
         else
         {
            ...
            addButtonMode();
            _btnUp.visible = _btnTop.visible = _loc11_.outfits.outfits.length > 1;
            _btnDown.visible = _btnBottom.visible = _loc11_.outfits.outfits.length > 1;
            _btnUp.buttonEnabled = _btnTop.buttonEnabled = _outfit.index > 1;
            _btnDown.buttonEnabled = _btnBottom.buttonEnabled = _outfit.index < _loc11_.outfits.outfits.length;
