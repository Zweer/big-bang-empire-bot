package com.playata.application.ui.elements.payment
{
   ...
   public class UiPaymentOffer extends UiButton
   {
      ...
      private function setNormalOfferData(param1:PremiumNormalBillingProductInfo) : void
      {
         ...
         _offerContent.backgroundSelected.gotoAndStop(1);
         _offerContent.backgroundUnselected.gotoAndStop(1);
         _offerContent.backgroundSpecialCustom.visible = _offerContent.backgroundSpecialGeneric.visible = false;
      ...
      {
         if(DialogPaymentBase.currentPaymentMethod == null)
         {
            return 0;
         }
         ...
         var _loc4_:Number = (_loc6_ = Core.config.getTypedObject("payment_currencies").getTypedObject(_loc3_)).getTypedObject("rates").getNumber(DialogPaymentBase.currentPaymentMethod.baseOption.toString());
         if(_loc9_ >= param1)
         {
            return 0;
         }
