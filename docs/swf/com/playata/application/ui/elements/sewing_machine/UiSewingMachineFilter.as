package com.playata.application.ui.elements.sewing_machine
{
   ...
   public class UiSewingMachineFilter
   {
      ...
      public static function isAllowed(param1:String) : Boolean
      {
         ...
         if(_loc4_)
         {
            if(!(_loc4_ = false) && Item.isStoryDungeonItem(param1))
            {
      ...
      {
         _itemQuality = param1;
         _content.iconShowCommon.visible = _content.txtShowCommon.visible = _ckbShowCommon.visible = _itemQuality >= 2;
         _content.iconShowRare.visible = _content.txtShowRare.visible = _ckbShowRare.visible = _itemQuality >= 2;
         _content.iconShowEpic.visible = _content.txtShowEpic.visible = _ckbShowEpic.visible = _itemQuality >= 3;
