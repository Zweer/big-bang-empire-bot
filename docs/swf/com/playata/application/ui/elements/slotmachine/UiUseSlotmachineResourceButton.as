package com.playata.application.ui.elements.slotmachine
{
   ...
   public class UiUseSlotmachineResourceButton extends UiUseResourceButton
   {
      ...
      override protected function onClickUseResource(param1:InteractionEvent) : void
      {
         ...
         if(_loc2_ && !_loc2_.multitaskingBoosterActive)
         {
            if(_loc2_.activeQuest)
            {
               Environment.panelManager.showDialog(new DialogBoosterMultitasking(onClickUseResource));
               return;
            }
         ...
         super.onClickUseResource(param1);
      }
