package com.playata.application.ui.elements.stats
{
   ...
   public class UiStatBar
   {
      ...
      public static function setStatFill(param1:int, param2:SymbolStatBarFillGeneric, param3:Number) : void
      {
         ...
         {
            (_loc7_ = param2.getChildByName(steps.getData(_loc4_))).visible = false;
         }
         ...
         if(param2 != null)
         {
            if(param2 == User.current.character)
            {
               ...
               if(param3 != null)
               {
                  ...
                  {
                     case 0:
                        return LocText.current.text("general/toughness_season_tooltip",LocText.current.formatHugeNumber(param2.statBaseStamina),LocText.current.formatHugeNumber(param2.itemStamina),LocText.current.formatHugeNumber(param2.boosterStamina),LocText.current.formatHugeNumber(param2.guildBoosterStamina),LocText.current.formatHugeNumber(param2.getStatValue(param1,true)),GameUtil.getHitPointsString(GameUtil.getHitPoints(param2.getStatValue(param1,true))),LocText.current.formatHugeNumber(param2.battleSkillStamina),LocText.current.formatHugeNumber(param2.seasonBaseStatBonus(param1,106) + param2.seasonBaseStatBonus(param1,109)));
                     case 1:
                        return LocText.current.text("general/brawn_season_tooltip",LocText.current.formatHugeNumber(param2.statBaseStrength),LocText.current.formatHugeNumber(param2.itemStrength),LocText.current.formatHugeNumber(param2.boosterStrength),LocText.current.formatHugeNumber(param2.guildBoosterStrength),LocText.current.formatHugeNumber(param2.getStatValue(param1,true)),LocText.current.formatHugeNumber(param2.statWeaponDamage),LocText.current.formatHugeNumber(param2.getMissilesDamage(true)),LocText.current.formatHugeNumber(GameUtil.getDamage(param2.statWeaponDamage,param2.getMissilesDamage(true),param2.getStatValue(param1,true))),LocText.current.formatHugeNumber(param2.battleSkillStrength),LocText.current.formatHugeNumber(param2.seasonBaseStatBonus(param1,105) + param2.seasonBaseStatBonus(param1,109)));
                     case 2:
                        return LocText.current.text("general/brain_season_tooltip",LocText.current.formatHugeNumber(param2.statBaseCriticalRating),LocText.current.formatHugeNumber(param2.itemCriticalRating),LocText.current.formatHugeNumber(param2.boosterCriticalRating),LocText.current.formatHugeNumber(param2.guildBoosterCriticalRating),LocText.current.formatHugeNumber(param2.getStatValue(param1,true)),NumberUtil.roundDecimal(GameUtil.getCriticalHitPercentage(param2.getStatValue(param1,true),_loc4_) * 100,2).toString().replace(".",LocText.current.text("base/numbers/comma_separator")),LocText.current.formatHugeNumber(_loc4_),LocText.current.formatHugeNumber(param2.battleSkillCriticalRating),LocText.current.formatHugeNumber(param2.seasonBaseStatBonus(param1,107) + param2.seasonBaseStatBonus(param1,109)));
                     case 3:
                        return LocText.current.text("general/awareness_season_tooltip",LocText.current.formatHugeNumber(param2.statBaseDodgeRating),LocText.current.formatHugeNumber(param2.itemDodgeRating),LocText.current.formatHugeNumber(param2.boosterDodgeRating),LocText.current.formatHugeNumber(param2.guildBoosterDodgeRating),LocText.current.formatHugeNumber(param2.getStatValue(param1,true)),NumberUtil.roundDecimal(GameUtil.getDodgePercentage(param2.getStatValue(param1,true),_loc5_) * 100,2).toString().replace(".",LocText.current.text("base/numbers/comma_separator")),LocText.current.formatHugeNumber(_loc5_),LocText.current.formatHugeNumber(param2.battleSkillDodgeRating),LocText.current.formatHugeNumber(param2.seasonBaseStatBonus(param1,108) + param2.seasonBaseStatBonus(param1,109)));
                  }
               }
               else
               {
            ...
            else
            {
               switch(int(param1) - 1)
               {
                  ...
                  case 1:
                     return LocText.current.text("general/brawn_duel_enemy_tooltip",param2.name,LocText.current.formatHugeNumber(GameUtil.getDamage(param2.statWeaponDamage,param2.getMissilesDamage(),param2.statTotalStrength)));
                  case 2:
      ...
      public function refreshCompareValue(param1:int, param2:int, param3:Boolean = false) : void
      {
         ...
         else
         {
            ...
            if(param3)
            {
               ...
               _content.txtFreeStats.visible = false;
               this.value = param1;
               _loc7_ = (_loc7_ = LocText.current.formatHugeNumber(param1)) + (" " + LocText.current.formatHugeNumber(_loc6_,true));
      ...
      public function highlight(param1:int, param2:int, param3:Boolean) : void
      {
         ...
         var _loc5_:int;
         var _loc4_:* = (_loc5_ = _currentValue - param2 + param1) < _currentValue;
         var _loc9_:* = null;
         var _loc7_:* = null;
         var _loc13_:int = 0;
         var _loc8_:int = 0;
         ...
         {
            (_loc12_ = _content.fillBase.getChildByName(steps.getData(_loc10_))).visible = false;
         }
         ...
         {
            (_loc12_ = _content.fillBase.getChildByName(steps.getData(stepKeys[stepKeys.length - 1]))).visible = true;
            return;
         }
