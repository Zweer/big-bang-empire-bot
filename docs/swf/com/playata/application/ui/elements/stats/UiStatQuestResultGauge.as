package com.playata.application.ui.elements.stats
{
   ...
   public class UiStatQuestResultGauge
   {
      ...
      private function updateGreenMask() : void
      {
         ...
         var _loc3_:Number = (354 - (354 - 7) * _greenScale.green) / 180 * 3.141592653589793;
         var _loc5_:Graphics;
         (_loc5_ = (FlashDisplayObject.getNativeDisplayObject(_content.m) as MovieClip).graphics).clear();
         _loc5_.beginFill(65280);
         var _loc1_:* = 6.283185307179586;
         while(_loc1_ > _loc3_)
         {
      ...
      private function checkSparkEffect() : void
      {
         ...
         var _loc5_:Number;
         if((_loc5_ = Math.abs(_lastNeedleRotation - _loc1_)) < 5 && _needleAnimation.max < 0.5)
         {
            return;
         }
         _lastNeedleRotation = _loc1_;
         var _loc3_:Number = _content.needle.rotation / 180 * 3.141592653589793;
