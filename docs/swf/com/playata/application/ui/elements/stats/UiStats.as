package com.playata.application.ui.elements.stats
{
   ...
   public class UiStats extends InteractiveDisplayObject
   {
      ...
      public function refresh(param1:Character, param2:Character = null) : void
      {
         ...
         _statBarStamina.value = param1.getStatValue(1,param2 != null);
         _statBarStrength.value = param1.getStatValue(2,param2 != null);
         _statBarCriticalRating.value = param1.getStatValue(3,param2 != null);
         _statBarDodgeRating.value = param1.getStatValue(4,param2 != null);
         ...
         if(param2)
         {
            _statBarStamina.refreshCompareValue(param1.getStatValue(1,true),param2.statTotalStamina);
            _statBarStrength.refreshCompareValue(param1.getStatValue(2,true),param2.statTotalStrength);
            _statBarCriticalRating.refreshCompareValue(param1.getStatValue(3,true),param2.statTotalCriticalRating);
            _statBarDodgeRating.refreshCompareValue(param1.getStatValue(4,true),param2.statTotalDodgeRating);
         }
      ...
      private function refreshFastSkillButton() : void
      {
         ...
         if(_character && _enableIncrease && !Environment.info.isTouchScreen)
         {
            ...
            else if(_character.hasData("stat_bought_stamina"))
            {
               ...
               {
                  _loc3_ += GameUtil.calcNeededGameCurrency(_loc2_);
                  _loc2_++;
               }
               if(_loc3_ > _loc1_)
               {
