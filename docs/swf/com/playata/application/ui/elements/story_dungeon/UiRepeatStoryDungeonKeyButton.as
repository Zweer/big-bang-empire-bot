package com.playata.application.ui.elements.story_dungeon
{
   ...
   public class UiRepeatStoryDungeonKeyButton implements ICitymapQuestButton
   {
      ...
      private var _tooltip:UiRepeatStoryDungeonKeyRewardTooltip;
      
      private var _container:SymbolMovieItemGeneric;
      
      public function UiRepeatStoryDungeonKeyButton(param1:SymbolMovieItemGeneric, param2:Quest, param3:Function, param4:Function, param5:Function)
      {
         super();
         _container = param1;
      ...
      {
         _container.itemPos.setUriSprite(StoryDungeon.getRepeatKeyImageUrl(param1),60,60,true,15,null,true);
         if(_tooltip == null)
         {
            _tooltip = new UiRepeatStoryDungeonKeyRewardTooltip(new InteractiveDisplayObject(_container));
         }
