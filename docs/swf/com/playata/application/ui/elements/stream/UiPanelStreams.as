package com.playata.application.ui.elements.stream
{
   ...
   public class UiPanelStreams
   {
      ...
      private var _newsContainer:UiNewsContainer = null;
      ...
      public function UiPanelStreams(param1:SymbolPanelStreamsGeneric)
      {
         ...
         _newsContainer = new UiNewsContainer(_content.messageContainer.serverSystemMessageContainer);
         ...
         _anchorContainer.add(_newsContainer,AnchorPoint.TOP_BOTTOM);
      ...
      public function refreshLocalization() : void
      {
         ...
         _newsContainer.refreshLocalization();
      ...
      public function get isNewsOpen() : Boolean
      {
         if(!_tabSystem.selected)
         {
            return false;
         }
         return _newsContainer.content.visible;
      }
      ...
      public function openNews() : void
      {
         ...
         _newsContainer.sync();
         _newsContainer.content.visible = true;
      ...
      public function openPrivateSystemMessage(param1:PrivateSystemMessage) : void
      {
         ...
         _newsContainer.content.visible = false;
      ...
      {
         var privateConversation:PrivateConversation = param1;
      ...
      private function onTabSelected(param1:String) : void
      {
         ...
         _newsContainer.content.visible = _tabSystem.selected && _activeSystemMessageContainer == 1;
