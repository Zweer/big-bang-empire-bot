   ...
   public class UiPrivateConversationMessage extends ListLine
   {
      ...
      private function refreshContent() : void
      {
         ...
         else if(_privateConversationMessage.isSystem)
         {
            ...
            _rawContentSystem.txtCreation.x += _loc3_ - 10 * 2;
            ...
            _rawContentSystem.txtMessage.x += _loc5_;
            _rawContentSystem.bubble.x += _loc5_;
         ...
         else if(_privateConversationMessage.isMyMessage)
         {
            ...
            _rawContentOwn.txtCreation.x += _loc3_ - 10 * 2;
            ...
            _rawContentOwn.txtMessage.x += _loc5_;
            _rawContentOwn.bubble.x += _loc5_;
      ...
      private function toggleCopyButton() : void
      {
         ...
         if(Environment.info.isTouchScreen && !_privateConversationMessage.isDeleted && !_privateConversationMessage.isSystem)
         {
            ...
            {
               _loc1_ = 41;
               _loc1_ *= !!_rawContentOwn.btnCopy.visible ? 1 : -1;
               _rawContentOwn.btnCopy.visible = !_rawContentOwn.btnCopy.visible;
               _rawContentOwn.btnDelete.x += _loc1_;
               _rawContentOwn.bubble.x += _loc1_;
               _rawContentOwn.txtCreation.x += _loc1_;
               _rawContentOwn.txtMessage.x += _loc1_;
            }
            else if(!_privateConversationMessage.isMyMessage)
            {
               _loc1_ = 41;
               _loc1_ *= !!_rawContentOther.btnCopy.visible ? -1 : 1;
               _rawContentOther.btnCopy.visible = !_rawContentOther.btnCopy.visible;
               _rawContentOther.bubble.x += _loc1_;
               _rawContentOther.txtCreation.x += _loc1_;
               _rawContentOther.txtMessage.x += _loc1_;
               _rawContentOther.txtSenderName.x += _loc1_;
            }
         }
      }
