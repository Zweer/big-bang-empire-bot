   ...
   public class UiPrivateConversationMessageContainer extends ScrollList
   {
      ...
      private function updateFooterHeight() : void
      {
         ...
         if(_content.footer.inputMessage.height != _loc1_)
         {
            ...
            _content.footer.inputMessage.y += _loc3_;
            _content.footer.textFieldBackground.height -= _loc3_;
            _content.footer.textFieldBackground.y += _loc3_;
            _content.background.height += _loc3_;
            _scrollContainer.height += _loc3_;
            _content.scrollBarLine.height += _loc3_;
            refresh();
         }
      }
      ...
      {
         Environment.panelManager.showDialog(new DialogPrivateConversationInvitation(_privateConversation));
      }
