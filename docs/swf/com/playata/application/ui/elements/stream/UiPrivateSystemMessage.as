package com.playata.application.ui.elements.stream
{
   ...
   public class UiPrivateSystemMessage
   {
      ...
      public function refresh() : void
      {
         ...
         {
            (_btnLink.content as Object).caption.x += _currentPartnerAdCaptionAdjustment;
         ...
         switch(param1.action)
         {
            ...
            case "claimPrivateSystemMessageItems":
               ...
               else if(param1.error == "errInventoryNoEmptySlot")
               {
                  ...
                  if(_item1.item)
                  {
                     _loc5_ += _item1.item.sellPrice;
                  }
                  if(_item2.item)
                  {
                     _loc5_ += _item2.item.sellPrice;
                  }
                  if(_item3.item)
                  {
                     _loc5_ += _item3.item.sellPrice;
                  }
                  if(_item4.item)
                  {
                     _loc5_ += _item4.item.sellPrice;
                  }
                  if(_item5.item)
                  {
                     _loc5_ += _item5.item.sellPrice;
                  }
