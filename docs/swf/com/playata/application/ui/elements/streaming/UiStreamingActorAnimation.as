package com.playata.application.ui.elements.streaming
{
   ...
   public class UiStreamingActorAnimation
   {
      ...
      public function refresh(param1:int, param2:int) : void
      {
         ...
         _actorId = param1;
         _animationId = param2;
         var _loc4_:Streaming;
         var _loc5_:Boolean = (_loc4_ = User.current.character.streaming).getUnlockedActors().exists(_actorId) && (_loc4_.getUnlockedActors().getData(_actorId) as StreamingActor).unlockedAnimations.exists(param2);
