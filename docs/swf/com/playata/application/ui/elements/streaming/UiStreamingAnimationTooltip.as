package com.playata.application.ui.elements.streaming
{
   ...
   public class UiStreamingAnimationTooltip extends UiClosableTooltip
   {
      ...
      override public function onAssigned() : void
      {
         ...
         _tooltipContent.backgroundUnlock.visible = _tooltipContent.txtUnlock.visible = !User.current.character.streaming.getUnlockedActors().exists(_actorId) || !(User.current.character.streaming.getUnlockedActors().getData(_actorId) as StreamingActor).unlockedAnimations.exists(_animationId);
         if(_tooltipContent.txtUnlock.visible)
         {
            switch(int(_loc1_.unlockType) - 1)
            {
               ...
               case 3:
                  ...
                  break;
               default:
                  _tooltipContent.txtUnlock.text = "";
            }
         }
