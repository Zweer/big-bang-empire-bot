package com.playata.application.ui.elements.tutorial
{
   ...
   public class UiTutorialArrow
   {
      ...
      {
         var instantHide:Boolean = param1;
      ...
      private function setLady(param1:String, param2:Number, param3:Boolean) : void
      {
         ...
         {
            param2 += LayoutUtil.deviceAdjustedWidthCorrection;
         }
         var _loc4_:* = _loc5_;
         if(param3)
         {
      ...
      {
         _lady.message.visible = _arrow.message.visible = false;
      ...
      {
         var _loc6_:SymbolTutorialMessageBoxGeneric;
         (_loc6_ = _arrow.message).caption.text = param1;
