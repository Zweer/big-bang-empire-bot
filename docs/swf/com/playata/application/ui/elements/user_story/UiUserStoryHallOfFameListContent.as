package com.playata.application.ui.elements.user_story
{
   ...
   public class UiUserStoryHallOfFameListContent
   {
      
      public static var MAX_LINES:int = 10;
       
      
      private var _content:SymbolUserStoryHallOfFameListContentGeneric = null;
      ...
      private var _selectedLine:UiUserStoryHallOfFameListLine = null;
      
      private var _userStoryLines:Vector.<UiUserStoryHallOfFameListLine> = null;
      
      public function UiUserStoryHallOfFameListContent(param1:SymbolUserStoryHallOfFameListContentGeneric, param2:Function, param3:Function, param4:Function, param5:UserStoryListContext)
      {
         var _loc6_:int = 0;
         super();
         _content = param1;
         ...
         _onClick = param4;
         _context = param5;
         param1.txtCaptionAuthor.text = LocText.current.text("dialog/user_story/column_author");
         ...
         _userStoryLines = new Vector.<UiUserStoryHallOfFameListLine>();
         _loc6_ = 1;
         while(_loc6_ <= MAX_LINES)
         {
            _userStoryLines.push(new UiUserStoryHallOfFameListLine(param1.getChildByName("line" + _loc6_) as SymbolUserStoryHallOfFameListLineGeneric,_loc6_,selectLine,doubleClickLine));
      ...
      private function selectLine(param1:UiUserStoryHallOfFameListLine) : void
      {
         var _loc2_:int = 0;
      ...
      private function doubleClickLine(param1:UiUserStoryHallOfFameListLine) : void
      {
         selectLine(param1);
         _onClick(null);
      }
