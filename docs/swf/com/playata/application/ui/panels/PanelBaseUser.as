package com.playata.application.ui.panels
{
   ...
   import com.playata.application.ui.dialogs.DialogGlobalTournamentResult;
   ...
   import com.playata.application.ui.dialogs.DialogTournamentResult;
   ...
   import com.playata.application.ui.elements.stream.UiPanelStreams;
   ...
   public class PanelBaseUser extends DefaultPanel
   {
      ...
      private var _streamsPanel:UiPanelStreams = null;
      ...
      private var _progressUpdater:ProgressUpdater = null;
      
      private var _seasonQuestButtonHintShown:Boolean = false;
      ...
      public function PanelBaseUser(param1:SymbolPanelBaseUserGeneric)
      {
         ...
         var _loc2_:SymbolPanelStreamsGeneric = new SymbolPanelStreamsGeneric();
         param1.parent.addChild(_loc2_);
         _streamsPanel = new UiPanelStreams(_loc2_);
      ...
      private function refreshMovieButtonTooltip() : void
      {
         ...
         {
            _loc1_ += "\n\n";
            _loc1_ += LocText.current.text("general/base_panel/movie_locked",CConstant.movie_min_level);
         }
         _btnMovie.tooltip = _loc1_;
      }
      
      private function refreshStreamingButtonTooltip() : void
      {
         var _loc1_:String = LocText.current.text("general/base_panel/streaming_tooltip");
         if(!_btnWork.buttonEnabled)
         {
            _loc1_ += "\n\n";
            _loc1_ += LocText.current.text("general/base_panel/streaming_locked");
         }
         _btnWork.tooltip = _loc1_;
      }
      ...
      override public function refresh() : void
      {
         ...
         else if(_loc1_.streaming)
         {
            _realContent.mainNavigationBar.btnWorkContent.info.visible = _loc1_.streaming.hasRoomWithoutShow();
            _btnWork.highlighted = _loc1_.streaming.getNextFinishedStreamingShow() != null && _loc1_.streaming.getNextFinishedStreamingShow().remainingSeconds <= 0;
         }
         else
         {
            _btnWork.highlighted = false;
         ...
         if(_btnMovie.visible && _btnMovie.buttonEnabled && _loc1_.movie)
         {
            ...
            else if(User.current.highlightMovieButton && _loc1_.hasEnoughEnergyForAllMovieQuests)
            {
               _btnMovie.highlighted = true;
            }
            else
      ...
      public function refreshStreamUnreadCounters() : void
      {
         ...
         if(_streamsPanel)
         {
            _streamsPanel.refreshUnreadCount();
         }
      }
      ...
      public function refreshNewMessagesBubble() : void
      {
         ...
         var _loc1_:Character = User.current.character;
         var _loc2_:int = _loc1_.streams.unreadCount;
         if(_loc2_ > 0)
         {
      ...
      {
         _gameCurrencyPanel.offset += param1;
         _gameCurrencyPanel.refresh();
      }
      ...
      private function onRequestProductsComplete(param1:Vector.<IBillingProduct>) : void
      {
         ...
         {
            if(_loc4_ = _loc2_.info as AppPremiumSpecialBillingProductInfo)
            {
      ...
      private function refreshLeaderboardInfoBubble() : void
      {
         ...
         {
            _loc2_ += _loc1_.pendingMovieTournamentRewards;
         }
         _loc2_ += _loc1_.pendingTournamentRewards;
         _loc2_ += _loc1_.pendingSoloGuildCompetitionTournamentRewards;
         _loc2_ += _loc1_.pendingGlobalTournamentRewards;
         if(_loc2_ > 0)
         {
      ...
      public function onSynGame() : void
      {
         ...
         if(!_loc2_ && NetworkCore.current.serverConnection.isSocketTransportActive && SyncStates.isSyncGameDataSynced)
         {
            return;
         }
         syncGame();
      ...
      public function syncGame() : void
      {
         ...
         new ApplicationRequest("syncGame",SyncStates.syncGameData.rawData,handleRequestSyncGame,null,null,2,false);
      }
      ...
      {
         var _loc5_:Vector.<IDisplayObject>;
         (_loc5_ = new Vector.<IDisplayObject>()).push(_realContent.playerPanel);
      ...
      private function refreshSeasonQuestButtonHint() : void
      {
         if(_seasonQuestButtonHintShown)
         {
            return;
         }
         var _loc1_:SymbolPanelBaseUserGeneric = _vo as SymbolPanelBaseUserGeneric;
         _realContent.mainNavigationBar.btnQuestsContent.questButtonSeasonHint.removeAllChildren();
         if(User.current.character.seasonProgress && User.current.character.seasonProgress.exists())
         {
            _realContent.mainNavigationBar.btnQuestsContent.questButtonSeasonHint.setUriSprite(User.current.character.seasonProgress.hintIconURL,50,50,true,1,null,true);
            _seasonQuestButtonHintShown = true;
         }
      }
      ...
      public function refreshMainNavigationButtons() : void
      {
         ...
         if(AppConfig.streamingEnabled)
         {
            _btnWork.buttonEnabled = _loc1_.fansTotal > 0;
            refreshStreamingButtonTooltip();
         }
      }
      ...
      public function refreshSelection() : void
      {
         ...
         _btnWork.selected = ViewManager.instance.activePanel == "work_new" || ViewManager.instance.activePanel == "streaming";
      ...
      private function onClickQuests(param1:InteractionEvent) : void
      {
         ...
         var _loc2_:Character = User.current.character;
         var _loc3_:int = _loc2_.currentLocation;
         if((_loc2_.activeQuest || _loc2_.activeConventionShow) && _loc2_.activeDungeonQuest)
         {
            if(_loc3_ == 2)
            {
         ...
         else if(_loc2_.activeDungeonQuest)
         {
            ViewManager.instance.showPanel("dungeon");
         }
         ...
         _realContent.mainNavigationBar.btnQuestsContent.questButtonSeasonHint.visible = false;
      }
      ...
      private function onClickWork(param1:InteractionEvent) : void
      {
         ...
         if(AppConfig.streamingEnabled)
         {
            ViewManager.instance.showPanel("streaming");
         }
         else
         {
      ...
      private function onClickLeaderboard(param1:InteractionEvent) : void
      {
         ...
         if(User.current.character.pendingGlobalTournamentRewards > 0)
         {
      ...
      public function get streamsPanel() : UiPanelStreams
      {
         return _streamsPanel;
      }
      
      public function openStreamsPanel(param1:Boolean = false) : void
      {
         _streamsPanel.open(param1);
      }
      ...
      private function handleRequestSyncGame(param1:String, param2:RequestData, param3:Object, param4:String) : void
      {
         ...
         if(param4 == "")
         {
            ...
            _gameSyncing = true;
            _loc5_ = User.current.character.streams.unreadCount;
            ...
            refreshBoosterInfoBubble();
            refreshLeaderboardInfoBubble();
            if(_loc5_ != User.current.character.streams.unreadCount)
            {
               Environment.audio.playFX("notification.mp3");
            }
         ...
         switch(param1.action)
         {
            case "getTournamentRewards":
               if(param1.error == "")
               {
                  ...
                  else if(AppConfig.movieTournamentsEnabled == true && User.current.character.pendingMovieTournamentRewards)
                  {
                     Environment.application.sendActionRequest("getMovieTournamentRewards",{},handleRequests);
                  }
                  ...
                  else if(User.current.character.pendingGlobalTournamentRewards > 0)
                  {
                     Environment.application.sendActionRequest("getGlobalTournamentRewards",{},handleRequests);
                  }
                  else
