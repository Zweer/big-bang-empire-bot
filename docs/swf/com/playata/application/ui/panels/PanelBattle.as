package com.playata.application.ui.panels
{
   ...
   public class PanelBattle extends DefaultPanel
   {
      ...
      public function PanelBattle(param1:SymbolPanelBattleGeneric)
      {
         ...
         {
            param1.skillsA.visible = param1.skillsB.visible = false;
         }
         param1.spotLightA.emblemGuildA.nativeInstance.blendMode = param1.spotLightB.emblemGuildB.nativeInstance.blendMode = "overlay";
         ...
         _background = new OpticalChangeBackground(param1.background,23,2);
      }
      ...
      override public function show(param1:* = null) : void
      {
         ...
         {
            if((_loc5_ = GuildArenaSettings.fromGuild(guildBattle.attacker)).arenaBackgroundId > 1)
            {
         ...
         if(isGuildBattle)
         {
            (_loc9_ = guildBattle.ownGuild.emblemSettings).emblemBackgroundBorderColorIndex = 4;
         ...
         else if(isActiveMovieQuest)
         {
            ...
            _skillsA.refresh(_battle.profileABattleEffects,null,true);
            _skillsB.refresh(_battle.profileBBattleEffects,null,false,activeMovieQuest.npcName);
         ...
         else if(isMissedDuel)
         {
            ...
            _skillsA.refresh(_battle.profileBBattleEffects,_loc8_.seasonEffect,true);
            _skillsB.refresh(_battle.profileABattleEffects,_loc4_.seasonEffect,false,_loc4_.name);
         ...
         {
            _loc3_ = activeDuel.selfCharacterActiveDuel;
            _loc10_ = activeDuel.opponentActiveDuel;
            ...
            _skillsA.refresh(_battle.profileABattleEffects,_loc3_.seasonEffect,true);
            _skillsB.refresh(_battle.profileBBattleEffects,_loc10_.seasonEffect,false,_loc10_.nameWithTitle);
            _avatarA.fillCharacter(_loc3_.appearanceSettings,true,true);
            _avatarB.fillCharacter(_loc10_.appearanceSettings,false,false);
         ...
         else if(isActiveDungeonQuest)
         {
            ...
            _skillsA.refresh(_battle.profileABattleEffects,null,true);
            _skillsB.refresh(_battle.profileBBattleEffects,null,false,activeDungeonQuest.npcName);
            _avatarA.fillCharacter(User.current.character.getCurrentSettings(1),true,true);
         ...
         else if(isActiveStoryDungeonBattle)
         {
            ...
            _skillsA.refresh(_battle.profileABattleEffects,null,true);
            _skillsB.refresh(_battle.profileBBattleEffects,null,false,StoryDungeon.getBossName(_loc11_.storyDungeonIndex));
            _avatarA.fillCharacter(User.current.character.getCurrentSettings(1),true,true);
         ...
         else if(isActiveQuest)
         {
            ...
            _skillsA.refresh(_battle.profileABattleEffects,null,true);
            _skillsB.refresh(_battle.profileBBattleEffects,null,false,User.current.character.activeQuest.npcName);
            _loc6_.txtPlayerLevelA.text = LocText.current.text("general/level_general_tooltip",User.current.character.level);
      ...
      public function startGuildBattleVisualization() : void
      {
         ...
         var _loc4_:Vector.<IDisplayObject>;
         (_loc4_ = new Vector.<IDisplayObject>()).push(_loc3_.battleAvatarA);
      ...
      private function startBattleVisualization() : void
      {
         ...
         if(!isGuildBattle)
         {
            ...
            {
               visualizeRound(_battle.battleRounds[_currentRoundIndex++]);
            }
         }
         else if(isGuildBattle)
         {
            ...
            {
               visualizeGuildBattleRound(guildBattle.battleRounds[_currentRoundIndex++]);
            }
         }
      }
         ...
         if(param1 != null)
         {
            for each(_loc7_ in param1)
            {
               if(BattleEffect.isRoundStartEffect(_loc7_))
               {
                  ...
                  param5.showSkillUsage(BattleEffect.battleSkillToBattleSkillIdentifier(_loc7_),BattleEffect.isSingleEvent(_loc7_),!BattleEffect.multiUsePossible(_loc7_));
               }
            }
         }
         if(param2 != null)
         {
            for each(_loc7_ in param2)
            {
               if(BattleEffect.isRoundStartEffect(_loc7_))
               {
                  ...
                  param6.showSkillUsage(BattleEffect.battleSkillToBattleSkillIdentifier(_loc7_),BattleEffect.isSingleEvent(_loc7_),!BattleEffect.multiUsePossible(_loc7_));
               }
            }
         }
      }
      ...
      private function onDamageDone() : void
      {
         ...
         try
         {
            ...
            else if(isGuildBattle)
            {
               ...
               _loc6_ = !!(_loc7_ = guildBattle.getCharacter(_loc1_.attacker)).isOwnGuildMember ? _barB : _barA;
               _loc2_ = (_loc8_ = !!_loc7_.isOwnGuildMember ? _avatarA : _avatarB) == _avatarA ? _avatarB : _avatarA;
               _loc5_ = _loc8_ == _avatarA ? _skillsA : _skillsB;
               _loc4_ = _loc8_ == _avatarA ? _skillsB : _skillsA;
      ...
      private function onDotDamageDone() : void
      {
         ...
         try
         {
            ...
            if(!isGuildBattle)
            {
               ...
               _loc6_ = !!_loc2_.attackerA ? _barB : _barA;
               if(isMissedDuel)
               {
                  _loc6_ = !!_loc2_.attackerA ? _barA : _barB;
               }
               _loc6_.decrease(_loc2_.dotDamage);
               _loc5_ = _loc6_ == _barA ? _skillsB : _skillsA;
               _loc4_ = _currentRoundIndex;
               while(_loc4_ < _battle.battleRounds.length)
               {
                  if(_battle.battleRounds[_loc4_].attacker == _loc2_.attacker)
                  {
                     if(_battle.battleRounds[_loc4_].dotDamage == 0)
                     {
                        _loc7_ = BattleEffect.battleEffectToBattleSkills(13);
                        for each(_loc3_ in _loc7_)
                        {
                           _loc5_.deactivateSkillUsage(BattleEffect.battleSkillToBattleSkillIdentifier(_loc3_),!BattleEffect.multiUsePossible(_loc3_));
                        }
                     }
                     break;
                  }
            ...
            {
               _loc1_ = guildBattle.battleRounds[_currentRoundIndex - 1];
               (_loc6_ = !!(_loc8_ = guildBattle.getCharacter(_loc1_.attacker)).isOwnGuildMember ? _barB : _barA).decrease(_loc1_.dotDamage);
               _loc5_ = _loc6_ == _barA ? _skillsB : _skillsA;
               _loc4_ = _currentRoundIndex;
               while(_loc4_ < guildBattle.battleRounds.length)
               {
                  if(guildBattle.battleRounds[_loc4_].attacker == _loc1_.attacker)
                  {
                     if(guildBattle.battleRounds[_loc4_].dotDamage == 0)
                     {
                        _loc7_ = BattleEffect.battleEffectToBattleSkills(13);
                        for each(_loc3_ in _loc7_)
                        {
      ...
      private function onBackfireDamageDone() : void
      {
         ...
         {
            _loc1_ = guildBattle.battleRounds[_currentRoundIndex - 1];
            _loc3_ = !!(_loc4_ = guildBattle.getCharacter(_loc1_.attacker)).isOwnGuildMember ? _barA : _barB;
      ...
      private function onHitAnimationComplete(param1:Boolean = true, param2:Boolean = true) : void
      {
         ...
         try
         {
            if(!isGuildBattle)
            {
               _loc9_ = !!(_loc5_ = _battle.battleRounds[_currentRoundIndex - 1]).attackerA ? _avatarA : _avatarB;
               if(isMissedDuel)
               {
            ...
            else if(isGuildBattle)
            {
               ...
               _loc4_ = (_loc9_ = !!_loc3_.isOwnGuildMember ? _avatarB : _avatarA) == _avatarA ? _avatarB : _avatarA;
      ...
      private function updateGuildBattleCharacters(param1:GuildBattleRound) : void
      {
         ...
         if(_currentGuildBattleOwnGuildCharacter != _loc2_)
         {
            ...
            _skillsA.refresh(_loc2_.battleEffects,_loc2_.seasonEffect,_loc2_.isMe,_loc2_.name);
         ...
         if(_currentGuildBattleOtherGuildCharacter != _loc6_)
         {
            ...
            _skillsB.refresh(_loc6_.battleEffects,_loc6_.seasonEffect,false,_loc6_.name);
            updateSkillsBPosition();
