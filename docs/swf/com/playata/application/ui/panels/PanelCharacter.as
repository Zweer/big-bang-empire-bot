package com.playata.application.ui.panels
{
   ...
   public class PanelCharacter extends DefaultPanel
   {
      ...
      public function PanelCharacter(param1:SymbolPanelCharacterGeneric)
      {
         ...
         param1.infoBox.enemyInformation.txtLevel.autoFontSize = true;
      ...
      override public function refresh() : void
      {
         ...
         if(_customCharacter != null)
         {
            ...
            _loc4_.infoBox.enemyInformation.txtLevel.text = LocText.current.formatHugeNumber(_loc1_.level);
         ...
         if(_loc4_.infoBox.txtDescription.textHeight >= _loc4_.infoBox.txtDescription.height)
         {
            ...
            while(_loc5_ < 5)
            {
               _loc7_ += _loc4_.infoBox.txtDescription.getLineText(_loc5_);
               _loc5_++;
            }
            _loc7_ += "... [" + LocText.current.text("screen/character/description/text_more") + "]";
         ...
         var _loc9_:Item;
         if((_loc9_ = _loc1_.getItem("chest_item_id")) && _loc9_.isOutfitItem && _loc1_.isChestItemShown)
         {
         ...
         var _loc6_:String = PanelDuels.getDuelResultTooltip(_loc1_.level,_loc1_.honor,_loc1_.getTotalStats(true));
      ...
      private function handleRequests(param1:ActionRequestResponse) : void
      {
         ...
         switch(param1.action)
         {
            case "startDuel":
               ...
               {
                  _loc2_ = CConstant.duel_attack_limit;
                  _loc3_ = BonusInfo.getValue(2);
                  if(_loc3_ > 0)
                  {
                     _loc2_ *= _loc3_;
                  }
                  panelManager.showDialog(new UiInfoDialog(LocText.current.text("dialog/duel_attack_not_allowed/title"),LocText.current.text("dialog/duel_attack_not_allowed/text",LocText.current.text("general/attack",_loc2_)),LocText.current.text("general/button_ok")));
               }
