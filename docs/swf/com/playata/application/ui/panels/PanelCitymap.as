package com.playata.application.ui.panels
{
   ...
   public class PanelCitymap extends DefaultPanel
   {
      ...
      public function PanelCitymap(param1:SymbolPanelCitymapGeneric)
      {
         ...
         {
            if((_loc18_ = _loc4_.getChildAt(_loc5_)).name.indexOf("dungeon_") == 0 || _loc18_.name.indexOf("customStage") == 0)
            {
         ...
         {
            if((_loc18_ = _loc4_.clouds.getChildAt(_loc5_)).name.indexOf("dungeon_") == 0 || _loc18_.name.indexOf("customStage") == 0)
            {
               _loc18_.visible = false;
            }
            _loc5_++;
         ...
         for each(_loc5_ in _loc13_)
         {
            ...
            _loc4_["customStageLocation" + _loc5_].visible = _loc4_.clouds["customStageLocation" + _loc5_].visible = true;
            ...
            _loc12_ = new UiCitymapStoryDungeonIcon(_loc4_["customStageStoryDungeonStage" + _loc5_],_loc5_,true);
            _storyDungeonIcons.push(_loc12_);
            _loc4_["customStageDatingStage" + _loc5_].visible = true;
            _loc15_ = new UiCitymapDatingIcon(_loc4_["customStageDatingStage" + _loc5_],_loc5_,true);
            _datingIcons.push(_loc15_);
            _loc4_["customStageQuest" + _loc5_].visible = true;
            _loc11_ = new UiCitymapQuestIcon(_loc4_["customStageQuest" + _loc5_],_loc5_,true);
            _questIcons.push(_loc11_);
         ...
         if(AppConfig.dungeonsEnabled)
         {
            for each(var _loc3_ in CDungeonTemplate.ids)
            {
               ...
               _loc16_.visible = _loc7_.visible = true;
               if(_loc7_)
               {
      ...
      {
         PanelQuests.openQuestId = param1.id;
         onAreaClicked(param1.stage);
      }
      ...
      override public function refresh() : void
      {
         ...
         {
            if((_loc13_ = _loc12_.mostXPQuest).reward.movieVotes > 0)
            {
            ...
            if(_loc15_ = _loc12_.dungeonKeyQuest)
            {
            ...
            if(_loc8_ = _loc12_.repeatStoryDungeonKeyQuest)
            {
            ...
            if(_loc10_ = _loc12_.repeatDatingKeyQuest)
            {
         ...
         switch(int(lastAction) - 1)
         {
            ...
            case 1:
               ...
               break;
            default:
               if(_loc12_.currentDungeon && (_loc12_.currentDungeon.isFinished || !_loc12_.currentDungeon.currentLevel.isFinished || _loc12_.currentDungeon.currentLevel.isFinished && _loc12_.currentDungeon.nextLevel && _loc12_.currentDungeon.nextLevel.isUnlocked))
               {
                  _loc16_ = getAvatarImagePositionForDungeon(_loc12_.currentDungeon.identifier);
                  break;
               }
         ...
         var _loc3_:Vector.<GoalValue> = _loc12_.openGoalValues();
         _loc4_ = 0;
