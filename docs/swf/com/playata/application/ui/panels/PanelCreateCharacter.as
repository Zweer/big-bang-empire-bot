   ...
   public class PanelCreateCharacter extends DefaultPanel
   {
      ...
      public function PanelCreateCharacter(param1:SymbolPanelCreateCharacterGeneric)
      {
         ...
         if(param1.txtLoginCaption.textWidth > param1.txtLoginCaption.width)
         {
            ...
            param1.txtLoginCaption.width += _loc3_;
            param1.txtLoginCaption.x -= _loc3_;
            param1.bgLogin.width += _loc3_;
            param1.bgLogin.x -= _loc3_;
         }
         ...
         if(platform.showIngameServerSelection && !platform.isNutakuCom)
         {
            param1.serverSelection.visible = true;
            _serverSelection = new UiServerSelection(param1.serverSelection,(Environment.application as Application).onServerSelectionChange,ServerInfo.defaultServerSelectionData);
         }
         if(AppConfig.alternativeLocales != null)
         {
            ...
            {
               param1.localePicker.x = 250;
               param1.bgLocale.x = 230;
            }
         }
         else
         {
      ...
      private function checkAndMakeSoftcore(param1:AppearanceSettings) : AppearanceSettings
      {
         var _loc3_:* = null;
         var _loc4_:String;
         if(!(_loc4_ = AppConfig.registrationSource))
         {
            return param1;
         }
