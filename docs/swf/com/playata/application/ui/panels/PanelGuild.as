package com.playata.application.ui.panels
{
   ...
   public class PanelGuild extends DefaultPanel
   {
      ...
      override public function refresh() : void
      {
         ...
         var _loc7_:SymbolPanelGuildGeneric;
         (_loc7_ = _vo as SymbolPanelGuildGeneric).dialogNoGuild.visible = !User.current.character.hasGuild && _customGuild == null;
         ...
         else
         {
            ...
            else
            {
               ...
               if(_loc2_.length > 0)
               {
                  ...
                  {
                     _loc12_.x = _loc6_;
                     _loc6_ += Math.round(_loc12_.width + (_loc12_ is ILabel ? 14 : -10));
                  }
                  ...
                  _loc7_.battleInfo.guildBattleInfo.x -= _loc8_;
      ...
      public function getGuildBattleHonor(param1:Guild, param2:Guild) : String
      {
         ...
         if(_loc5_ == 0)
         {
            _loc3_ += LocText.current.text("dialog/guild_battle_search/tooltip_lose_no_honor");
         }
         else
         {
            _loc3_ += LocText.current.text("dialog/guild_battle_search/tooltip_lose_honor",GameUtil.getHonorString(_loc5_));
         }
         return _loc3_;
      }
