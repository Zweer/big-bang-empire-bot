package com.playata.application.ui.panels
{
   ...
   public class PanelSlotMachine extends DefaultPanel
   {
      ...
      private function refreshButtons() : void
      {
         ...
         {
            if(CConstant.slotmachine_max_daily_spins > 0)
            {
            ...
            {
               _btnSpin.tooltip = LocText.current.text("panel/slotmachine/button_spin_without_limit_tooltip",_loc1_.slotmachineSpinCount);
               _btnFreeSpin.tooltip = LocText.current.text("panel/slotmachine/button_spin_without_limit_tooltip",_loc1_.slotmachineSpinCount);
            }
      ...
      {
         var _loc1_:int = CConstant.slotmachine_max_daily_spins;
         if(_loc1_ <= 0)
         {
            _loc1_ = 30;
         }
         Environment.panelManager.showDialog(new DialogTutorialPopup(LocText.current.text("dialog/tutorial/slotmachine/title"),LocText.current.text("dialog/tutorial/slotmachine/text",CConstant.resource_slotmachine_jeton_usage_amount,_loc1_),onTutorialDialogClosed));
      }
