package com.playata.application.ui.panels
{
   ...
   public class PanelStatQuest extends DefaultPanel
   {
      ...
      override public function show(param1:* = null) : void
      {
         ...
         else if(_loc3_.activeDungeonQuest && _loc3_.activeDungeonQuest.isFought && _loc3_.activeDungeonQuest.isStatQuest)
         {
            _quest = _loc3_.activeDungeonQuest;
            _lastViewedMode = 3;
         }
         else if(_loc3_.activeQuest && _loc3_.activeQuest.isFinished && _loc3_.activeQuest.isStatQuest)
         {
         ...
         var _loc6_:Sprite;
         (_loc6_ = (_vo as SymbolPanelStatQuestGeneric).npc).visible = false;
         ...
         var _loc7_:SymbolPanelStatQuestGeneric;
         (_loc7_ = _vo as SymbolPanelStatQuestGeneric).stats.gotoAndStop(_quest.statQuestStat);
         switch(int(_quest.statQuestStat) - 1)
         {
            case 0:
      ...
      private function refreshWithDatingStep() : void
      {
         ...
         var _loc8_:SymbolPanelStatQuestGeneric;
         (_loc8_ = _vo as SymbolPanelStatQuestGeneric).stats.gotoAndStop(_loc1_.statType);
         switch(int(_loc1_.statType) - 1)
         {
            case 0:
         ...
         else if(_loc5_ = _loc4_.outfits.getOutfitWithSetting(_loc7_))
         {
