   ...
   public class ProgressUpdater
   {
      ...
      private function onTimer() : void
      {
         ...
         if(AppConfig.streamingEnabled)
         {
            ...
            {
               if((_loc5_ = _loc1_.streaming.getNextFinishedStreamingShow().progress) < 100)
               {
         ...
         {
            _loc3_ = Number(((_loc8_ = CConstant.movie_cooldown) - _loc1_.remainingSecondsUntilNewMovieOffers) / _loc8_ * 100);
         }
