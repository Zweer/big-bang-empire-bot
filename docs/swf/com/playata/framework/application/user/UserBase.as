package com.playata.framework.application.user
{
   ...
   public class UserBase implements IUser
   {
      ...
      protected var _hasMarketingEmail:Boolean = false;
      ...
      public function set hasMarketingEmail(param1:Boolean) : void
      {
         _hasMarketingEmail = param1;
      }
      
      public function get hasMarketingEmail() : Boolean
      {
         return _hasMarketingEmail;
      }
      ...
      public function setSettingValue(param1:String, param2:Object) : void
      {
         ...
         var handleResponse:* = function(param1:ActionRequestResponse):void
         {
      ...
      {
         var onLatestToSSet:Function = param1;
         var handleResponse:* = function(param1:ActionRequestResponse):void
         {
            Environment.application.updateData(param1.data);
            onLatestToSSet(!param1.hasError);
         };
      ...
      {
         var onLatestPPSet:Function = param1;
         var handleResponse:* = function(param1:ActionRequestResponse):void
         {
            Environment.application.updateData(param1.data);
            onLatestPPSet(!param1.hasError);
         };
      ...
      {
         var onValidated:Function = param1;
         var handleResponse:* = function(param1:ActionRequestResponse):void
         {
            Environment.application.updateData(param1.data);
            if(param1.hasError)
      ...
      {
         var onRegistered:* = function(param1:Boolean, param2:String):void
         {
            var _loc3_:int = 0;
            if(param1 && param2)
            {
      ...
      {
         if(Environment.pushNotificationManager != null && Environment.pushNotificationManager.deviceNotificationId)
         {
            Environment.application.sendActionRequest("unregisterUserNotificationDevice",RequestData.fromData({"device_id":Environment.pushNotificationManager.deviceNotificationId}),null);
         }
      }
