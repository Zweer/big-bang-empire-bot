package com.playata.framework.assets
{
   ...
   public class AssetLoaderBase implements IAssetLoader
   {
      ...
      {
         var onAssetProgress:Function = param1;
         var onAssetComplete:Function = param2;
         var requestUrl:String = param3;
         var onLoadProgress:* = function(param1:DataProgress):void
         {
         ...
         var complete:* = function(param1:IByteArray):void
         {
            if(uriData)
            {
               uriData.dispose();
            }
            onAssetComplete(param1);
         };
         var onError:* = function(param1:Exception):void
         {
            Logger.error("[Asset Loader] URL Asset - Error: " + param1.errorID);
            complete(null);
         };
         var onUrlLoaderComplete:* = function():void
         {
