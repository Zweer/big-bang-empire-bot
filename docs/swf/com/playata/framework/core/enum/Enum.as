package com.playata.framework.core.enum
{
   ...
   public class Enum
   {
      ...
      {
         var _loc5_:EnumConstants;
         if((_loc5_ = _enumDb[Runtime.getClassName(param1)]) == null)
         {
            return null;
         }
      ...
      protected static function initEnum(param1:Class) : void
      {
         ...
         var _loc5_:Array;
         if((_loc5_ = _pendingDb[_loc4_]) == null)
         {
         ...
         for each(var _loc2_ in _loc6_.constant)
         {
            ...
            if((_loc7_ = Object(_loc3_).constructor) != param1)
            {
