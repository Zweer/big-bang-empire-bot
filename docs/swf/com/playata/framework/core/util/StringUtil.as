package com.playata.framework.core.util
{
   ...
   public class StringUtil
   {
      ...
      public static function replaceHtmlTagPart(param1:String, param2:String, param3:String, param4:String, param5:String, param6:String) : String
      {
         ...
         while(_loc7_ != -1)
         {
            if((_loc10_ = param1.indexOf(param3,_loc7_)) == -1)
            {
               break;
            }
            if(!(_loc8_ = param1.substring(_loc7_,_loc10_ + param3.length)))
            {
               break;
            }
            _loc9_ = _loc8_;
         ...
         return StringUtil.replace(param1,param4,"");
      }
      ...
      public static function replaceHtmlFontColorTagPart(param1:String, param2:String, param3:String, param4:String, param5:String = "[[color=", param6:String = "]]") : String
      {
         ...
         while(_loc8_ != -1)
         {
            if((_loc11_ = param1.indexOf(param3,_loc8_)) == -1)
            {
               break;
            }
            if(!(_loc9_ = param1.substring(_loc8_,_loc11_ + param3.length)))
            {
               break;
            }
            _loc10_ = _loc9_;
            ...
            _loc7_.push(_loc10_);
            if((_loc12_ = param1.indexOf(param4)) != -1 && _loc12_ < _loc8_ && _loc7_.length > 1)
            {
               _loc7_.pop();
      ...
      public static function removeHtmlTag(param1:String, param2:String, param3:String, param4:String) : String
      {
         ...
         while(_loc5_ != -1)
         {
            if((_loc7_ = param1.indexOf(param3,_loc5_)) == -1)
            {
               break;
            }
            if(!(_loc6_ = param1.substring(_loc5_,_loc7_ + param3.length)))
            {
               break;
            }
      ...
      public static function hexColorToUint(param1:String) : uint
      {
         ...
         return uint(String(param1).replace(_loc2_,"0x"));
      }
      ...
      public static function formatBytes(param1:uint, param2:int = 1) : String
      {
         ...
         return (_loc4_ = NumberUtil.roundDecimal(_loc4_,param2)) + _loc3_[_loc5_];
      }
   }
}
