package com.playata.framework.display
{
   ...
   public class Sprite extends com.playata.framework.display.DisplayObject implements ISprite
   {
      ...
      public function setRoundedMask(param1:IDisplayObject, param2:Vector.<String>, param3:Number = 15) : void
      {
         ...
         (_loc4_ = FlashDisplayObject.getNativeDisplayObject(param1) as flash.display.Sprite).visible = false;
         var _loc6_:flash.display.Sprite;
         (_loc6_ = new flash.display.Sprite()).graphics.lineStyle(0,0,0);
         ...
         {
            if(_loc8_ = _loc5_.getChildByName(_loc7_))
            {
               _loc8_.mask = _loc6_;
            }
         }
