package com.playata.framework.display
{
   ...
   public class UriSpriteCache
   {
      ...
      public function getUriSprite(param1:UriSpriteDefinition, param2:int) : IUriSprite
      {
         ...
         {
            _loc7_ = (_loc6_ = _cache.getData(_loc5_))[0] as IUriSprite;
         ...
         var _loc4_:IUriSprite;
         (_loc4_ = DisplayObjectFactory.createUriSpriteFromSettings(param1.settings)).load();
         var _loc10_:Vector.<IUriSprite>;
         (_loc10_ = new Vector.<IUriSprite>()).push(_loc4_);
