package com.playata.framework.display.layout
{
   ...
   public class LayoutUtil
   {
      ...
      public static function get deviceAdjustedHalfWidthCorrection() : Number
      {
         return deviceAdjustedWidthCorrection / 2;
      }
      ...
      public static function get deviceAdjustedHalfHeightCorrection() : Number
      {
         return deviceAdjustedHeightCorrection / 2;
      }
      ...
      public static function get deviceAdjustedSoftKeyboardHeight() : uint
      {
         ...
         return int(Math.round(DisplayCore.current.displayContext.softKeyboardRect.height / _loc2_));
      }
