package com.playata.framework.display.lib.flash
{
   ...
   public class FPSMonitor extends Sprite
   {
      ...
      public function FPSMonitor(param1:uint, param2:uint, param3:uint, param4:uint, param5:uint)
      {
         ...
         (_loc7_ = new TextFormat()).color = 16777215;
         _loc7_.font = "Verdana";
         _loc7_.size = 10;
         var _loc6_:TextFormat;
         (_loc6_ = new TextFormat()).color = 4294967295;
         _loc6_.font = "Verdana";
         _loc6_.size = 10;
         _loc6_.bold = true;
      ...
      private function onEnterFrame(param1:Event) : void
      {
         ...
         var _loc7_:String = (_loc7_ = (_loc7_ = StringUtil.formatBytes(System.totalMemory) + "\n") + (int(1000 / _avgTime) + "fps\n")) + ("Avg: " + _avgTime + "ms. Best: " + _shortestTime + "ms (" + int(1000 / _shortestTime) + "fps). Worst: " + _longestTime + "ms (" + int(1000 / _longestTime) + "fps). Div: " + (int(100 * _longestTime / (_shortestTime != 0 ? _shortestTime : 1) - 100)) + "%\n");
