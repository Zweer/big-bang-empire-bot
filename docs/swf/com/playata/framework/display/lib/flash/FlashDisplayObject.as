package com.playata.framework.display.lib.flash
{
   ...
   import com.playata.framework.display.DisplayObject;
   ...
   public class FlashDisplayObject extends FlashObject implements IDisplayObject
   {
      ...
      public function get skewX() : Number
      {
         ...
         return Number(_loc2_.c / 3.141592653589793 * 180);
      }
      ...
      {
         var _loc2_:Matrix = _displayObject.transform.matrix;
         return Number(_loc2_.b / 3.141592653589793 * 180);
      }
      ...
      public function addFilter(param1:IDisplayObjectFilter) : void
      {
         ...
         {
            case "grayscale":
               _loc14_ = (_loc4_ = param1 as GrayscaleFilter).r;
               _loc7_ = _loc4_.g;
               _loc2_ = _loc4_.b;
               _loc8_ = (_loc8_ = (_loc8_ = (_loc8_ = (_loc8_ = []).concat([_loc14_,_loc7_,_loc2_,0,0])).concat([_loc14_,_loc7_,_loc2_,0,0])).concat([_loc14_,_loc7_,_loc2_,0,0])).concat([0,0,0,_loc4_.a,0]);
            ...
            case "tint":
               ...
               (_loc15_ = new ColorTransform()).color = _loc10_.color;
