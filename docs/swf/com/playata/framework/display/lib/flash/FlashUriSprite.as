package com.playata.framework.display.lib.flash
{
   ...
   public class FlashUriSprite extends FlashDisplayObjectContainer implements IUriSprite
   {
      ...
      public function clone(param1:Function) : IUriSprite
      {
         ...
         var _loc8_:* = null;
         var _loc6_:* = null;
         var _loc4_:FlashUriSprite;
         (_loc4_ = new FlashUriSprite())._uri = _uri;
         ...
         else
         {
            ...
            (_loc6_ = new Bitmap()).bitmapData = _loc8_.bitmapData;
      ...
      {
         if(_loader && _loader.content is Bitmap)
         {
         ...
         if(_content.getChildAt(0) is Bitmap)
         {
            return (_content.getChildAt(0) as Bitmap).bitmapData;
         }
         if(_content.getChildAt(0) is MovieClip)
         {
            return FlashDisplayUtil.getFlashDisplayObjectAsBitmap(_content.getChildAt(0)).bitmapData;
         }
         return null;
      }
      ...
      private function completeHandler(param1:Event) : void
      {
         ...
         try
         {
            ...
            {
               (_loc4_ = Bitmap(_loader.content)).smoothing = true;
            }
