   ...
   public class FixedList extends List
   {
      ...
      public function FixedList(param1:Sprite, param2:Class, param3:int, param4:Direction, param5:Button, param6:Button, param7:Boolean, param8:Boolean, param9:Function = null, param10:String = null)
      {
         ...
         else
         {
            ...
            while(_loc12_ < param3)
            {
               (_loc11_ = addExistingLine(null,_loc12_,_listContainer.getChildByName(param10 + (_loc12_ + 1)))).visible = false;
               _loc12_++;
            }
         }
      }
      ...
      public function scrollToItem(param1:IListItem) : void
      {
         _offset = 0;
         scrollDown(Math.max(Math.floor(_currentListItems.indexOf(param1) - _lines.length / 2),0));
      }
