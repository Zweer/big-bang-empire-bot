package com.playata.framework.display.ui.controls
{
   ...
   public class List extends Control
   {
      ...
      protected var _allowSelection:Boolean = true;
      ...
      public function selectFirstLine() : void
      {
         clearSelection();
         if(_currentListItems.length > 0)
         {
            selectedItem = _currentListItems[0];
         }
      }
      ...
      public function get currentListItems() : Vector.<IListItem>
      {
         return _currentListItems;
      }
      ...
      {
         var item:IListItem = param1;
         var index:int = param2;
         var content:IDisplayObject = param3;
