package com.playata.framework.display.ui.controls
{
   ...
   public class ScrollContainer extends Control implements IScrollContainer
   {
      ...
      protected var _scrollTween:ITween = null;
      ...
      public static function isTouched(param1:ScrollContainer) : Boolean
      {
         return SCROLL_TOUCHES.exists(param1);
      }
      ...
      public function get allowRubberBanding() : Boolean
      {
         return _allowRubberBanding;
      }
      
      public function set allowRubberBanding(param1:Boolean) : void
      {
         _allowRubberBanding = param1;
      }
      
      public function refreshScrollContainer() : void
      {
         _invalidated = true;
         onUpdate(0);
      }
      ...
      public function getElement(param1:int) : IDisplayObject
      {
      ...
      public function scrollToPosition(param1:Point, param2:Number = 0.6) : void
      {
         ...
         if(_containerPosition.x == pos.x && _containerPosition.y == pos.y)
         {
            return;
         }
         if(duration > 0)
         {
            ...
            _scrollTween = Tween.to(updatedPosition,duration,positionTween);
         }
         else
         {
      ...
      protected function onMouseWheelHandler(param1:InteractionEvent) : void
      {
         var _loc4_:int = 0;
         _loc4_ = 30;
         if(!_enabled || !Control.isControllable(this) || !interactionEnabled)
         {
            return;
         }
      ...
      {
         if(!_enabled || !Control.isControllable(this))
         {
            _activeTouchId = -1;
            return;
         }
         ...
         if(_activeTouchId == -1)
         {
            _movedOffset.x = _movedOffset.y = 0;
            _speed.x = _speed.y = 0;
      ...
      protected function handleInteractionMove(param1:InteractionEvent) : void
      {
         ...
         if(!SCROLL_TOUCHES.exists(this))
         {
            _loc2_ = Point.distance(HELPER_POINT_TOUCH,_absoluteTouchStartPosition);
            if(_loc2_ <= MIN_DRAG_DISTANCE)
            {
               return;
            }
         ...
         if(_policy != ScrollPolicy.VERTICAL)
         {
            ...
            if(HELPER_POINT_OFFSET.x != 0)
            {
               ...
               _movedOffset.x += HELPER_POINT_OFFSET.x;
            }
         ...
         if(_policy != ScrollPolicy.HORIZONTAL)
         {
            ...
            if(HELPER_POINT_OFFSET.y != 0)
            {
               ...
               _movedOffset.y += HELPER_POINT_OFFSET.y;
            }
      ...
      protected function setBounds(param1:IDisplayObject, param2:Number, param3:Number, param4:Number, param5:Number) : void
      {
         ...
         {
            (_loc6_ = _boundsCache.getData(param1.nativeInstance)).x = param2;
            _loc6_.y = param3;
            _loc6_.width = param4;
      ...
      protected function updateContentVisibility() : void
      {
         ...
         _boundsChecker.y -= _container.y;
         _boundsChecker.x -= _container.x;
      ...
      protected function updateScroller() : void
      {
         ...
         if(_scrollIndicatorVertical && _policy != ScrollPolicy.HORIZONTAL)
         {
            ...
            {
               _loc1_ += _containerPosition.y;
            }
            else if(_containerPosition.y < _min.y)
            {
               _loc1_ += _min.y - _containerPosition.y;
            }
         ...
         if(_scrollIndicatorHorizontal && _policy != ScrollPolicy.VERTICAL)
         {
            ...
            {
               _loc4_ += _containerPosition.x;
            }
            else if(_containerPosition.x < _min.x)
            {
               _loc4_ += _min.x - _containerPosition.x;
            }
