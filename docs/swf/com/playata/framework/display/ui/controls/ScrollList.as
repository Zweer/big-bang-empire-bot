package com.playata.framework.display.ui.controls
{
   ...
   public class ScrollList extends List implements IScrollable
   {
      ...
      protected var _customRenderListItem:Function = null;
      
      protected var _lineOffset:int = 0;
      ...
      public function ScrollList(param1:Sprite, param2:Class, param3:Direction, param4:IScrollBar, param5:Button, param6:Button, param7:Boolean, param8:Boolean, param9:Function = null)
      {
         ...
         var _loc10_:ScrollerDefinition;
         (_loc10_ = new ScrollerDefinition()).policy = _direction == Direction.VERTICAL ? ScrollPolicy.VERTICAL : ScrollPolicy.HORIZONTAL;
      ...
      {
         return _scrollContainer.containerWidth;
      }
      ...
      {
         return _scrollContainer.containerHeight;
      }
      ...
      public function scrollToItem(param1:IListItem, param2:Number) : void
      {
         var _loc3_:ListLine = getLineForItem(param1);
         if(_loc3_)
         {
            _scrollContainer.scrollCenterElement(_loc3_,param2);
         }
      }
      ...
      override protected function renderList() : void
      {
            ...
            else
            {
               ...
               if(_customRenderListItem === null)
               {
                  ...
                  if(_direction == Direction.HORIZONTAL)
                  {
                     ...
                     _loc5_.y = _lineOffset;
                     _loc3_ += _loc5_.width;
                  }
               }
               else
               {
                  _loc2_ = _customRenderListItem(_loc6_,_loc5_);
               }
               if(_loc2_)
               {
         ...
         (_scrollContainer as ScrollContainer).refreshScrollContainer();
         if(_appendFromEnd)
         {
