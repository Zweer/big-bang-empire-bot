package com.playata.framework.display.ui.controls
{
   ...
   public class Tooltip extends InteractiveDisplayObject
   {
      ...
      private static const _onVisibleChangedCallbacks:GenericMap = new GenericMap();
      ...
      {
         var element:IInteractiveDisplayObject = param1;
         var visual:IDisplayObject = param2;
         super(visual);
         _element = element;
         if(_element != null)
         {
      ...
      override public function set visible(param1:Boolean) : void
      {
         if(visible != param1)
         {
            ...
            if(_onVisibleChangedCallbacks.exists(_displayObject))
            {
               _onVisibleChangedCallbacks.getData(_displayObject).dispatch(this);
            }
         }
      }
      ...
      public function get onVisibleChanged() : ISignal
      {
         if(!_onVisibleChangedCallbacks.exists(_displayObject))
         {
            _onVisibleChangedCallbacks.setData(_displayObject,new Signal());
         }
         return _onVisibleChangedCallbacks.getData(_displayObject);
      }
   }
}
