package com.playata.framework.input.lib.flash
{
   ...
   public class FlashMouseEvent extends InteractionEvent
   {
       
      
      private var _mouseEvent:MouseEvent = null;
      
      public function FlashMouseEvent(param1:IInteractionTarget, param2:MouseEvent)
      {
         super();
         _mouseEvent = param2;
         this.target = param1;
      ...
      override protected function getData(param1:String) : Object
      {
         switch(param1)
         {
            ...
            case "localX":
               return _mouseEvent.localX;
            case "localY":
               return _mouseEvent.localY;
            default:
