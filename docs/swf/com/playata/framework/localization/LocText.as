package com.playata.framework.localization
{
   ...
   public class LocText implements IAsset
   {
      ...
      public function text(param1:String, ... rest) : String
      {
         ...
         while(_loc12_ > 0)
         {
            ...
            else
            {
               ...
               while(_loc14_.indexOf(_loc19_) != -1)
               {
                  ...
                  _loc17_ = !!((_loc21_ = parseFloat(StringUtil.replace(StringUtil.replace(rest[_loc12_ - 1].toString(),text("base/numbers/comma_separator"),"."),text("base/numbers/thousands_separator"),""))) % 1) ? true : false;
                  _loc20_ = "";
         ...
         while(_loc14_.indexOf("[m:") != -1 || _loc14_.indexOf("[f:") != -1)
         {
            ...
            if(_loc14_.indexOf("[m:") != -1)
            {
               ...
               if((_loc22_ = _loc14_.substring(_loc14_.indexOf("[m:") + 3)).indexOf("|f:") != -1 && _loc22_.indexOf("]") != -1)
               {
                  _loc18_ = (_loc18_ = _loc22_.substring(_loc22_.indexOf("|f:") + 3)).substring(0,_loc18_.indexOf("]"));
            ...
            else
            {
               ...
               if((_loc18_ = _loc14_.substring(_loc14_.indexOf("[f:") + 3)).indexOf("|m:") != -1 && _loc18_.indexOf("]") != -1)
               {
                  _loc22_ = (_loc22_ = _loc18_.substring(_loc18_.indexOf("|m:") + 3)).substring(0,_loc22_.indexOf("]"));
         ...
         while(_loc14_.indexOf("[touch:") != -1 || _loc14_.indexOf("[desktop:") != -1)
         {
            ...
            if(_loc14_.indexOf("[touch:") != -1)
            {
               ...
               if((_loc9_ = _loc14_.substring(_loc14_.indexOf("[touch:") + "[touch:".length)).indexOf("|desktop:") != -1 && _loc9_.indexOf("]") != -1)
               {
                  _loc4_ = (_loc4_ = _loc9_.substring(_loc9_.indexOf("|desktop:") + "[desktop:".length)).substring(0,_loc4_.indexOf("]"));
            ...
            else
            {
               ...
               if((_loc4_ = _loc14_.substring(_loc14_.indexOf("[desktop:") + "[desktop:".length)).indexOf("|touch:") != -1 && _loc4_.indexOf("]") != -1)
               {
                  _loc9_ = (_loc9_ = _loc4_.substring(_loc4_.indexOf("|touch:") + "|touch:".length)).substring(0,_loc9_.indexOf("]"));
         ...
         while(_loc14_.indexOf("<font color=\"quality") != -1)
         {
            ...
            {
               if(_loc14_.indexOf("\"quality_epic\"") == -1)
               {
      ...
      public function getParameterString(param1:String, param2:int, param3:String = null) : String
      {
         ...
         {
            if((_loc7_ = _loc4_.charAt(_loc8_)) == "[")
            {
               _loc5_++;
            }
         ...
         return _loc4_.substr(0,_loc6_ + 1);
      }
      ...
      public function getPluralForm(param1:String, param2:int, param3:String = null) : String
      {
         ...
         return (_loc4_ = _loc4_.substr(0,_loc6_)).replace("$v",param3);
      }
      ...
      public function formatHugeNumber(param1:*, param2:Boolean = false) : String
      {
         ...
         {
            _loc6_ += _loc5_.slice(_loc7_,_loc7_ + 3);
            if((_loc7_ += 3) < _loc5_.length)
            {
               _loc6_ += _loc9_;
            }
         }
