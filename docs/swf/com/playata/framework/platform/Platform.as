package com.playata.framework.platform
{
   ...
   public class Platform
   {
      ...
      public function get isNutakuCom() : Boolean
      {
         return id == "nutaku" && ServerInfo.serverId != "nu1" && ServerInfo.serverId != "nu2";
      }
      
      public function get isNutakuNet() : Boolean
      {
         return id == "nutaku" && (ServerInfo.serverId == "nu1" || ServerInfo.serverId == "nu2");
      }
      ...
      {
         return id == "naughtyempire" || isEroges || isNutakuNet;
      }
