   ...
   public class GreenSockTweenHandler implements ITweenHandler
   {
      ...
      public function printActiveTweens(param1:Boolean = true, param2:Array = null) : void
      {
         ...
         for each(var _loc4_ in param2)
         {
            ...
            {
               _loc7_ = (_loc5_ = _loc4_ as TimelineMax).isActive();
               if(!param1 || _loc7_)
               {
            ...
            {
               _loc7_ = (_loc6_ = _loc4_ as TimelineLite).isActive();
               if(!param1 || _loc7_)
               {
            ...
            {
               _loc7_ = (_loc8_ = _loc4_ as TweenMax).isActive();
               if(!param1 || _loc7_)
               {
