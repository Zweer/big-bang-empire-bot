package org.casalib.load
{
   ...
   public class GroupLoad extends ProcessGroup
   {
      ...
      public function getLoad(param1:*) : LoadItem
      {
         ...
         while(_loc4_--)
         {
            if((_loc5_ = _loc3_[_loc4_]) is GroupLoad)
            {
               if((_loc5_ = _loc5_.getLoad(param1)) != null)
               {
                  return _loc5_;
               }
            }
      ...
      public function hasAsset(param1:*, param2:Boolean = true) : Boolean
      {
         ...
         var _loc4_:Array;
         var _loc5_:uint = (_loc4_ = this.loads).length;
         while(_loc5_--)
         {
            if((_loc6_ = _loc4_[_loc5_]) is GroupLoad)
            {
      ...
      protected function _checkTotalPercentValidity() : void
      {
         ...
         {
            _loc1_ += this._percentMap[_loc2_].decimalPercentage;
         }
         if(_loc1_ != 1)
         {
            for(_loc2_ in this._percentMap)
            {
               this._percentMap[_loc2_].decimalPercentage /= _loc1_;
            }
         }
      }
      ...
      protected function _onProgress(param1:LoadEvent) : void
      {
         ...
         var _loc3_:* = 0;
         var _loc4_:Array;
         var _loc5_:uint = (_loc4_ = this.processes).length;
         while(_loc5_--)
         {
            if((_loc6_ = _loc4_[_loc5_]).loading)
            {
               _loc2_.push(_loc6_.Bps);
               _loc3_ += this._percentMap[_loc6_].decimalPercentage * _loc6_.progress.decimalPercentage;
            }
            else if(_loc6_.loaded)
            {
               _loc2_.push(_loc6_.Bps);
               _loc3_ += this._percentMap[_loc6_].decimalPercentage;
            }
         }
