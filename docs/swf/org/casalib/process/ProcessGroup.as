   ...
   public class ProcessGroup extends Process
   {
      ...
      public function addProcess(param1:Process) : void
      {
         ...
         else
         {
            ...
            {
               if(!(_loc5_ = this._processes[_loc2_]).completed)
               {
      ...
      public function hasProcess(param1:Process, param2:Boolean = true) : Boolean
      {
         ...
         while(_loc4_--)
         {
            if((_loc5_ = this._processes[_loc4_]) is ProcessGroup)
            {
               if((_loc6_ = _loc5_ as ProcessGroup).hasProcess(param1,true))
               {
                  return true;
               }
            }
      ...
      public function destroyProcesses(param1:Boolean = true) : void
      {
         ...
         if(param1)
         {
            while(_loc2_--)
            {
               ...
               {
                  (_loc4_ = _loc3_ as ProcessGroup).destroyProcesses(true);
               }
               else
               {
                  _loc3_.destroy();
