package spine
{
   public class Bone implements Updatable
   {
      ...
      public function updateWorldTransformWith(param1:Number, param2:Number, param3:Number, param4:Number, param5:Number, param6:Number, param7:Number) : void
      {
         ...
         switch(_data.transformMode)
         {
            ...
            case TransformMode.noScaleOrReflection:
               ...
               if((_loc22_ = Number(Math.sqrt(_loc15_ * _loc15_ + _loc17_ * _loc17_))) > 0.00001)
               {
               ...
               _loc21_ = 3.141592653589793 / 2 + Math.atan2(_loc17_,_loc15_);
      ...
      function updateAppliedTransform() : void
      {
         ...
         if(scaleX > 0.0001)
         {
            ascaleY = (_loc9_ = _loc3_ * _loc8_ - _loc4_ * _loc6_) / ascaleX;
