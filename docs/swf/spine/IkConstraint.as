package spine
{
   public class IkConstraint implements Constraint
   {
      ...
      public static function apply2(param1:Bone, param2:Bone, param3:Number, param4:Number, param5:int, param6:Number) : void
      {
         ...
         var _loc50_:*;
         if(!(_loc50_ = Math.abs(_loc31_ - _loc32_) <= 0.0001))
         {
            _loc52_ = 0;
         ...
         var _loc7_:Bone;
         _loc34_ = (_loc7_ = param1.parent).a;
         _loc35_ = _loc7_.b;
         _loc37_ = _loc7_.c;
         _loc38_ = _loc7_.d;
         ...
         {
            _loc26_ *= _loc31_;
            if((_loc13_ = Number((_loc10_ * _loc10_ + _loc12_ * _loc12_ - _loc25_ * _loc25_ - _loc26_ * _loc26_) / (2 * _loc25_ * _loc26_))) < -1)
            {
               _loc13_ = -1;
            }
            else if(_loc13_ > 1)
         ...
         else
         {
            ...
            if((_loc38_ = _loc22_ * _loc22_ - 4 * _loc23_ * _loc37_) >= 0)
            {
               ...
               _loc56_ = (_loc46_ = -(_loc22_ + _loc46_) / 2) / _loc23_;
            ...
            _loc42_ = 0;
            var _loc55_:* = 1.7976931348623157e+308;
            var _loc51_:* = 0;
            var _loc48_:* = 0;
            _loc40_ = 0;
            var _loc36_:* = 0;
            ...
            if((_loc38_ = _loc53_ * _loc53_) > _loc36_)
            {
               _loc40_ = 0;
               _loc36_ = _loc38_;
               _loc28_ = _loc53_;
            ...
            _loc53_ = _loc25_ - _loc34_;
            if((_loc38_ = _loc53_ * _loc53_) < _loc55_)
            {
               _loc42_ = 3.141592653589793;
               _loc55_ = _loc38_;
               _loc51_ = _loc53_;
            }
            ...
            if((_loc38_ = _loc53_ * _loc53_ + _loc54_ * _loc54_) < _loc55_)
            {
               _loc42_ = _loc33_;
               _loc55_ = _loc38_;
               _loc51_ = _loc53_;
         ...
         if((_loc44_ = (_loc44_ - _loc39_) * MathUtils.radDeg + _loc29_ - _loc41_) > 180)
         {
            _loc44_ -= 360;
         }
         else if(_loc44_ < -180)
         ...
         if((_loc45_ = ((_loc45_ + _loc39_) * MathUtils.radDeg - param2.ashearX) * _loc20_ + _loc30_ - _loc41_) > 180)
         {
            _loc45_ -= 360;
         }
         else if(_loc45_ < -180)
