package spine
{
   ...
   public class PathConstraint implements Constraint
   {
      ...
      public function update() : void
      {
         ...
         var _loc11_:PathAttachment;
         if((_loc11_ = target.attachment as PathAttachment) == null)
         {
            return;
         }
         var _loc4_:Number = this.rotateMix;
         var _loc19_:Number;
         var _loc9_:* = (_loc19_ = this.translateMix) > 0;
         var _loc1_:* = _loc4_ > 0;
         if(!_loc9_ && !_loc1_)
         {
            return;
         ...
         var _loc13_:SpacingMode;
         var _loc5_:* = (_loc13_ = _loc2_.spacingMode) == SpacingMode.length;
         var _loc14_:RotateMode;
         var _loc17_:* = (_loc14_ = _loc2_.rotateMode) == RotateMode.tangent;
         ...
         if(_loc6_ || _loc5_)
         {
            ...
            {
               var _loc39_:Number = (_loc25_ = (_loc27_ = _loc37_[_loc26_]).data.length) * _loc27_.a;
         ...
         var _loc28_:Vector.<Number>;
         var _loc8_:* = Number((_loc28_ = computeWorldPositions(_loc11_,_loc36_,_loc17_,_loc2_.positionMode == PositionMode.percent,_loc13_ == SpacingMode.percent))[0]);
         ...
         else
         {
            _loc18_ = false;
            _loc32_ = target.bone;
            _loc22_ *= _loc32_.a * _loc32_.d - _loc32_.b * _loc32_.c > 0 ? MathUtils.degRad : Number(-MathUtils.degRad);
         }
         _loc26_ = 0;
         _loc31_ = 3;
         while(_loc26_ < _loc29_)
         {
            _loc27_._worldX = (_loc27_ = _loc37_[_loc26_])._worldX + (_loc8_ - _loc27_.worldX) * _loc19_;
            _loc27_._worldY += (_loc7_ - _loc27_.worldY) * _loc19_;
            ...
            if(_loc1_)
            {
               ...
               _loc33_ -= Math.atan2(_loc23_,_loc20_);
               if(_loc18_)
               {
                  _loc3_ = Math.cos(_loc33_);
                  _loc16_ = Math.sin(_loc33_);
                  _loc25_ = _loc27_.data.length;
                  _loc8_ += (_loc25_ * (_loc3_ * _loc20_ - _loc16_ * _loc23_) - _loc12_) * _loc4_;
                  _loc7_ += (_loc25_ * (_loc16_ * _loc20_ + _loc3_ * _loc23_) - _loc15_) * _loc4_;
               }
               else
               {
                  _loc33_ += _loc22_;
               }
               if(_loc33_ > 3.141592653589793)
               {
                  _loc33_ -= 3.141592653589793 * 2;
               }
               else if(_loc33_ < -3.141592653589793)
               {
                  _loc33_ += 3.141592653589793 * 2;
               }
               _loc33_ *= _loc4_;
      ...
      protected function computeWorldPositions(param1:PathAttachment, param2:int, param3:Boolean, param4:Boolean, param5:Boolean) : Vector.<Number>
      {
         ...
         var _loc25_:int = (_loc10_ = param1.worldVerticesLength) / 6;
         var _loc27_:* = -1;
         if(!param1.constantSpeed)
         {
            ...
            _loc24_ = 0;
            _loc6_ = 0;
            for(; _loc22_ < param2; _loc22_++,_loc24_ += 3)
            {
               _loc11_ = _loc35_[_loc22_];
               _loc26_ = _loc41_ += _loc11_;
               if(_loc37_)
               {
                  if((_loc26_ %= _loc36_) < 0)
                  {
                     _loc26_ += _loc36_;
                  }
                  _loc6_ = 0;
         ...
         while(_loc22_ < _loc25_)
         {
            ...
            _loc36_ += Math.sqrt(_loc32_ * _loc32_ + _loc31_ * _loc31_);
            _loc32_ += _loc43_;
            _loc31_ += _loc45_;
            _loc43_ += _loc7_;
            _loc45_ += _loc9_;
            ...
            _loc31_ += _loc45_;
            _loc36_ += Math.sqrt(_loc32_ * _loc32_ + _loc31_ * _loc31_);
            _loc32_ += _loc43_ + _loc7_;
            _loc31_ += _loc45_ + _loc9_;
            _loc36_ += Math.sqrt(_loc32_ * _loc32_ + _loc31_ * _loc31_);
         ...
         for(; _loc22_ < param2; _loc22_++,_loc24_ += 3)
         {
            ...
            if(_loc6_ != _loc27_)
            {
               ...
               while(_loc20_ < 8)
               {
                  ...
                  _loc43_ += _loc7_;
                  _loc45_ += _loc9_;
                  _loc42_ += Math.sqrt(_loc32_ * _loc32_ + _loc31_ * _loc31_);
      ...
      private function addCurvePosition(param1:Number, param2:Number, param3:Number, param4:Number, param5:Number, param6:Number, param7:Number, param8:Number, param9:Number, param10:Vector.<Number>, param11:int, param12:Boolean) : void
      {
         ...
         var _loc18_:Number = (_loc13_ = param1 * param1) * param1;
         var _loc19_:Number = 1 - param1;
         var _loc14_:Number;
         var _loc17_:Number = (_loc14_ = _loc19_ * _loc19_) * _loc19_;
         var _loc20_:Number = (_loc23_ = _loc19_ * param1) * 3;
