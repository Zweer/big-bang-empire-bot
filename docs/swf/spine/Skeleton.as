package spine
{
   ...
   public class Skeleton
   {
      ...
      public function updateCache() : void
      {
         ...
         var _loc2_:* = null;
         var _loc7_:* = null;
         var _loc5_:Vector.<Updatable>;
         (_loc5_ = this._updateCache).length = 0;
         ...
         while(_loc6_ < _loc9_)
         {
            ...
            while(true)
            {
               if(_loc1_ < _loc3_)
               {
                  if((_loc10_ = _loc12_[_loc1_]).data.order == _loc6_)
                  {
               ...
               while(true)
               {
                  ...
                  while(true)
                  {
                     ...
                     if((_loc7_ = _loc4_[_loc1_]).data.order == _loc6_)
                     {
      ...
      {
         var _loc6_:Slot;
         var _loc9_:Number = (_loc6_ = param1.target).data.index;
         ...
         var _loc4_:Attachment;
         if((_loc4_ = _loc6_.attachment) is PathAttachment)
         {
            sortPathConstraintAttachment2(_loc4_,_loc5_);
         }
         var _loc8_:Vector.<Bone>;
         var _loc7_:Number = (_loc8_ = param1.bones).length;
         _loc2_ = 0;
         while(_loc2_ < _loc7_)
         {
      ...
      private function sortTransformConstraint(param1:TransformConstraint) : void
      {
         ...
         var _loc4_:Vector.<Bone>;
         var _loc3_:Number = (_loc4_ = param1.bones).length;
         var _loc2_:* = 0;
         _loc2_ = 0;
         while(_loc2_ < _loc3_)
         {
      ...
      {
         if(!param1.attachments.hasOwnProperty(param2))
         {
            return;
         }
         var _loc4_:Dictionary;
         if(!(_loc4_ = param1.attachments[param2]))
         {
            return;
         }
