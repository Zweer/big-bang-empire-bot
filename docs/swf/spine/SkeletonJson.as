package spine
{
   ...
   public class SkeletonJson
   {
      ...
      public function readSkeletonData(param1:*, param2:String = null) : SkeletonData
      {
         ...
         var _loc24_:SkeletonData;
         (_loc24_ = new SkeletonData()).name = param2;
         var _loc7_:Object;
         if(_loc7_ = _loc16_["skeleton"])
         {
         ...
         for each(var _loc30_ in _loc16_["bones"])
         {
            ...
            (_loc23_ = new BoneData(_loc24_.bones.length,_loc30_["name"],_loc3_)).length = (_loc30_["length"] || 0) * scale;
         ...
         {
            (_loc5_ = new IkConstraintData(_loc14_["name"])).order = _loc14_["order"] || 0;
            for each(_loc20_ in _loc14_["bones"])
            {
               if(!(_loc26_ = _loc24_.findBone(_loc20_)))
               {
         ...
         {
            (_loc27_ = new TransformConstraintData(_loc14_["name"])).order = _loc14_["order"] || 0;
            for each(_loc20_ in _loc14_["bones"])
            {
               if(!(_loc26_ = _loc24_.findBone(_loc20_)))
               {
         ...
         {
            (_loc37_ = new PathConstraintData(_loc14_["name"])).order = _loc14_["order"] || 0;
            for each(_loc20_ in _loc14_["bones"])
            {
               if(!(_loc26_ = _loc24_.findBone(_loc20_)))
               {
         ...
         for(var _loc25_ in _loc11_)
         {
            ...
            for(_loc10_ in _loc22_)
            {
               ...
               {
                  if((_loc13_ = readAttachment(_loc15_[_loc35_],_loc6_,_loc9_,_loc35_)) != null)
                  {
         ...
         {
            if(!(_loc29_ = !_loc28_.skin ? _loc24_.defaultSkin : _loc24_.findSkin(_loc28_.skin)))
            {
               throw new Error("Skin not found: " + _loc28_.skin);
            }
            if(!(_loc12_ = _loc29_.getAttachment(_loc28_.slotIndex,_loc28_.parent)))
            {
         ...
         _loc8_.length = 0;
         var _loc19_:Object;
         if(_loc19_ = _loc16_["events"])
         {
            for(var _loc18_ in _loc19_)
            {
               _loc31_ = _loc19_[_loc18_];
               (_loc33_ = new EventData(_loc18_)).intValue = _loc31_["int"] || 0;
      ...
      private function readAttachment(param1:Object, param2:Skin, param3:int, param4:String) : Attachment
      {
         ...
         switch(_loc9_)
         {
            case AttachmentType.region:
               if(!(_loc15_ = attachmentLoader.newRegionAttachment(param2,param4,param1["path"] || param4)))
               {
                  return null;
               }
            ...
            case AttachmentType.boundingbox:
               if(!(_loc8_ = attachmentLoader.newBoundingBoxAttachment(param2,param4)))
               {
                  return null;
               }
            ...
            case AttachmentType.path:
               if(!(_loc11_ = attachmentLoader.newPathAttachment(param2,param4)))
               {
                  return null;
               }
         ...
         if(!(_loc16_ = attachmentLoader.newMeshAttachment(param2,param4,param1["path"] || param4)))
         {
            return null;
         }
      ...
      private function readVertices(param1:Object, param2:VertexAttachment, param3:int) : void
      {
         ...
         var _loc9_:Vector.<Number>;
         (_loc9_ = new Vector.<Number>(param3 * 3 * 3)).length = 0;
         var _loc6_:Vector.<int>;
         (_loc6_ = new Vector.<int>(param3 * 3)).length = 0;
         _loc7_ = 0;
         _loc10_ = _loc5_.length;
         while(_loc7_ < _loc10_)
         {
      ...
      private function readAnimation(param1:Object, param2:String, param3:SkeletonData) : void
      {
         ...
         for(_loc13_ in _loc26_)
         {
            ...
            for(_loc12_ in _loc76_)
            {
               ...
               if(_loc12_ == "color")
               {
                  (_loc47_ = new ColorTimeline(_loc40_.length)).slotIndex = _loc43_;
                  _loc35_ = 0;
               ...
               else
               {
                  ...
                  (_loc78_ = new AttachmentTimeline(_loc40_.length)).slotIndex = _loc43_;
                  _loc35_ = 0;
                  for each(_loc50_ in _loc40_)
                  {
         ...
         {
            if((_loc33_ = param3.findBoneIndex(_loc17_)) == -1)
            {
            ...
            for(_loc12_ in _loc25_)
            {
               ...
               if(_loc12_ == "rotate")
               {
                  (_loc21_ = new RotateTimeline(_loc40_.length)).boneIndex = _loc33_;
                  _loc35_ = 0;
                  for each(_loc50_ in _loc40_)
                  {
         ...
         for(var _loc82_ in _loc18_)
         {
            ...
            (_loc44_ = new IkConstraintTimeline(_loc40_.length)).ikConstraintIndex = param3.ikConstraints.indexOf(_loc75_);
            _loc35_ = 0;
            for each(_loc50_ in _loc40_)
            {
         ...
         for(var _loc24_ in _loc9_)
         {
            ...
            (_loc49_ = new TransformConstraintTimeline(_loc40_.length)).transformConstraintIndex = param3.transformConstraints.indexOf(_loc4_);
            _loc35_ = 0;
            for each(_loc50_ in _loc40_)
            {
         ...
         {
            if((_loc22_ = param3.findPathConstraintIndex(_loc34_)) == -1)
            {
            ...
            for(_loc12_ in _loc19_)
            {
               ...
               {
                  (_loc81_ = new PathConstraintMixTimeline(_loc40_.length)).pathConstraintIndex = _loc22_;
                  _loc35_ = 0;
                  for each(_loc50_ in _loc40_)
                  {
                     _loc10_ = !!_loc50_.hasOwnProperty("rotateMix") ? _loc50_["rotateMix"] : 1;
         ...
         for(var _loc68_ in _loc64_)
         {
            ...
            for(_loc13_ in _loc76_)
            {
               ...
               for(_loc12_ in _loc16_)
               {
                  ...
                  if((_loc46_ = _loc41_.getAttachment(_loc43_,_loc12_) as VertexAttachment) == null)
                  {
                  ...
                  (_loc14_ = new DeformTimeline(_loc40_.length)).slotIndex = _loc43_;
                  _loc14_.attachment = _loc46_;
                  _loc35_ = 0;
                  for each(_loc50_ in _loc40_)
                  {
                     if((_loc37_ = _loc50_["vertices"]) == null)
                     {
                     ...
                     else
                     {
                        ...
                        if(_loc42_ != 1)
                        {
                           _loc70_ = (_loc67_ = _loc65_) + _loc61_.length;
                           while(_loc67_ < _loc70_)
                           {
                              var _loc84_:* = _loc67_;
                              var _loc83_:* = _loc20_[_loc84_] * _loc42_;
                        ...
                        if(!_loc15_)
                        {
                           ...
                           {
                              var _loc86_:* = _loc67_;
                              var _loc85_:* = _loc20_[_loc86_] + _loc38_[_loc67_];
         ...
         if(_loc72_)
         {
            ...
            for each(var _loc51_ in _loc72_)
            {
               ...
               if(_loc51_["offsets"])
               {
                  ...
                  {
                     if((_loc43_ = param3.findSlotIndex(_loc69_["slot"])) == -1)
                     {
         ...
         var _loc71_:Array;
         if(_loc71_ = param1["events"])
         {
            _loc11_ = new EventTimeline(_loc71_.length);
            _loc35_ = 0;
            for each(var _loc73_ in _loc71_)
            {
               if(!(_loc28_ = param3.findEvent(_loc73_["name"])))
               {
                  throw new Error("Event not found: " + _loc73_["name"]);
               }
               (_loc55_ = new Event(_loc73_["time"],_loc28_)).intValue = !!_loc73_.hasOwnProperty("int") ? _loc73_["int"] : _loc28_.intValue;
