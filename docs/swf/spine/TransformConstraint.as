package spine
{
   public class TransformConstraint implements Constraint
   {
      ...
      public function update() : void
      {
         ...
         var _loc21_:Bone;
         var _loc17_:Number = (_loc21_ = this.target).a;
         ...
         while(_loc15_ < _loc19_)
         {
            ...
            if(_loc2_ != 0)
            {
               ...
               if((_loc24_ = Math.atan2(_loc22_,_loc17_) - Math.atan2(_loc12_,_loc9_) + _loc11_) > 3.141592653589793)
               {
                  _loc24_ -= 3.141592653589793 * 2;
               }
               else if(_loc24_ < -3.141592653589793)
               {
                  _loc24_ += 3.141592653589793 * 2;
               }
               _loc24_ *= _loc2_;
            ...
            if(_loc8_ != 0)
            {
               ...
               _loc16_._worldX += (_temp[0] - _loc16_.worldX) * _loc8_;
               _loc16_._worldY += (_temp[1] - _loc16_.worldY) * _loc8_;
               _loc6_ = true;
            }
            if(_loc14_ > 0)
            {
            ...
            if(_loc20_ > 0)
            {
               ...
               if((_loc24_ = Math.atan2(_loc23_,_loc18_) - Math.atan2(_loc22_,_loc17_) - (_loc5_ - Math.atan2(_loc16_.c,_loc16_.a))) > 3.141592653589793)
               {
                  _loc24_ -= 3.141592653589793 * 2;
               }
               else if(_loc24_ < -3.141592653589793)
