package spine.animation
{
   ...
   public class AnimationState
   {
      ...
      {
         var data:AnimationStateData = param1;
      ...
      private function updateMixingFrom(param1:TrackEntry, param2:Number) : void
      {
         ...
         _loc3_.animationLast = _loc3_.nextAnimationLast;
         _loc3_.trackLast = _loc3_.nextTrackLast;
         _loc3_.trackTime += param2 * _loc3_.timeScale;
         param1.mixTime += param2 * param1.timeScale;
      }
      ...
      public function apply(param1:Skeleton) : void
      {
         ...
         while(_loc4_ < _loc5_)
         {
            if(!((_loc6_ = tracks[_loc4_]) == null || _loc6_.delay > 0))
            {
               _loc14_ = Number(_loc6_.alpha);
               if(_loc6_.mixingFrom != null)
               {
                  _loc14_ *= applyMixingFrom(_loc6_,param1);
               }
               ...
               {
                  if(_loc8_ = _loc6_.timelinesRotation.length == 0)
                  {
                  ...
                  while(_loc3_ < _loc9_)
                  {
                     if((_loc12_ = _loc7_[_loc3_]) is RotateTimeline)
                     {
      ...
      private function applyMixingFrom(param1:TrackEntry, param2:Skeleton) : Number
      {
         ...
         var _loc15_:TrackEntry;
         if((_loc15_ = param1.mixingFrom).mixingFrom != null)
         {
         ...
         else if((_loc17_ = Number(param1.mixTime / param1.mixDuration)) > 1)
         {
            _loc17_ = 1;
         }
         ...
         var _loc8_:*;
         if(_loc8_ = _loc15_.timelinesRotation.length == 0)
         {
      ...
      private function applyRotateTimeline(param1:Timeline, param2:Skeleton, param3:Number, param4:Number, param5:Boolean, param6:Vector.<Number>, param7:int, param8:Boolean) : void
      {
         ...
         var _loc13_:RotateTimeline;
         var _loc11_:Vector.<Number> = (_loc13_ = RotateTimeline(param1)).frames;
         ...
         else
         {
            ...
            _loc9_ = (_loc9_ = _loc11_[_loc22_ + 1] - _loc21_) - (16384 - (int(16384.499999999996 - _loc9_ / 360))) * 360;
            _loc9_ = (_loc9_ = _loc21_ + _loc9_ * _loc17_ + _loc14_.data.rotation) - (16384 - (int(16384.499999999996 - _loc9_ / 360))) * 360;
         }
         var _loc23_:Number = !!param5 ? _loc14_.data.rotation : Number(_loc14_.rotation);
         var _loc15_:Number;
         if((_loc15_ = _loc9_ - _loc23_) == 0)
         {
            _loc19_ = param6[param7];
         }
         else
         {
            _loc15_ -= (16384 - (int(16384.499999999996 - _loc15_ / 360))) * 360;
            if(param8)
            {
               _loc18_ = 0;
               _loc10_ = _loc15_;
            ...
            if(MathUtils.signum(_loc10_) != MathUtils.signum(_loc15_) && Math.abs(_loc10_) <= 90)
            {
               ...
               {
                  _loc18_ += 360 * MathUtils.signum(_loc18_);
               }
               _loc16_ = _loc20_;
            }
            ...
            if(_loc16_ != _loc20_)
            {
               _loc19_ += 360 * MathUtils.signum(_loc18_);
            }
            param6[param7] = _loc19_;
         }
         param6[param7 + 1] = _loc15_;
         _loc23_ += _loc19_ * param4;
         _loc14_.rotation = _loc23_ - (16384 - (int(16384.499999999996 - _loc23_ / 360))) * 360;
      }
      ...
      private function queueEvents(param1:TrackEntry, param2:Number) : void
      {
         ...
         var _loc10_:Number;
         var _loc3_:Number = (_loc10_ = param1.animationEnd) - _loc6_;
         ...
         while(_loc5_ < _loc9_)
         {
            if((_loc7_ = _loc8_[_loc5_]).time < _loc4_)
            {
               break;
            }
         ...
         while(_loc5_ < _loc9_)
         {
            if((_loc7_ = _loc8_[_loc5_]).time >= _loc6_)
            {
      ...
      public function clearTrack(param1:int) : void
      {
         ...
         disposeNext(_loc3_);
         var _loc2_:* = _loc3_;
         while((_loc4_ = _loc2_.mixingFrom) != null)
         {
            queue.end(_loc4_);
      ...
      private function setCurrent(param1:int, param2:TrackEntry, param3:Boolean) : void
      {
         ...
         if(_loc4_ != null)
         {
            ...
            {
               param2.mixAlpha *= Math.min(_loc4_.mixTime / _loc4_.mixDuration,1);
            }
         }
         queue.start(param2);
      }
      ...
      public function setAnimationByName(param1:int, param2:String, param3:Boolean) : TrackEntry
      {
         ...
         if((_loc4_ = data.skeletonData.findAnimation(param2)) == null)
         {
      ...
      public function setAnimation(param1:int, param2:Animation, param3:Boolean) : TrackEntry
      {
         ...
         var _loc5_:TrackEntry;
         if((_loc5_ = expandToIndex(param1)) != null)
         {
      ...
      {
         var _loc5_:Animation;
         if((_loc5_ = data.skeletonData.findAnimation(param2)) == null)
         {
            throw new ArgumentError("Animation not found: " + param2);
         }
      ...
      public function addAnimation(param1:int, param2:Animation, param3:Boolean, param4:Number) : TrackEntry
      {
         ...
         var _loc7_:TrackEntry;
         if((_loc7_ = expandToIndex(param1)) != null)
         {
         ...
         else
         {
            ...
            if(param4 <= 0)
            {
               if((_loc5_ = _loc7_.animationEnd - _loc7_.animationStart) != 0)
               {
                  param4 += _loc5_ * (1 + int(_loc7_.trackTime / _loc5_)) - data.getMix(_loc7_.animation,param2);
               }
               else
               {
                  param4 = 0;
      ...
      public function addEmptyAnimation(param1:int, param2:Number, param3:Number) : TrackEntry
      {
         ...
         var _loc4_:TrackEntry;
         (_loc4_ = addAnimation(param1,emptyAnimation,false,param3)).mixDuration = param2;
      ...
      {
         var _loc5_:TrackEntry;
         (_loc5_ = TrackEntry(trackEntryPool.obtain())).trackIndex = param1;
      ...
      private function _animationsChanged() : void
      {
         ...
         var _loc2_:* = this.propertyIDs = new Dictionary();
         var _loc3_:int = 0;
