   ...
   public class ColorTimeline extends CurveTimeline
   {
      ...
      override public function apply(param1:Skeleton, param2:Number, param3:Number, param4:Vector.<Event>, param5:Number, param6:Boolean, param7:Boolean) : void
      {
         ...
         else
         {
            ...
            _loc16_ += (_loc10_[_loc17_ + 1] - _loc16_) * _loc15_;
            _loc11_ += (_loc10_[_loc17_ + 2] - _loc11_) * _loc15_;
            _loc9_ += (_loc10_[_loc17_ + 3] - _loc9_) * _loc15_;
            _loc8_ += (_loc10_[_loc17_ + 4] - _loc8_) * _loc15_;
         }
         if(param5 == 1)
         {
            _loc14_.r = _loc16_;
         ...
         else
         {
            ...
            _loc14_.r += (_loc16_ - _loc14_.r) * param5;
            _loc14_.g += (_loc11_ - _loc14_.g) * param5;
            _loc14_.b += (_loc9_ - _loc14_.b) * param5;
            _loc14_.a += (_loc8_ - _loc14_.a) * param5;
         }
      }
   }
}
