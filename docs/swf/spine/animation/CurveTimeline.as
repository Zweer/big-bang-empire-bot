package spine.animation
{
   ...
   public class CurveTimeline implements Timeline
   {
      ...
      public function setCurve(param1:int, param2:Number, param3:Number, param4:Number, param5:Number) : void
      {
         ...
         (_loc10_ = this.curves)[int(_loc8_++)] = 2;
         var _loc15_:* = _loc14_;
         var _loc16_:* = _loc12_;
         _loc9_ = _loc8_ + 19 - 1;
         while(_loc8_ < _loc9_)
      ...
      public function getCurvePercent(param1:int, param2:Number) : Number
      {
         ...
         {
            if((_loc4_ = Number(_loc3_[_loc6_])) >= param2)
            {
               if(_loc6_ == _loc5_)
               {
                  _loc9_ = 0;
         ...
         var _loc8_:Number;
         return (_loc8_ = _loc3_[int(_loc6_ - 1)]) + (1 - _loc8_) * (param2 - _loc4_) / (1 - _loc4_);
      }
   }
}
