   ...
   public class TransformConstraintTimeline extends CurveTimeline
   {
      ...
      override public function apply(param1:Skeleton, param2:Number, param3:Number, param4:Vector.<Event>, param5:Number, param6:Boolean, param7:Boolean) : void
      {
         ...
         else
         {
            ...
            _loc8_ += (_loc9_[_loc18_ + 1] - _loc8_) * _loc15_;
            _loc16_ += (_loc9_[_loc18_ + 2] - _loc16_) * _loc15_;
            _loc13_ += (_loc9_[_loc18_ + 3] - _loc13_) * _loc15_;
            _loc11_ += (_loc9_[_loc18_ + 4] - _loc11_) * _loc15_;
         }
         if(param6)
         {
            _loc10_ = _loc17_.data;
         ...
         {
            _loc17_.rotateMix += (_loc8_ - _loc17_.rotateMix) * param5;
            _loc17_.translateMix += (_loc16_ - _loc17_.translateMix) * param5;
            _loc17_.scaleMix += (_loc13_ - _loc17_.scaleMix) * param5;
            _loc17_.shearMix += (_loc11_ - _loc17_.shearMix) * param5;
         }
      }
   }
}
