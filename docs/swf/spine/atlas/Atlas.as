package spine.atlas
{
   ...
   public class Atlas
   {
      ...
      protected function load(param1:String, param2:TextureLoader) : void
      {
         ...
         while((_loc5_ = _loc4_.readLine()) != null)
         {
            if((_loc5_ = _loc4_.trim(_loc5_)).length == 0)
            {
               _loc9_ = null;
            }
            else if(!_loc9_)
            {
               (_loc9_ = new AtlasPage()).name = _loc5_;
               ...
               {
                  _loc9_.uWrap = _loc9_.vWrap = TextureWrap.repeat;
               }
            ...
            {
               (_loc10_ = new AtlasRegion()).name = _loc5_;
               _loc10_.page = _loc9_;
