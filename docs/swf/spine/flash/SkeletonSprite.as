package spine.flash
{
   ...
   public class SkeletonSprite extends Sprite
   {
      ...
      public function advanceTime(param1:Number) : void
      {
         ...
         {
            _loc2_ = (_loc7_ = _loc13_[_loc4_]).attachment as RegionAttachment;
            if(_loc2_)
            {
               if(!(_loc5_ = wrappers[_loc2_]))
               {
                  _loc16_ = !!(_loc18_ = AtlasRegion(_loc2_.rendererObject)).rotate ? _loc18_.width : int(_loc18_.height);
                  if(!(_loc10_ = _loc18_.rendererObject as BitmapData))
                  {
                     _loc12_ = _loc18_.page.rendererObject as BitmapData;
                     _loc8_ = !!_loc18_.rotate ? _loc18_.height : int(_loc18_.width);
                     (_loc10_ = new BitmapData(_loc8_,_loc16_)).copyPixels(_loc12_,new Rectangle(_loc18_.x,_loc18_.y,_loc8_,_loc16_),new Point());
                     _loc18_.rendererObject = _loc10_;
                  }
                  (_loc14_ = new Bitmap(_loc10_)).smoothing = true;
                  ...
                  _loc9_ = -_loc2_.rotation * 3.141592653589793 / 180;
