package starling.display
{
   ...
   public class DisplayObject extends EventDispatcher
   {
      ...
      public function drawToBitmapData(param1:BitmapData = null, param2:uint = 0, param3:Number = 0.0) : BitmapData
      {
         ...
         {
            _loc6_ = (_loc14_ = getBounds(_parent,sHelperRect)).x;
            _loc7_ = _loc14_.y;
            if(!param1)
            {
      ...
      public function set transformationMatrix(param1:Matrix) : void
      {
         ...
         _scaleY = _skewX > -0.7853981633974483 && _skewX < 0.7853981633974483 ? param1.d / Math.cos(_skewX) : Number(-param1.c / Math.sin(_skewX));
         _scaleX = _skewY > -0.7853981633974483 && _skewY < 0.7853981633974483 ? param1.a / Math.cos(_skewY) : Number(param1.b / Math.sin(_skewY));
      ...
      public function set width(param1:Number) : void
      {
         ...
         var _loc3_:Boolean = _scaleX < 1e-8 && _scaleX > -1e-8;
         if(_loc3_ || _loc4_)
         {
            scaleX = 1;
            _loc2_ = width;
      ...
      public function set height(param1:Number) : void
      {
         ...
         var _loc3_:Boolean = _scaleY < 1e-8 && _scaleY > -1e-8;
         if(_loc3_ || _loc4_)
         {
            scaleY = 1;
            _loc2_ = height;
