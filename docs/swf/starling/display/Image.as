package starling.display
{
   ...
   public class Image extends Quad
   {
      ...
      public static function bindScale9GridToTexture(param1:Texture, param2:Rectangle) : void
      {
         ...
         var scale9Grid:Rectangle = param2;
      ...
      private function setupScale9Grid() : void
      {
         ...
         _loc1_ = (_loc10_ = setupScale9GridAttributes(sPadding.left,sPadding.top,sPosCols,sPosRows,sTexCols,sTexRows)) / 4;
      ...
      private function setupTileGrid() : void
      {
         ...
         var _loc21_:* = 0;
         var _loc17_:Texture;
         var _loc32_:Rectangle = (_loc17_ = this.texture).frame;
         var _loc20_:VertexData = this.vertexData;
         var _loc4_:IndexData = this.indexData;
         var _loc28_:Rectangle = getBounds(this,sBounds);
         var _loc13_:int;
         var _loc1_:uint = !!(_loc13_ = _loc20_.numVertices) ? _loc20_.getColor(0) : 16777215;
...
class SetupAutomator
{
   ...
   public function remove(param1:Function, param2:Function) : void
   {
      ...
      if(param2 != null)
      {
         if((_loc4_ = _onRelease.indexOf(param2)) != -1)
         {
