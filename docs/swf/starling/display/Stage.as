package starling.display
{
   ...
   public class Stage extends DisplayObjectContainer
   {
      ...
      public function getScreenBounds(param1:DisplayObject, param2:Rectangle = null) : Rectangle
      {
         var _loc9_:Starling;
         if((_loc9_ = this.starling) == null)
         {
            return getStageBounds(param1,param2);
         }
         if(param2 == null)
         {
            param2 = new Rectangle();
         }
         var _loc4_:Object = _loc9_.nativeStage;
         var _loc6_:Rectangle = _loc9_.viewPort;
         var _loc3_:Number = _width / _loc6_.width;
         var _loc5_:Number = _height / _loc6_.height;
         var _loc7_:Number = -_loc6_.x * _loc3_;
         var _loc8_:Number = -_loc6_.y * _loc5_;
         param2.setTo(_loc7_,_loc8_,_loc4_.stageWidth * _loc3_,_loc4_.stageHeight * _loc5_);
         getTransformationMatrix(param1,sMatrix);
         return RectangleUtil.getBounds(param2,sMatrix,param2);
      }
