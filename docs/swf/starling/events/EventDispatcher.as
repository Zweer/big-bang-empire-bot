package starling.events
{
   ...
   public class EventDispatcher
   {
      ...
      public function addEventListener(param1:String, param2:Function) : void
      {
         ...
         var _loc3_:Array = _eventListeners[param1] as Array;
         if(_loc3_ == null)
         {
            _eventListeners[param1] = [param2];
         }
      ...
      public function removeEventListener(param1:String, param2:Function) : void
      {
         ...
         if(_eventListeners)
         {
            _loc3_ = _eventListeners[param1] as Array;
      ...
      function invokeEvent(param1:Event) : Boolean
      {
         ...
         var _loc5_:* = null;
         var _loc2_:int = 0;
         var _loc3_:Array = !!_eventListeners ? _eventListeners[param1.type] as Array : null;
         var _loc4_:int;
         if(_loc4_ = _loc3_ == null ? 0 : _loc3_.length)
         {
            if(_eventStack === null)
            {
               _eventStack = new Vector.<String>(0);
      ...
      {
         var _loc3_:Array = !!_eventListeners ? _eventListeners[param1] as Array : null;
         if(_loc3_ == null)
         {
            return false;
         }
