package starling.text
{
   ...
   public class BitmapFont implements ITextCompositor
   {
      ...
      protected function parseFontXml(param1:XML) : void
      {
         ...
         var _loc17_:Rectangle;
         var _loc7_:Number = !!(_loc17_ = _texture.frame) ? _loc17_.x : 0;
         ...
         for each(var _loc11_ in param1.chars.char)
         {
            ...
            (_loc15_ = new Rectangle()).x = parseFloat(_loc11_.@x) / _loc6_ + _loc7_;
      ...
      public function createSprite(param1:Number, param2:Number, param3:String, param4:TextFormat, param5:TextOptions = null) : Sprite
      {
         ...
         var _loc10_:* = null;
         var _loc8_:* = null;
         var _loc6_:Vector.<BitmapCharLocation>;
         var _loc12_:int = (_loc6_ = arrangeChars(param1,param2,param3,param4,param5)).length;
         var _loc11_:String = this.smoothing;
         var _loc7_:Sprite = new Sprite();
         _loc9_ = 0;
         while(_loc9_ < _loc12_)
         {
            (_loc8_ = (_loc10_ = _loc6_[_loc9_]).char.createImage()).x = _loc10_.x;
            _loc8_.y = _loc10_.y;
      ...
      public function fillMeshBatch(param1:MeshBatch, param2:Number, param3:Number, param4:String, param5:TextFormat, param6:TextOptions = null) : void
      {
         var _loc8_:int = 0;
         var _loc9_:* = null;
         var _loc7_:Vector.<BitmapCharLocation>;
         var _loc10_:int = (_loc7_ = arrangeChars(param2,param3,param4,param5,param6)).length;
      ...
      public function getDefaultMeshStyle(param1:MeshStyle, param2:TextFormat, param3:TextOptions) : MeshStyle
      {
         ...
         (_loc4_ = param1 as DistanceFieldStyle || new DistanceFieldStyle()).multiChannel = _type == "multiChannelDistanceField";
      ...
      public function arrangeChars(param1:Number, param2:Number, param3:String, param4:TextFormat, param5:TextOptions) : Vector.<BitmapCharLocation>
      {
            ...
            if(_size <= _loc35_)
            {
               ...
               while(_loc28_ < _loc32_)
               {
                  ...
                  else
                  {
                     ...
                     if(_loc6_)
                     {
                        _loc36_ += _loc38_.getKerning(_loc37_);
                     }
                     (_loc39_ = BitmapCharLocation.instanceFromPool(_loc38_)).index = _loc28_;
                     _loc39_.x = _loc36_ + _loc38_.xOffset;
                     _loc39_.y = _loc15_ + _loc38_.yOffset;
                     _loc20_[_loc20_.length] = _loc39_;
                     _loc36_ += _loc38_.xAdvance + _loc19_;
                     _loc37_ = _loc25_;
         ...
         {
            if((_loc32_ = (_loc12_ = sLines[_loc14_]).length) != 0)
            {
               _loc22_ = 0;
               _loc31_ = (_loc27_ = _loc12_[_loc12_.length - 1]).x - _loc27_.char.xOffset + _loc27_.char.xAdvance;
               if(_loc8_ == "right")
               {
               ...
               {
                  (_loc39_ = _loc12_[_loc23_]).x = _loc13_ * (_loc39_.x + _loc22_ + _offsetX) + _padding;
