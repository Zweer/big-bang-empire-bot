package starling.utils
{
   ...
   public class AssetManager extends EventDispatcher
   {
      ...
      public function dispose() : void
      {
         ...
         for each(var _loc5_ in _bitmapFonts)
         {
            _loc5_.dispose();
         }
      }
      ...
      public function addTextureAtlas(param1:String, param2:TextureAtlas) : void
      {
         ...
         if(param1 in _atlases && param2 != _atlases[param1])
         {
      ...
      public function addSound(param1:String, param2:Sound) : void
      {
         ...
         if(param1 in _sounds && param2 != _sounds[param1])
         {
      ...
      public function addXml(param1:String, param2:XML) : void
      {
         ...
         if(param1 in _xmls && param2 != _xmls[param1])
         {
      ...
      public function addObject(param1:String, param2:Object) : void
      {
         ...
         if(param1 in _objects && param2 != _objects[param1])
         {
      ...
      public function addByteArray(param1:String, param2:ByteArray) : void
      {
         ...
         if(param1 in _byteArrays && param2 != _byteArrays[param1])
         {
      ...
      {
         log("Adding bitmap font \'" + param1 + "\'");
         if(param1 in _bitmapFonts && param2 != _bitmapFonts[param1])
         {
            log("Warning: name was already in use; the previous font will be replaced.");
            _bitmapFonts[param1].dispose();
         }
         _bitmapFonts[param1] = param2;
      }
      ...
      {
         log("Removing bitmap font \'" + param1 + "\'");
         if(param2 && param1 in _bitmapFonts)
         {
            _bitmapFonts[param1].dispose();
         }
         delete _bitmapFonts[param1];
      }
      ...
      public function loadQueue(param1:Function) : void
      {
         ...
         var processXml:* = function(param1:int):void
         {
            ...
            var _loc5_:XML;
            var _loc8_:String = (_loc5_ = xmls[param1]).localName();
            var _loc3_:Number = (param1 + 1) / (xmls.length + 1);
            if(_loc8_ == "TextureAtlas")
            {
               _loc6_ = getName(_loc5_.@imagePath.toString());
               if(_loc4_ = getTexture(_loc6_))
               {
                  addTextureAtlas(_loc6_,new TextureAtlas(_loc4_,_loc5_));
               }
               else
               {
                  log("Cannot create atlas: texture \'" + _loc6_ + "\' is missing.");
               }
               if(_keepAtlasXmls)
               {
                  addXml(_loc6_,_loc5_);
               }
               else
               {
            ...
            else
            {
               if(_loc8_ != "font")
               {
                  throw new Error("XML contents not recognized: " + _loc8_);
               }
               if(_loc4_ = getTexture(_loc2_ = getName(_loc5_.pages.page.@file.toString())))
               {
                  _loc7_ = new ExtendedBitmapFont(assetManager,_loc4_,_loc5_);
                  addBitmapFont(_loc2_,_loc7_);
                  TextField.registerCompositor(_loc7_,_loc2_);
               }
               else
               {
                  log("Cannot create bitmap font: texture \'" + _loc6_ + "\' is missing.");
               }
               if(_keepFontXmls)
               {
                  addXml(_loc6_,_loc5_);
            ...
            onProgress(0.9 + 0.09999999999999998 * _loc3_);
      ...
      private function byteArrayStartsWith(param1:ByteArray, param2:String) : Boolean
      {
         ...
         while(_loc7_ < _loc6_)
         {
            if(!((_loc4_ = param1[_loc7_]) == 0 || _loc4_ == 10 || _loc4_ == 13 || _loc4_ == 32))
            {
