package starling.utils
{
   ...
   public class RenderUtil
   {
      ...
      public static function clear(param1:uint = 0, param2:Number = 0.0, param3:Number = 1.0, param4:uint = 0) : void
      {
      ...
      public static function requestContext3D(param1:Stage3D, param2:String, param3:*) : void
      {
         ...
         if(profile == "auto")
         {
            var profiles:Array = ["enhanced","standardExtended","standard","standardConstrained","baselineExtended","baseline","baselineConstrained"];
         }
