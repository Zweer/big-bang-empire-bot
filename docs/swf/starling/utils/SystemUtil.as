   ...
   public class SystemUtil
   {
      ...
      public static function initialize() : void
      {
         ...
         try
         {
            ...
            sSupportsDepthAndStencil = (_loc5_ = _loc1_._loc2_::initialWindow._loc2_::depthAndStencil.toString().toLowerCase()) == "true";
            sAIR = true;
         }
         catch(e:Error)
         {
      ...
      public static function isEmbeddedFont(param1:String, param2:Boolean = false, param3:Boolean = false, param4:String = "embedded") : Boolean
      {
         ...
         {
            _loc7_ = (_loc6_ = _loc8_.fontStyle) == "bold" || _loc6_ == "boldItalic";
