package visuals.dungeon_paths
{
   ...
   public class SymbolDungeon1_1PathGeneric extends Sprite
   {
       
      
      private var _nativeObject:SymbolDungeon1_1Path = null;
      ...
      public var step3_4:SymbolDungeonPathStepGeneric = null;
      ...
      public function SymbolDungeon1_1PathGeneric(param1:MovieClip = null)
      {
         if(param1)
         {
            _nativeObject = param1 as SymbolDungeon1_1Path;
         }
         else
         {
            _nativeObject = new SymbolDungeon1_1Path();
         }
         ...
         step3_4 = new SymbolDungeonPathStepGeneric(_nativeObject.step3_4);
      ...
      public function setNativeInstance(param1:SymbolDungeon1_1Path) : void
      {
      ...
      public function syncInstances() : void
      {
         ...
         if(_nativeObject.step3_4)
         {
            step3_4.setNativeInstance(_nativeObject.step3_4);
         }
