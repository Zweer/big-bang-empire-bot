package visuals.dungeon_paths
{
   ...
   public class SymbolDungeon3_2PathGeneric extends Sprite
   {
       
      
      private var _nativeObject:SymbolDungeon3_2Path = null;
      ...
      public var step6_7:SymbolDungeonPathStepGeneric = null;
      ...
      public function SymbolDungeon3_2PathGeneric(param1:MovieClip = null)
      {
         if(param1)
         {
            _nativeObject = param1 as SymbolDungeon3_2Path;
         }
         else
         {
            _nativeObject = new SymbolDungeon3_2Path();
         }
         ...
         step6_7 = new SymbolDungeonPathStepGeneric(_nativeObject.step6_7);
      ...
      public function setNativeInstance(param1:SymbolDungeon3_2Path) : void
      {
      ...
      public function syncInstances() : void
      {
         ...
         if(_nativeObject.step6_7)
         {
            step6_7.setNativeInstance(_nativeObject.step6_7);
         }
