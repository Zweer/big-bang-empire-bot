package visuals.ui.base
{
   ...
   public class SymbolUiButtonDefaultCheckGeneric extends Sprite
   {
       
      
      private var _nativeObject:SymbolUiButtonDefaultCheck = null;
      ...
      public function SymbolUiButtonDefaultCheckGeneric(param1:MovieClip = null)
      {
         if(param1)
         {
            _nativeObject = param1 as SymbolUiButtonDefaultCheck;
         }
         else
         {
            _nativeObject = new SymbolUiButtonDefaultCheck();
         }
      ...
      public function setNativeInstance(param1:SymbolUiButtonDefaultCheck) : void
      {
