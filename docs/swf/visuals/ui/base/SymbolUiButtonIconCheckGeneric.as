package visuals.ui.base
{
   ...
   public class SymbolUiButtonIconCheckGeneric extends Sprite
   {
       
      
      private var _nativeObject:SymbolUiButtonIconCheck = null;
      ...
      public function SymbolUiButtonIconCheckGeneric(param1:MovieClip = null)
      {
         if(param1)
         {
            _nativeObject = param1 as SymbolUiButtonIconCheck;
         }
         else
         {
            _nativeObject = new SymbolUiButtonIconCheck();
         }
      ...
      public function setNativeInstance(param1:SymbolUiButtonIconCheck) : void
      {
