package visuals.ui.base
{
   ...
   public class SymbolUiButtonIconDeleteGeneric extends Sprite
   {
       
      
      private var _nativeObject:SymbolUiButtonIconDelete = null;
      ...
      public function SymbolUiButtonIconDeleteGeneric(param1:MovieClip = null)
      {
         if(param1)
         {
            _nativeObject = param1 as SymbolUiButtonIconDelete;
         }
         else
         {
            _nativeObject = new SymbolUiButtonIconDelete();
         }
      ...
      public function setNativeInstance(param1:SymbolUiButtonIconDelete) : void
      {
