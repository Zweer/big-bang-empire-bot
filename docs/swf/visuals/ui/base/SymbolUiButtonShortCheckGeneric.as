package visuals.ui.base
{
   ...
   public class SymbolUiButtonShortCheckGeneric extends Sprite
   {
       
      
      private var _nativeObject:SymbolUiButtonShortCheck = null;
      ...
      public function SymbolUiButtonShortCheckGeneric(param1:MovieClip = null)
      {
         if(param1)
         {
            _nativeObject = param1 as SymbolUiButtonShortCheck;
         }
         else
         {
            _nativeObject = new SymbolUiButtonShortCheck();
         }
      ...
      public function setNativeInstance(param1:SymbolUiButtonShortCheck) : void
      {
