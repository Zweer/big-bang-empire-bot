package visuals.ui.base
{
   ...
   public class SymbolUiButtonWideGeneric extends Sprite
   {
       
      
      private var _nativeObject:SymbolUiButtonWide = null;
      
      public var bg:SymbolSlice9BackgroundButtonGeneric = null;
      
      public var caption:ILabel = null;
      
      public function SymbolUiButtonWideGeneric(param1:MovieClip = null)
      {
         if(param1)
         {
            _nativeObject = param1 as SymbolUiButtonWide;
         }
         else
         {
            _nativeObject = new SymbolUiButtonWide();
         }
      ...
      public function setNativeInstance(param1:SymbolUiButtonWide) : void
      {
