package visuals.ui.dialogs
{
   ...
   public class SymbolDialogAccountSettingsGeneric extends Sprite
   {
      ...
      public var btnOptOutMarketing:SymbolUiButtonWideGeneric = null;
      ...
      public function SymbolDialogAccountSettingsGeneric(param1:MovieClip = null)
      {
         ...
         btnOptOutMarketing = new SymbolUiButtonWideGeneric(_nativeObject.btnOptOutMarketing);
      ...
      public function syncInstances() : void
      {
         ...
         if(_nativeObject.btnOptOutMarketing)
         {
            btnOptOutMarketing.setNativeInstance(_nativeObject.btnOptOutMarketing);
         }
