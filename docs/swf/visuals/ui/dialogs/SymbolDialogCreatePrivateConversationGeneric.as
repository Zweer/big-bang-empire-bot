package visuals.ui.dialogs
{
   ...
   public class SymbolDialogCreatePrivateConversationGeneric extends Sprite
   {
      ...
      public var receiverAutoComplete:SymbolMailReceiverAutoCompleteGeneric = null;
      ...
      public function SymbolDialogCreatePrivateConversationGeneric(param1:MovieClip = null)
      {
         ...
         receiverAutoComplete = new SymbolMailReceiverAutoCompleteGeneric(_nativeObject.receiverAutoComplete);
      }
      ...
      public function syncInstances() : void
      {
         ...
         if(_nativeObject.receiverAutoComplete)
         {
            receiverAutoComplete.setNativeInstance(_nativeObject.receiverAutoComplete);
         }
      }
   }
}
