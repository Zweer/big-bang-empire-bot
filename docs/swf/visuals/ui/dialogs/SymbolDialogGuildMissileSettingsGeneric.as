package visuals.ui.dialogs
{
   ...
   public class SymbolDialogGuildMissileSettingsGeneric extends Sprite
   {
       
      
      private var _nativeObject:SymbolDialogGuildMissileSettings = null;
      ...
      public var symbolIconGuildMissileBig:SymbolIconGuildMissileBigGeneric = null;
      
      public function SymbolDialogGuildMissileSettingsGeneric(param1:MovieClip = null)
      {
         if(param1)
         {
            _nativeObject = param1 as SymbolDialogGuildMissileSettings;
         }
         else
         {
            _nativeObject = new SymbolDialogGuildMissileSettings();
         }
         ...
         symbolIconGuildMissileBig = new SymbolIconGuildMissileBigGeneric(_nativeObject.symbolIconGuildMissileBig);
      }
      
      public function setNativeInstance(param1:SymbolDialogGuildMissileSettings) : void
      {
      ...
      public function syncInstances() : void
      {
         ...
         if(_nativeObject.symbolIconGuildMissileBig)
         {
            symbolIconGuildMissileBig.setNativeInstance(_nativeObject.symbolIconGuildMissileBig);
         }
      }
   }
}
