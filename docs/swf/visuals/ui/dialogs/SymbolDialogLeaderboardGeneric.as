package visuals.ui.dialogs
{
   ...
   public class SymbolDialogLeaderboardGeneric extends Sprite
   {
      ...
      public var tournamentContent:SymbolLeaderboardTournamentContentGeneric = null;
      ...
      public var btnTabTournament:SymbolButtonTabGeneric = null;
      ...
      public function SymbolDialogLeaderboardGeneric(param1:MovieClip = null)
      {
         ...
         tournamentContent = new SymbolLeaderboardTournamentContentGeneric(_nativeObject.tournamentContent);
         ...
         btnTabTournament = new SymbolButtonTabGeneric(_nativeObject.btnTabTournament);
      ...
      public function syncInstances() : void
      {
         ...
         if(_nativeObject.tournamentContent)
         {
            tournamentContent.setNativeInstance(_nativeObject.tournamentContent);
         }
         ...
         if(_nativeObject.btnTabTournament)
         {
            btnTabTournament.setNativeInstance(_nativeObject.btnTabTournament);
         }
