package visuals.ui.dialogs
{
   ...
   public class SymbolDialogOutfitRenameGeneric extends Sprite
   {
       
      
      private var _nativeObject:SymbolDialogOutfitRename = null;
      ...
      public function SymbolDialogOutfitRenameGeneric(param1:MovieClip = null)
      {
         if(param1)
         {
            _nativeObject = param1 as SymbolDialogOutfitRename;
         }
         else
         {
            _nativeObject = new SymbolDialogOutfitRename();
         }
      ...
      public function setNativeInstance(param1:SymbolDialogOutfitRename) : void
      {
