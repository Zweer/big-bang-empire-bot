package visuals.ui.dialogs
{
   ...
   public class SymbolDialogQuestCompleteGeneric extends Sprite
   {
      ...
      public var txtUserStoryVotingCaption:ILabel = null;
      
      public var userStoryVoting:SymbolUserStoryVotingGeneric = null;
      ...
      public function SymbolDialogQuestCompleteGeneric(param1:MovieClip = null)
      {
         ...
         txtUserStoryVotingCaption = FlashLabel.fromNative(_nativeObject.txtUserStoryVotingCaption);
         userStoryVoting = new SymbolUserStoryVotingGeneric(_nativeObject.userStoryVoting);
      }
      ...
      public function syncInstances() : void
      {
         ...
         FlashLabel.setNativeInstance(txtUserStoryVotingCaption,_nativeObject.txtUserStoryVotingCaption);
         if(_nativeObject.userStoryVoting)
         {
            userStoryVoting.setNativeInstance(_nativeObject.userStoryVoting);
         }
      }
   }
}
