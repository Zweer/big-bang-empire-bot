package visuals.ui.dialogs
{
   ...
   import visuals.ui.elements.icons.SymbolIconDialogTitlesGeneric;
   ...
   public class SymbolDialogTitlesGeneric extends Sprite
   {
      ...
      public var title11:SymbolTitleLineGeneric = null;
      ...
      public var icon:SymbolIconDialogTitlesGeneric = null;
      
      public var titleFilter:SymbolTitlesFilterGeneric = null;
      ...
      public function SymbolDialogTitlesGeneric(param1:MovieClip = null)
      {
         ...
         title11 = new SymbolTitleLineGeneric(_nativeObject.title11);
         ...
         icon = new SymbolIconDialogTitlesGeneric(_nativeObject.icon);
         titleFilter = new SymbolTitlesFilterGeneric(_nativeObject.titleFilter);
      ...
      public function syncInstances() : void
      {
         ...
         if(_nativeObject.title11)
         {
            title11.setNativeInstance(_nativeObject.title11);
         }
         ...
         if(_nativeObject.titleFilter)
         {
            titleFilter.setNativeInstance(_nativeObject.titleFilter);
         }
