package visuals.ui.elements.battle_skills
{
   ...
   public class SymbolBattleSkillsGeneric extends Sprite
   {
      ...
      public var seasonSkill:SymbolBattleSkillBattleIconGeneric = null;
      ...
      public function SymbolBattleSkillsGeneric(param1:MovieClip = null)
      {
         ...
         seasonSkill = new SymbolBattleSkillBattleIconGeneric(_nativeObject.seasonSkill);
      }
      ...
      public function syncInstances() : void
      {
         ...
         if(_nativeObject.seasonSkill)
         {
            seasonSkill.setNativeInstance(_nativeObject.seasonSkill);
         }
      }
   }
}
