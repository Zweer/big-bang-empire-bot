package visuals.ui.elements.buttons
{
   ...
   public class SymbolButtonOpticalChangeGeneric extends com.playata.framework.display.MovieClip
   {
       
      
      private var _nativeObject:SymbolButtonOpticalChange = null;
      ...
      public function SymbolButtonOpticalChangeGeneric(param1:flash.display.MovieClip = null)
      {
         if(param1)
         {
            _nativeObject = param1 as SymbolButtonOpticalChange;
         }
         else
         {
            _nativeObject = new SymbolButtonOpticalChange();
         }
      ...
      public function setNativeInstance(param1:SymbolButtonOpticalChange) : void
      {
