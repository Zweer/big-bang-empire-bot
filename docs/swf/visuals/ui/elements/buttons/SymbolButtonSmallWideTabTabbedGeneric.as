package visuals.ui.elements.buttons
{
   ...
   public class SymbolButtonSmallWideTabTabbedGeneric extends Sprite
   {
       
      
      private var _nativeObject:SymbolButtonSmallWideTabTabbed = null;
      
      public var symbolButtonTabTabbedBackground:SymbolButtonTabTabbedBackgroundGeneric = null;
      
      public var caption:ILabel = null;
      
      public function SymbolButtonSmallWideTabTabbedGeneric(param1:MovieClip = null)
      {
         if(param1)
         {
            _nativeObject = param1 as SymbolButtonSmallWideTabTabbed;
         }
         else
         {
            _nativeObject = new SymbolButtonSmallWideTabTabbed();
         }
      ...
      public function setNativeInstance(param1:SymbolButtonSmallWideTabTabbed) : void
      {
