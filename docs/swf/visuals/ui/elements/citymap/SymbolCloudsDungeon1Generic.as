package visuals.ui.elements.citymap
{
   ...
   public class SymbolCloudsDungeon1Generic extends Sprite
   {
       
      
      private var _nativeObject:SymbolCloudsDungeon1 = null;
      ...
      public function SymbolCloudsDungeon1Generic(param1:MovieClip = null)
      {
         if(param1)
         {
            _nativeObject = param1 as SymbolCloudsDungeon1;
         }
         else
         {
            _nativeObject = new SymbolCloudsDungeon1();
         }
      ...
      public function setNativeInstance(param1:SymbolCloudsDungeon1) : void
      {
