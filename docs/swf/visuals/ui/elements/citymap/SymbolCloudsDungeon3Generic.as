package visuals.ui.elements.citymap
{
   ...
   public class SymbolCloudsDungeon3Generic extends Sprite
   {
       
      
      private var _nativeObject:SymbolCloudsDungeon3 = null;
      ...
      public function SymbolCloudsDungeon3Generic(param1:MovieClip = null)
      {
         if(param1)
         {
            _nativeObject = param1 as SymbolCloudsDungeon3;
         }
         else
         {
            _nativeObject = new SymbolCloudsDungeon3();
         }
      ...
      public function setNativeInstance(param1:SymbolCloudsDungeon3) : void
      {
