package visuals.ui.elements.citymap
{
   ...
   public class SymbolCloudsLocation2Generic extends Sprite
   {
       
      
      private var _nativeObject:SymbolCloudsLocation2 = null;
      ...
      public function SymbolCloudsLocation2Generic(param1:MovieClip = null)
      {
         if(param1)
         {
            _nativeObject = param1 as SymbolCloudsLocation2;
         }
         else
         {
            _nativeObject = new SymbolCloudsLocation2();
         }
      ...
      public function setNativeInstance(param1:SymbolCloudsLocation2) : void
      {
