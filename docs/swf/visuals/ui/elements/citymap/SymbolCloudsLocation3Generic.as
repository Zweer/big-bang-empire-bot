package visuals.ui.elements.citymap
{
   ...
   public class SymbolCloudsLocation3Generic extends Sprite
   {
       
      
      private var _nativeObject:SymbolCloudsLocation3 = null;
      ...
      public function SymbolCloudsLocation3Generic(param1:MovieClip = null)
      {
         if(param1)
         {
            _nativeObject = param1 as SymbolCloudsLocation3;
         }
         else
         {
            _nativeObject = new SymbolCloudsLocation3();
         }
      ...
      public function setNativeInstance(param1:SymbolCloudsLocation3) : void
      {
