package visuals.ui.elements.citymap
{
   ...
   public class SymbolCloudsLocation4Generic extends Sprite
   {
       
      
      private var _nativeObject:SymbolCloudsLocation4 = null;
      ...
      public function SymbolCloudsLocation4Generic(param1:MovieClip = null)
      {
         if(param1)
         {
            _nativeObject = param1 as SymbolCloudsLocation4;
         }
         else
         {
            _nativeObject = new SymbolCloudsLocation4();
         }
      ...
      public function setNativeInstance(param1:SymbolCloudsLocation4) : void
      {
