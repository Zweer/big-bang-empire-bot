package visuals.ui.elements.citymap
{
   ...
   public class SymbolCloudsLocation5Generic extends Sprite
   {
       
      
      private var _nativeObject:SymbolCloudsLocation5 = null;
      ...
      public function SymbolCloudsLocation5Generic(param1:MovieClip = null)
      {
         if(param1)
         {
            _nativeObject = param1 as SymbolCloudsLocation5;
         }
         else
         {
            _nativeObject = new SymbolCloudsLocation5();
         }
      ...
      public function setNativeInstance(param1:SymbolCloudsLocation5) : void
      {
