package visuals.ui.elements.citymap
{
   ...
   public class SymbolCloudsLocation7Generic extends Sprite
   {
       
      
      private var _nativeObject:SymbolCloudsLocation7 = null;
      ...
      public function SymbolCloudsLocation7Generic(param1:MovieClip = null)
      {
         if(param1)
         {
            _nativeObject = param1 as SymbolCloudsLocation7;
         }
         else
         {
            _nativeObject = new SymbolCloudsLocation7();
         }
      ...
      public function setNativeInstance(param1:SymbolCloudsLocation7) : void
      {
