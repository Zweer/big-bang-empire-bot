package visuals.ui.elements.citymap
{
   ...
   public class SymbolCloudsLocation9Generic extends Sprite
   {
       
      
      private var _nativeObject:SymbolCloudsLocation9 = null;
      ...
      public function SymbolCloudsLocation9Generic(param1:MovieClip = null)
      {
         if(param1)
         {
            _nativeObject = param1 as SymbolCloudsLocation9;
         }
         else
         {
            _nativeObject = new SymbolCloudsLocation9();
         }
      ...
      public function setNativeInstance(param1:SymbolCloudsLocation9) : void
      {
