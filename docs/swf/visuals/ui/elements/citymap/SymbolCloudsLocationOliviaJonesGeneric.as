package visuals.ui.elements.citymap
{
   ...
   public class SymbolCloudsLocationOliviaJonesGeneric extends Sprite
   {
       
      
      private var _nativeObject:SymbolCloudsLocationOliviaJones = null;
      ...
      public function SymbolCloudsLocationOliviaJonesGeneric(param1:MovieClip = null)
      {
         if(param1)
         {
            _nativeObject = param1 as SymbolCloudsLocationOliviaJones;
         }
         else
         {
            _nativeObject = new SymbolCloudsLocationOliviaJones();
         }
      ...
      public function setNativeInstance(param1:SymbolCloudsLocationOliviaJones) : void
      {
