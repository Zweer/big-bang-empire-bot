package visuals.ui.elements.goal
{
   ...
   public class SymbolStoryGoalLocationGeneric extends com.playata.framework.display.MovieClip
   {
       
      
      private var _nativeObject:SymbolStoryGoalLocation = null;
      
      public function SymbolStoryGoalLocationGeneric(param1:flash.display.MovieClip = null)
      {
         if(param1)
         {
            _nativeObject = param1 as SymbolStoryGoalLocation;
         }
         else
         {
            _nativeObject = new SymbolStoryGoalLocation();
         }
         super(null,FlashMovieClip.fromNative(_nativeObject));
         var _loc2_:FlashDisplayObjectContainer = _sprite as FlashDisplayObjectContainer;
      }
      
      public function setNativeInstance(param1:SymbolStoryGoalLocation) : void
      {
