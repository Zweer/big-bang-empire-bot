package visuals.ui.elements.guild
{
   ...
   public class SymbolButtonAppearanceGeneric extends Sprite
   {
       
      
      private var _nativeObject:SymbolButtonAppearance = null;
      
      public var bg:SymbolSlice9BackgroundButtonGeneric = null;
      
      public var caption:ILabel = null;
      
      public function SymbolButtonAppearanceGeneric(param1:MovieClip = null)
      {
         if(param1)
         {
            _nativeObject = param1 as SymbolButtonAppearance;
         }
         else
         {
            _nativeObject = new SymbolButtonAppearance();
         }
      ...
      public function setNativeInstance(param1:SymbolButtonAppearance) : void
      {
