package visuals.ui.elements.guild
{
   ...
   public class SymbolButtonGuildGeneric extends Sprite
   {
       
      
      private var _nativeObject:SymbolButtonGuild = null;
      ...
      public function SymbolButtonGuildGeneric(param1:MovieClip = null)
      {
         if(param1)
         {
            _nativeObject = param1 as SymbolButtonGuild;
         }
         else
         {
            _nativeObject = new SymbolButtonGuild();
         }
      ...
      public function setNativeInstance(param1:SymbolButtonGuild) : void
      {
