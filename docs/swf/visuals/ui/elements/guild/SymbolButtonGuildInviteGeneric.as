package visuals.ui.elements.guild
{
   ...
   public class SymbolButtonGuildInviteGeneric extends Sprite
   {
       
      
      private var _nativeObject:SymbolButtonGuildInvite = null;
      ...
      public function SymbolButtonGuildInviteGeneric(param1:MovieClip = null)
      {
         if(param1)
         {
            _nativeObject = param1 as SymbolButtonGuildInvite;
         }
         else
         {
            _nativeObject = new SymbolButtonGuildInvite();
         }
      ...
      public function setNativeInstance(param1:SymbolButtonGuildInvite) : void
      {
