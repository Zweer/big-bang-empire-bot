package visuals.ui.elements.herobook
{
   ...
   import visuals.ui.elements.season.SymbolSeasonPointRewardGeneric;
   ...
   public class SymbolHerobookInfoGeneric extends Sprite
   {
      ...
      public var seasonPointRewardWide:SymbolSeasonPointRewardWideGeneric = null;
      
      public var seasonPointRewards:SymbolSeasonPointRewardGeneric = null;
      ...
      public function SymbolHerobookInfoGeneric(param1:MovieClip = null)
      {
         ...
         seasonPointRewardWide = new SymbolSeasonPointRewardWideGeneric(_nativeObject.seasonPointRewardWide);
         seasonPointRewards = new SymbolSeasonPointRewardGeneric(_nativeObject.seasonPointRewards);
      ...
      public function syncInstances() : void
      {
         ...
         if(_nativeObject.seasonPointRewardWide)
         {
            seasonPointRewardWide.setNativeInstance(_nativeObject.seasonPointRewardWide);
         }
         if(_nativeObject.seasonPointRewards)
         {
            seasonPointRewards.setNativeInstance(_nativeObject.seasonPointRewards);
         }
