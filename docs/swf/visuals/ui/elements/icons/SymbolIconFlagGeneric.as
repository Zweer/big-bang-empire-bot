package visuals.ui.elements.icons
{
   ...
   public class SymbolIconFlagGeneric extends com.playata.framework.display.MovieClip
   {
       
      
      private var _nativeObject:SymbolIconFlag = null;
      
      public function SymbolIconFlagGeneric(param1:flash.display.MovieClip = null)
      {
         if(param1)
         {
            _nativeObject = param1 as SymbolIconFlag;
         }
         else
         {
            _nativeObject = new SymbolIconFlag();
         }
         super(null,FlashMovieClip.fromNative(_nativeObject));
         var _loc2_:FlashDisplayObjectContainer = _sprite as FlashDisplayObjectContainer;
      }
      
      public function setNativeInstance(param1:SymbolIconFlag) : void
      {
