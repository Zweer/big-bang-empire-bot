package visuals.ui.elements.item
{
   ...
   import visuals.ui.elements.icons.SymbolIconOutfitGeneric;
   ...
   public class SymbolItemSlotGeneric extends Sprite
   {
      ...
      public var iconUsedInOutfit:SymbolIconOutfitGeneric = null;
      ...
      public function SymbolItemSlotGeneric(param1:MovieClip = null)
      {
         ...
         iconUsedInOutfit = new SymbolIconOutfitGeneric(_nativeObject.iconUsedInOutfit);
      ...
      public function syncInstances() : void
      {
         ...
         if(_nativeObject.iconUsedInOutfit)
         {
            iconUsedInOutfit.setNativeInstance(_nativeObject.iconUsedInOutfit);
         }
