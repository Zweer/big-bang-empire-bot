package visuals.ui.elements.movie
{
   ...
   import visuals.ui.elements.season.SymbolSeasonPointRewardMovieTooltipGeneric;
   ...
   public class SymbolMovieStarTooltipRewardGeneric extends Sprite
   {
      ...
      public var txtStreamingResource:ILabelArea = null;
      ...
      public var seasonPointReward:SymbolSeasonPointRewardMovieTooltipGeneric = null;
      ...
      public function SymbolMovieStarTooltipRewardGeneric(param1:MovieClip = null)
      {
         ...
         txtStreamingResource = FlashLabelArea.fromNative(_nativeObject.txtStreamingResource);
         ...
         seasonPointReward = new SymbolSeasonPointRewardMovieTooltipGeneric(_nativeObject.seasonPointReward);
      }
      ...
      public function syncInstances() : void
      {
         ...
         FlashLabelArea.setNativeInstance(txtStreamingResource,_nativeObject.txtStreamingResource);
