package visuals.ui.elements.quest
{
   ...
   public class SymbolQuestBriefingStatsGeneric extends com.playata.framework.display.MovieClip
   {
       
      
      private var _nativeObject:SymbolQuestBriefingStats = null;
      
      public function SymbolQuestBriefingStatsGeneric(param1:flash.display.MovieClip = null)
      {
         if(param1)
         {
            _nativeObject = param1 as SymbolQuestBriefingStats;
         }
         else
         {
            _nativeObject = new SymbolQuestBriefingStats();
         }
         super(null,FlashMovieClip.fromNative(_nativeObject));
         var _loc2_:FlashDisplayObjectContainer = _sprite as FlashDisplayObjectContainer;
      }
      
      public function setNativeInstance(param1:SymbolQuestBriefingStats) : void
      {
