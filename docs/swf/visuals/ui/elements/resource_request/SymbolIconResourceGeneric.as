package visuals.ui.elements.resource_request
{
   ...
   public class SymbolIconResourceGeneric extends com.playata.framework.display.MovieClip
   {
       
      
      private var _nativeObject:SymbolIconResource = null;
      
      public function SymbolIconResourceGeneric(param1:flash.display.MovieClip = null)
      {
         if(param1)
         {
            _nativeObject = param1 as SymbolIconResource;
         }
         else
         {
            _nativeObject = new SymbolIconResource();
         }
         super(null,FlashMovieClip.fromNative(_nativeObject));
         var _loc2_:FlashDisplayObjectContainer = _sprite as FlashDisplayObjectContainer;
      }
      
      public function setNativeInstance(param1:SymbolIconResource) : void
      {
