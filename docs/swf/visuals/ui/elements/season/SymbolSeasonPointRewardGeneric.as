package visuals.ui.elements.season
{
   ...
   public class SymbolSeasonPointRewardGeneric extends Sprite
   {
       
      
      private var _nativeObject:SymbolSeasonPointReward = null;
      
      public var txtValue:ILabel = null;
      
      public var icon:SymbolPlaceholderGeneric = null;
      
      public function SymbolSeasonPointRewardGeneric(param1:MovieClip = null)
      {
         if(param1)
         {
            _nativeObject = param1 as SymbolSeasonPointReward;
         }
         else
         {
            _nativeObject = new SymbolSeasonPointReward();
         }
      ...
      public function setNativeInstance(param1:SymbolSeasonPointReward) : void
      {
