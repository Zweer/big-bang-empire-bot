package visuals.ui.elements.sewing_machine
{
   ...
   public class SymbolSewingMachineContentGeneric extends Sprite
   {
      ...
      public var sewingMachineFilter:SymbolSewingMachineFilterGeneric = null;
      ...
      public function SymbolSewingMachineContentGeneric(param1:MovieClip = null)
      {
         ...
         sewingMachineFilter = new SymbolSewingMachineFilterGeneric(_nativeObject.sewingMachineFilter);
      ...
      public function syncInstances() : void
      {
         ...
         if(_nativeObject.sewingMachineFilter)
         {
            sewingMachineFilter.setNativeInstance(_nativeObject.sewingMachineFilter);
         }
