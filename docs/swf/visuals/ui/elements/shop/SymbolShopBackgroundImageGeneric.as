package visuals.ui.elements.shop
{
   ...
   public class SymbolShopBackgroundImageGeneric extends com.playata.framework.display.MovieClip
   {
       
      
      private var _nativeObject:SymbolShopBackgroundImage = null;
      
      public function SymbolShopBackgroundImageGeneric(param1:flash.display.MovieClip = null)
      {
         if(param1)
         {
            _nativeObject = param1 as SymbolShopBackgroundImage;
         }
         else
         {
            _nativeObject = new SymbolShopBackgroundImage();
         }
         super(null,FlashMovieClip.fromNative(_nativeObject));
         var _loc2_:FlashDisplayObjectContainer = _sprite as FlashDisplayObjectContainer;
      }
      
      public function setNativeInstance(param1:SymbolShopBackgroundImage) : void
      {
