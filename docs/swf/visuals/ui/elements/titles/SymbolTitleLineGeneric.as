package visuals.ui.elements.titles
{
   ...
   public class SymbolTitleLineGeneric extends Sprite
   {
      ...
      public var marriage:SymbolIconMarriageGeneric = null;
      ...
      public function SymbolTitleLineGeneric(param1:MovieClip = null)
      {
         ...
         marriage = new SymbolIconMarriageGeneric(_nativeObject.marriage);
      }
      ...
      public function syncInstances() : void
      {
         ...
         if(_nativeObject.marriage)
         {
            marriage.setNativeInstance(_nativeObject.marriage);
         }
      }
   }
}
