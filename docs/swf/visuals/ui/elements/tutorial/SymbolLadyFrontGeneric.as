package visuals.ui.elements.tutorial
{
   ...
   public class SymbolLadyFrontGeneric extends com.playata.framework.display.MovieClip
   {
       
      
      private var _nativeObject:SymbolLadyFront = null;
      
      public function SymbolLadyFrontGeneric(param1:flash.display.MovieClip = null)
      {
         if(param1)
         {
            _nativeObject = param1 as SymbolLadyFront;
         }
         else
         {
            _nativeObject = new SymbolLadyFront();
         }
         super(null,FlashMovieClip.fromNative(_nativeObject));
         var _loc2_:FlashDisplayObjectContainer = _sprite as FlashDisplayObjectContainer;
      }
      
      public function setNativeInstance(param1:SymbolLadyFront) : void
      {
