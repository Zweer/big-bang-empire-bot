package visuals.ui.panels
{
   ...
   import visuals.ui.elements.buttons.SymbolButtonQuestArrowLeftGeneric;
   import visuals.ui.elements.buttons.SymbolButtonQuestArrowRightGeneric;
   ...
   public class SymbolPanelQuestsGeneric extends Sprite
   {
      ...
      public var dailyBonusQuestEnergy:SymbolDailyBonusQuestsGeneric = null;
      
      public var questArea:SymbolDummyGeneric = null;
      
      public var swipeArea:SymbolDummyGeneric = null;
      ...
      public var btnPreviousStage:SymbolButtonQuestArrowLeftGeneric = null;
      
      public var btnNextStage:SymbolButtonQuestArrowRightGeneric = null;
      ...
      public var btnDrawEvent:SymbolDrawEventButtonGeneric = null;
      
      public var btnSeason:SymbolSeasonButtonGeneric = null;
      ...
      public function SymbolPanelQuestsGeneric(param1:MovieClip = null)
      {
         ...
         dailyBonusQuestEnergy = new SymbolDailyBonusQuestsGeneric(_nativeObject.dailyBonusQuestEnergy);
         questArea = new SymbolDummyGeneric(_nativeObject.questArea);
         swipeArea = new SymbolDummyGeneric(_nativeObject.swipeArea);
         ...
         btnPreviousStage = new SymbolButtonQuestArrowLeftGeneric(_nativeObject.btnPreviousStage);
         btnNextStage = new SymbolButtonQuestArrowRightGeneric(_nativeObject.btnNextStage);
         ...
         btnDrawEvent = new SymbolDrawEventButtonGeneric(_nativeObject.btnDrawEvent);
         btnSeason = new SymbolSeasonButtonGeneric(_nativeObject.btnSeason);
      ...
      public function syncInstances() : void
      {
         ...
         if(_nativeObject.dailyBonusQuestEnergy)
         {
            dailyBonusQuestEnergy.setNativeInstance(_nativeObject.dailyBonusQuestEnergy);
         }
         if(_nativeObject.questArea)
         {
            questArea.setNativeInstance(_nativeObject.questArea);
         }
         if(_nativeObject.swipeArea)
         {
            swipeArea.setNativeInstance(_nativeObject.swipeArea);
         }
         ...
         if(_nativeObject.btnPreviousStage)
         {
            btnPreviousStage.setNativeInstance(_nativeObject.btnPreviousStage);
         }
         if(_nativeObject.btnNextStage)
         {
            btnNextStage.setNativeInstance(_nativeObject.btnNextStage);
         }
         ...
         if(_nativeObject.btnDrawEvent)
         {
            btnDrawEvent.setNativeInstance(_nativeObject.btnDrawEvent);
         }
         if(_nativeObject.btnSeason)
         {
            btnSeason.setNativeInstance(_nativeObject.btnSeason);
         }
