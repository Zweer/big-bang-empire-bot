package visuals.ui.panels
{
   ...
   public class SymbolPanelsGeneric extends Sprite
   {
      ...
      public var panelStreaming:SymbolPanelStreamingGeneric = null;
      ...
      public function SymbolPanelsGeneric(param1:MovieClip = null)
      {
         ...
         panelStreaming = new SymbolPanelStreamingGeneric(_nativeObject.panelStreaming);
      ...
      public function syncInstances() : void
      {
         ...
         if(_nativeObject.panelStreaming)
         {
            panelStreaming.setNativeInstance(_nativeObject.panelStreaming);
         }
