package websocket.hurlant.crypto.cert
{
   ...
   public class X509Certificate
   {
      ...
      public function isSigned(param1:X509CertificateCollection, param2:X509CertificateCollection, param3:Date = null) : Boolean
      {
         ...
         if(_loc4_ == null)
         {
            if((_loc4_ = param1.getCertificate(_loc6_)) == null)
            {
               return false;
            }
         }
      ...
      private function verifyCertificate(param1:RSAKey) : Boolean
      {
         ...
         var _loc5_:* = null;
         var _loc6_:String;
         switch(_loc6_ = getAlgorithmIdentifier())
         {
         ...
         var _loc4_:Object;
         if((_loc4_ = DER.parse(_loc2_,Type.RSA_SIGNATURE)).algorithm.algorithmId.toString() != _loc5_)
         {
            return false;
         }
      ...
      private function signCertificate(param1:RSAKey, param2:String) : ByteArray
      {
         ...
         var _loc5_:Sequence;
         (_loc5_ = new Sequence())[0] = new Sequence();
