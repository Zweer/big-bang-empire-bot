package websocket.hurlant.crypto.hash
{
   ...
   public class MD2 implements IHash
   {
      ...
      public function hash(param1:ByteArray) : ByteArray
      {
         ...
         var _loc7_:uint = 16 - param1.length % 16 || 16;
         do
         {
            param1[param1.length] = _loc7_;
         }
         ...
         while(_loc7_ < _loc2_)
         {
            ...
            {
               var _loc11_:* = _loc8_;
               var _loc12_:* = _loc4_[_loc11_] ^ S[param1[_loc7_ + _loc8_] ^ _loc10_];
         ...
         while(_loc7_ < _loc2_)
         {
            ...
            while(_loc8_ < 16)
            {
               _loc5_[32 + _loc8_] = (_loc5_[16 + _loc8_] = param1[_loc7_ + _loc8_]) ^ _loc5_[_loc8_];
               _loc8_++;
            }
            _loc3_ = uint(0);
            _loc8_ = uint(0);
            while(_loc8_ < 18)
            {
               ...
               while(_loc9_ < 48)
               {
                  _loc5_[_loc9_] = _loc3_ = uint(_loc5_[_loc9_] ^ S[_loc3_]);
                  _loc9_++;
               }
               _loc3_ = uint(_loc3_ + _loc8_ & 255);
               _loc8_++;
            }
            _loc7_ += 16;
         }
