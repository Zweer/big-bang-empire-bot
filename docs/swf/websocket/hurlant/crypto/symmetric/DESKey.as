package websocket.hurlant.crypto.symmetric
{
   ...
   public class DESKey implements ISymmetricKey
   {
      ...
      protected function generateWorkingKey(param1:Boolean, param2:ByteArray, param3:uint) : Array
      {
         ...
         while(_loc8_ < 56)
         {
            _loc9_ = uint(pc1[_loc8_]);
            _loc12_[_loc8_] = (param2[param3 + (_loc9_ >>> 3)] & bytebit[_loc9_ & 7]) != 0;
            _loc8_++;
         }
         _loc6_ = uint(0);
         while(_loc6_ < 16)
         {
            if(param1)
            {
               _loc10_ = uint(_loc6_ << 1);
            }
            else
            {
               _loc10_ = uint(15 - _loc6_ << 1);
            }
            ...
            while(_loc8_ < 28)
            {
               if((_loc9_ = uint(_loc8_ + totrot[_loc6_])) < 28)
               {
                  _loc13_[_loc8_] = _loc12_[_loc9_];
               }
               else
               {
                  _loc13_[_loc8_] = _loc12_[_loc9_ - 28];
               }
               _loc8_++;
            }
            _loc8_ = uint(28);
            while(_loc8_ < 56)
            {
               if((_loc9_ = uint(_loc8_ + totrot[_loc6_])) < 56)
               {
                  _loc13_[_loc8_] = _loc12_[_loc9_];
               }
               else
            ...
            while(_loc8_ < 24)
            {
               if(_loc13_[pc2[_loc8_]])
               {
                  var _loc14_:* = _loc10_;
                  var _loc15_:* = _loc4_[_loc14_] | bigbyte[_loc8_];
                  _loc4_[_loc14_] = _loc15_;
               }
               if(_loc13_[pc2[_loc8_ + 24]])
               {
                  _loc15_ = _loc11_;
                  _loc14_ = _loc4_[_loc15_] | bigbyte[_loc8_];
                  _loc4_[_loc15_] = _loc14_;
               }
               _loc8_++;
            }
            _loc6_++;
         ...
         while(_loc6_ != 32)
         {
            ...
            _loc7_ = uint(_loc4_[_loc6_ + 1]);
            _loc4_[_loc6_] = (_loc5_ & 16515072) << 6 | (_loc5_ & 4032) << 10 | (_loc7_ & 16515072) >>> 10 | (_loc7_ & 4032) >>> 6;
            _loc4_[_loc6_ + 1] = (_loc5_ & 258048) << 12 | (_loc5_ & 63) << 16 | (_loc7_ & 258048) >>> 4 | _loc7_ & 63;
            _loc6_ += 2;
         }
         return _loc4_;
      }
      ...
      protected function desFunc(param1:Array, param2:ByteArray, param3:uint, param4:ByteArray, param5:uint) : void
      {
         ...
         var _loc6_:* = 0;
         var _loc10_:* = 0;
         _loc7_ = uint((_loc7_ = uint((_loc7_ = uint((_loc7_ = uint((param2[param3 + 0] & 255) << 24)) | (param2[param3 + 1] & 255) << 16)) | (param2[param3 + 2] & 255) << 8)) | param2[param3 + 3] & 255);
         _loc9_ = uint((_loc9_ = uint((_loc9_ = uint((_loc9_ = uint((param2[param3 + 4] & 255) << 24)) | (param2[param3 + 5] & 255) << 16)) | (param2[param3 + 6] & 255) << 8)) | param2[param3 + 7] & 255);
         _loc8_ = uint((_loc7_ >>> 4 ^ _loc9_) & 252645135);
         _loc9_ ^= _loc8_;
         _loc8_ = uint(((_loc7_ ^= _loc8_ << 4) >>> 16 ^ _loc9_) & 65535);
         _loc9_ ^= _loc8_;
         _loc7_ ^= _loc8_ << 16;
         _loc8_ = uint((_loc9_ >>> 2 ^ _loc7_) & 858993459);
         _loc7_ ^= _loc8_;
         _loc8_ = uint(((_loc9_ ^= _loc8_ << 2) >>> 8 ^ _loc7_) & 16711935);
         _loc7_ ^= _loc8_;
         _loc9_ = uint(((_loc9_ ^= _loc8_ << 8) << 1 | _loc9_ >>> 31 & 1) & 4294967295);
         _loc8_ = uint((_loc7_ ^ _loc9_) & 2863311530);
         _loc7_ ^= _loc8_;
         _loc9_ ^= _loc8_;
         _loc7_ = uint((_loc7_ << 1 | _loc7_ >>> 31 & 1) & 4294967295);
         _loc6_ = uint(0);
         while(_loc6_ < 8)
         {
            _loc8_ = uint((_loc8_ = uint(_loc9_ << 28 | _loc9_ >>> 4)) ^ param1[_loc6_ * 4 + 0]);
            _loc10_ = uint((_loc10_ = uint((_loc10_ = uint((_loc10_ = uint(SP7[_loc8_ & 63])) | SP5[_loc8_ >>> 8 & 63])) | SP3[_loc8_ >>> 16 & 63])) | SP1[_loc8_ >>> 24 & 63]);
            _loc8_ = uint(_loc9_ ^ param1[_loc6_ * 4 + 1]);
            _loc10_ = uint((_loc10_ = uint((_loc10_ = uint((_loc10_ |= SP8[_loc8_ & 63]) | SP6[_loc8_ >>> 8 & 63])) | SP4[_loc8_ >>> 16 & 63])) | SP2[_loc8_ >>> 24 & 63]);
            _loc8_ = uint((_loc8_ = uint((_loc7_ ^= _loc10_) << 28 | _loc7_ >>> 4)) ^ param1[_loc6_ * 4 + 2]);
            _loc10_ = uint((_loc10_ = uint((_loc10_ = uint((_loc10_ = uint(SP7[_loc8_ & 63])) | SP5[_loc8_ >>> 8 & 63])) | SP3[_loc8_ >>> 16 & 63])) | SP1[_loc8_ >>> 24 & 63]);
            _loc8_ = uint(_loc7_ ^ param1[_loc6_ * 4 + 3]);
            _loc10_ = uint((_loc10_ = uint((_loc10_ = uint((_loc10_ |= SP8[_loc8_ & 63]) | SP6[_loc8_ >>> 8 & 63])) | SP4[_loc8_ >>> 16 & 63])) | SP2[_loc8_ >>> 24 & 63]);
            _loc9_ ^= _loc10_;
            _loc6_++;
         }
         _loc9_ = uint(_loc9_ << 31 | _loc9_ >>> 1);
         _loc8_ = uint((_loc7_ ^ _loc9_) & 2863311530);
         _loc7_ ^= _loc8_;
         _loc9_ ^= _loc8_;
         _loc8_ = uint(((_loc7_ = uint(_loc7_ << 31 | _loc7_ >>> 1)) >>> 8 ^ _loc9_) & 16711935);
         _loc9_ ^= _loc8_;
         _loc8_ = uint(((_loc7_ ^= _loc8_ << 8) >>> 2 ^ _loc9_) & 858993459);
         _loc9_ ^= _loc8_;
         _loc7_ ^= _loc8_ << 2;
         _loc8_ = uint((_loc9_ >>> 16 ^ _loc7_) & 65535);
         _loc7_ ^= _loc8_;
         _loc8_ = uint(((_loc9_ ^= _loc8_ << 16) >>> 4 ^ _loc7_) & 252645135);
         _loc7_ ^= _loc8_;
         _loc9_ ^= _loc8_ << 4;
         param4[param5 + 0] = _loc9_ >>> 24 & 255;
         param4[param5 + 1] = _loc9_ >>> 16 & 255;
         param4[param5 + 2] = _loc9_ >>> 8 & 255;
         param4[param5 + 3] = _loc9_ & 255;
         param4[param5 + 4] = _loc7_ >>> 24 & 255;
         param4[param5 + 5] = _loc7_ >>> 16 & 255;
         param4[param5 + 6] = _loc7_ >>> 8 & 255;
         param4[param5 + 7] = _loc7_ & 255;
      }
