package websocket.hurlant.crypto.tls
{
   ...
   public class TLSEngine extends EventDispatcher
   {
      ...
      public function TLSEngine(param1:TLSConfig, param2:IDataInput, param3:IDataOutput, param4:String = null)
      {
         ...
         var _loc5_:Object;
         _currentReadState = (_loc5_ = _securityParameters.getConnectionStates()).read;
      ...
      private function parseRecord(param1:IDataInput) : void
      {
         ...
         while(_state != 3 && param1.bytesAvailable > 4)
         {
            ...
            {
               _loc2_ = (_loc6_ = _packetQueue.shift()).data;
            ...
            else
            {
               ...
               if((_loc5_ = uint(param1.readShort())) > 18432)
               {
      ...
      private function parseHandshake(param1:ByteArray) : ByteArray
      {
         ...
         var _loc4_:uint;
         if((_loc4_ = _loc3_ << 16 | _loc2_.readUnsignedShort()) + 4 > param1.length)
         {
         ...
         if(_entityHandshakeHandlers.hasOwnProperty(_loc5_))
         {
            ...
            {
               (_loc6_ = new ByteArray()).writeBytes(param1,_loc4_ + 4,param1.length - (_loc4_ + 4));
               return _loc6_;
            }
            return null;
         }
      ...
      private function parseHandshakeClientKeyExchange(param1:ByteArray) : void
      {
         ...
         if(_securityParameters.useRSA)
         {
            ...
            _pendingReadState = (_loc5_ = _securityParameters.getConnectionStates()).read;
      ...
      private function sendServerHello(param1:Object) : void
      {
         ...
         (_loc4_ = new ByteArray()).writeShort(_securityParameters.version);
      ...
      private function sendClientKeyExchange() : void
      {
         ...
         if(_securityParameters.useRSA)
         {
            ...
            (_loc5_ = new Random()).nextBytes(_loc1_,46);
            _loc1_.position = 0;
            (_loc4_ = new ByteArray()).writeBytes(_loc1_,0,_loc1_.length);
            _loc4_.position = 0;
            ...
            _pendingReadState = (_loc6_ = _securityParameters.getConnectionStates()).read;
      ...
      private function loadCertificates(param1:ByteArray) : void
      {
         ...
         var _loc8_:* = null;
         var _loc7_:uint;
         var _loc5_:uint = (_loc7_ = param1.readByte()) << 16 | param1.readShort();
         var _loc12_:Array = [];
         while(_loc5_ > 0)
         {
            _loc11_ = uint((_loc7_ = param1.readByte()) << 16 | param1.readShort());
         ...
         if(_loc6_)
         {
            ...
            else
            {
               ...
               if((_loc8_ = new RegExp(_loc4_.replace(/[\^\\\-$.[\]|()?+{}]/g,"\\$&").replace(/\*/g,"[^.]+"),"gi")).exec(_otherIdentity))
               {
                  _otherCertificate = _loc2_;
               }
               else
